...
carried in the text where they occur and collected in §61.
...
| 39 | **Rarity** | A null model, so "remarkable" means something measurable |
| 40 | **The one structure** | What all thirty-nine collapse into |
...
configuration the chart contains — §39 measures it at roughly **1 in 3,571** —
...
mismatch at 84.5% of all charts** (§39). It is the default condition, not a
...
- **the entire rarity measurement in §39**, which counts signs and spacing
...
**A correction, found later by §39's placement-only pass: the 8th is not the
...
The consequences are worked out in §39.
...
> 11th a minute later. **The finding agrees with five other techniques (§56),
...
computed but never read until §57 — one more correction the deeper varga pass
forced.)*
...
**acute, hot, sharp, sudden.** §57 reads what that means.
...
dominant figure of the decade — §55 found her the most benign presence in the
...
the correction in §61 — which leaves roughly **nine months** of the clearest
...
**3. A seventh blind spot, and it is new.** §58 lists six. This is the seventh,
...
that did not exist before. **This is listed in §58 as his seventh blind spot,
...
marriage most of all, and §47 says so at length: *his dissatisfaction, where it
...
Set that against what §51 established — that this is a chart whose central
...
2. **The marriage is durable precisely because its dissolution-house is weak.**
   §57 found the 8th from the Upapada is his **11th** — rank 11 of 12, carrying
...
§57 already settled the **mode**: this chart is built for employment inside an
...
### Against what §48 already found

§48 answered *"career growth"* from the chart alone, with no premise about a
...
- §48: **"Rahu–Shukra and Rahu–Surya are a money and recognition window, not a
...
- §48: **"advancement through demonstrated competence, not through position."**
  §22 finds the 6th outranks the 10th and the 10th lord ranks fourth.
- §48: **"growth is real, late, and stepped."** §22 finds both career grahas
  mature at 32 and 36, and puts the income crossover at April 2034.

**And they disagree about nothing, but they measure different things.** §48's
...
This is not a new finding; it is the mechanism §51 identified when asked why he
...
aspected by nothing but Ketu, and contains Upaketu** — §57 called it the
...
> 2038**, with the real expansion from **December 2040** — which §46 had
...
2. **The 6th and the D10 say employment.** §57's finding stands — the house of
...
3. **And §51 is the warning.** The one occupant of his three houses of desire
...
> §57 found the 7th empty, aspected only by Ketu and holding Upaketu, and none
...
since §48. **Here is where it actually comes from**: the graha of structure
...
**This reading declines longevity (§60) and continues to decline it**; what
...
Never asked, and it is a different question from *"career growth"* (§48) or
...
throughout.** §17 already called Rahu–Budha "the hinge" and §53 called it
...
(§27), and Ketu's function is to make a thing stop mattering; §51 established
...
§53's timeline already carries *"do not resign here"* against a much smaller
...
| 71 | Longevity through Ashtakavarga | **Declined — see §60** |
...
| 84–96 | Remedial measures | §59 derives remedy from the chart rather than from these. **Corrected in §35: chapters 85–94 also *define* the inauspicious birth conditions, all fifteen of which are now computed and all fifteen negative** |
...
| **43** | **Longevity** — Pindayu, Naisargayu, Amsayu, choice among them, rectifications | **Declined.** §60 refuses ayurdaya; this names precisely what was refused — three methods, not one |
...
This document's central mechanism, argued across §51 at length, is that **he
...
chapter that codifies exactly this.** §51 uses the word *renunciation* six
...
carries load-bearing claims here**: §39's rarity figure rests on *"both
...
> §39's rarity finding says in Baladi's**: the two lights are enthroned and
> underfed. **Two independent avastha schemes, the same verdict.**

### Whether the gap damaged the two claims that rest on avastha

**Claim A — §39's rarity headline**, *"both luminaries exalted and both weak by
...
> **What §51 gets from this is not what I expected.** It argued the
...
> almost exactly what §51 described behaviourally: a man who sets things down
...
1. **Lajjitadi computed** — and it independently confirms §39's rarity finding
...
5. **The sannyasa yogas come back on the boundary**, twice, each turning on
   whether a node counts as a body. §51 is neither confirmed nor refuted; it is
...
belong to the longevity question §60 declines.
...
answered *"what are his natural traits"* (§42) without any of them.
...
and can be recorded without touching longevity, which §60 declines and
...
from §60 onward and **does not reopen at the back door.**
...
| 84–96 | Remedial rites | **Diagnostic half now computed** *(above)*; the **ritual half stands open.** §59 derives remedy from the chart's own structure rather than from prescribed rites, and does not pretend that is equivalent |
...
| 43 | Longevity — Pindayu, Naisargayu, Amsayu | **declined** §60 |
...
| 71 | Longevity through Ashtakavarga | **declined** §60 |
...
| 84 | Remedial measures generally | ritual half open; §59 is the structural answer |
...
| 4 | Zodiacal signs; limbs of Kalapurusha; Nisheka Lagna | §9, §57 |
...
| 12–23 | Effects of the 1st to the 12th house, one chapter each | §9, §55–56 |
...
explicit null model** in §39. The correction is sound as general method and
...
## 39. Rarity — measuring instead of asserting
...
## 41. Part two — the questions asked
...
|---|---|---|
| **42** | *"What are his natural traits"* | `verify_traits.py` |
| **43** | *"Why do people feel jealous or insecure about him"* | `verify_perception.py` |
| **44** | *"How 8th house transform him"* · *"When can he expect major transformation"* · *"Why do people go through such deep transformations does he has any purpose to it"* | `verify_eighth.py` · `verify_timeline.py` · `verify_purpose.py` |
| **45** | *"His wife traits"* | `verify_spouse.py` |
| **46** | *"Will his in laws be wealthy"* | `verify_inlaws.py` |
| **47** | *"So who are the people loving him and when can he experience it. And will he be satisfied with his wife love in marriage and vice versa"* | `verify_love.py` |
| **48** | *"Career growth"* | `verify_career.py` |
| **49** | *"How would the solar eclipse affect him"* | `verify_eclipse.py` |
| **50** | *"Which means he gets all but with pain"* · *"Which means his life is good but with friction"* · *"So it overall upward trajectory in life right"* · *"Any unique point that is so uncommon"* | `verify_cost.py` · `verify_audit.py` · `verify_rarity.py` |
| **51** | *"Why will he walk away from the things he wanted most"* | `verify_relinquish.py` |
...
or gaps that are still need to found about him"* became §62, most of which has
...
## 42. "What are his natural traits"
...
## 43. "Why do people feel jealous or insecure about him"
...
## 44. The three questions about transformation
...
| Contact | Vargas |
|---|---|
| **Occupies the 7th** | **D9, D27** *(an earlier draft added D11 — withdrawn in §50; Ketu is in D11's 10th)* |
...
## 46. "Will his in laws be wealthy"
...
## 47. "Who are the people loving him, and when can he experience it — and will he be satisfied with his wife's love, and she with his"
...
## 49. "How would the solar eclipse affect him"
...
## 50. The four claims he put to the chart
...
Measured, not asserted — §39 has the full method and the deflations. The single
answer:
...
## 51. Why he sets down the things he wanted most
...
## 53. The timeline all the answers share
...
## 54. Part three — the questions not asked
...
asked about** (§55–§57, twenty areas across two passes), **things about him
nobody thought to ask**
(§58–§60), **the corrections the exact birth data forced** (§61), and **what
remains unknown** (§62).

---

## 55. The people never asked about
...
## 56. The areas never asked about
...
## 57. The second pass — eight more never asked
...
> says — and it is exactly what the satisfaction analysis in §47 found from the
...
That is the same conclusion the purpose analysis in §44 reached from the
...
## 59. Remedy — never asked, and derivable
...
## 60. The question deliberately declined
...
## 61. Every correction the birth data forced
...
| Was | Now |
|---|---|
| **1. Birth time to the minute** — *"the only input that would change conclusions rather than add to them"* | **CLOSED.** Known to the second. It changed four dates and one frame-dependent count (§61) |
...
- **The parents' charts.** Both threads are read by bhavat bhavam from his
  chart alone, which is why §55 describes roles rather than people.
...
- **Ayurdaya is still not performed** — §60 gives the reasons, and the birth
...
## 63. The whole thing on one page
