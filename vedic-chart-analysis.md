...
carried in the text where they occur and collected in §53.
...
| 31 | **Rarity** | A null model, so "remarkable" means something measurable |
| 32 | **The one structure** | What all thirty-one collapse into |
...
configuration the chart contains — §31 measures it at roughly **1 in 3,571** —
...
mismatch at 84.5% of all charts** (§31). It is the default condition, not a
...
- **the entire rarity measurement in §31**, which counts signs and spacing
...
**A correction, found later by §31's placement-only pass: the 8th is not the
...
The consequences are worked out in §31.
...
> 11th a minute later. **The finding agrees with five other techniques (§48),
...
computed but never read until §49 — one more correction the deeper varga pass
forced.)*
...
**acute, hot, sharp, sudden.** §49 reads what that means.
...
dominant figure of the decade — §47 found her the most benign presence in the
...
the correction in §53 — which leaves roughly **nine months** of the clearest
...
**3. A seventh blind spot, and it is new.** §50 lists six. This is the seventh,
...
that did not exist before. **This is listed in §50 as his seventh blind spot,
...
marriage most of all, and §39 says so at length: *his dissatisfaction, where it
...
Set that against what §43 established — that this is a chart whose central
...
2. **The marriage is durable precisely because its dissolution-house is weak.**
   §49 found the 8th from the Upapada is his **11th** — rank 11 of 12, carrying
...
§49 already settled the **mode**: this chart is built for employment inside an
...
### Against what §40 already found

§40 answered *"career growth"* from the chart alone, with no premise about a
...
- §40: **"Rahu–Shukra and Rahu–Surya are a money and recognition window, not a
...
- §40: **"advancement through demonstrated competence, not through position."**
  §22 finds the 6th outranks the 10th and the 10th lord ranks fourth.
- §40: **"growth is real, late, and stepped."** §22 finds both career grahas
  mature at 32 and 36, and puts the income crossover at April 2034.

**And they disagree about nothing, but they measure different things.** §40's
...
This is not a new finding; it is the mechanism §43 identified when asked why he
...
aspected by nothing but Ketu, and contains Upaketu** — §49 called it the
...
> 2038**, with the real expansion from **December 2040** — which §38 had
...
2. **The 6th and the D10 say employment.** §49's finding stands — the house of
...
3. **And §43 is the warning.** The one occupant of his three houses of desire
...
> §49 found the 7th empty, aspected only by Ketu and holding Upaketu, and none
...
since §40. **Here is where it actually comes from**: the graha of structure
...
**This reading declines longevity (§52) and continues to decline it**; what
...
Never asked, and it is a different question from *"career growth"* (§40) or
...
throughout.** §17 already called Rahu–Budha "the hinge" and §45 called it
...
(§27), and Ketu's function is to make a thing stop mattering; §43 established
...
§45's timeline already carries *"do not resign here"* against a much smaller
...
## 31. Rarity — measuring instead of asserting
...
## 33. Part two — the questions asked
...
|---|---|---|
| **34** | *"What are his natural traits"* | `verify_traits.py` |
| **35** | *"Why do people feel jealous or insecure about him"* | `verify_perception.py` |
| **36** | *"How 8th house transform him"* · *"When can he expect major transformation"* · *"Why do people go through such deep transformations does he has any purpose to it"* | `verify_eighth.py` · `verify_timeline.py` · `verify_purpose.py` |
| **37** | *"His wife traits"* | `verify_spouse.py` |
| **38** | *"Will his in laws be wealthy"* | `verify_inlaws.py` |
| **39** | *"So who are the people loving him and when can he experience it. And will he be satisfied with his wife love in marriage and vice versa"* | `verify_love.py` |
| **40** | *"Career growth"* | `verify_career.py` |
| **41** | *"How would the solar eclipse affect him"* | `verify_eclipse.py` |
| **42** | *"Which means he gets all but with pain"* · *"Which means his life is good but with friction"* · *"So it overall upward trajectory in life right"* · *"Any unique point that is so uncommon"* | `verify_cost.py` · `verify_audit.py` · `verify_rarity.py` |
| **43** | *"Why will he walk away from the things he wanted most"* | `verify_relinquish.py` |
...
or gaps that are still need to found about him"* became §54, most of which has
...
## 34. "What are his natural traits"
...
## 35. "Why do people feel jealous or insecure about him"
...
## 36. The three questions about transformation
...
| Contact | Vargas |
|---|---|
| **Occupies the 7th** | **D9, D27** *(an earlier draft added D11 — withdrawn in §42; Ketu is in D11's 10th)* |
...
## 38. "Will his in laws be wealthy"
...
## 39. "Who are the people loving him, and when can he experience it — and will he be satisfied with his wife's love, and she with his"
...
## 41. "How would the solar eclipse affect him"
...
## 42. The four claims he put to the chart
...
Measured, not asserted — §31 has the full method and the deflations. The single
answer:
...
## 43. Why he sets down the things he wanted most
...
## 45. The timeline all the answers share
...
## 46. Part three — the questions not asked
...
asked about** (§47–§49, twenty areas across two passes), **things about him
nobody thought to ask**
(§50–§52), **the corrections the exact birth data forced** (§53), and **what
remains unknown** (§54).

---

## 47. The people never asked about
...
## 48. The areas never asked about
...
## 49. The second pass — eight more never asked
...
> says — and it is exactly what the satisfaction analysis in §39 found from the
...
That is the same conclusion the purpose analysis in §36 reached from the
...
## 51. Remedy — never asked, and derivable
...
## 52. The question deliberately declined
...
## 53. Every correction the birth data forced
...
| Was | Now |
|---|---|
| **1. Birth time to the minute** — *"the only input that would change conclusions rather than add to them"* | **CLOSED.** Known to the second. It changed four dates and one frame-dependent count (§53) |
...
- **The parents' charts.** Both threads are read by bhavat bhavam from his
  chart alone, which is why §47 describes roles rather than people.
...
- **Ayurdaya is still not performed** — §52 gives the reasons, and the birth
...
## 55. The whole thing on one page
