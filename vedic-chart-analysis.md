...
carried in the text where they occur and collected in §67.
...
| 45 | **Rarity** | A null model, so "remarkable" means something measurable |
| 46 | **The one structure** | What all forty-five collapse into |
...
configuration the chart contains — §45 measures it at roughly **1 in 3,571** —
...
mismatch at 84.5% of all charts** (§45). It is the default condition, not a
...
- **the entire rarity measurement in §45**, which counts signs and spacing
...
**A correction, found later by §45's placement-only pass: the 8th is not the
...
The consequences are worked out in §45.
...
> 11th a minute later. **The finding agrees with five other techniques (§62),
...
computed but never read until §63 — one more correction the deeper varga pass
forced.)*
...
**acute, hot, sharp, sudden.** §63 reads what that means.
...
dominant figure of the decade — §61 found her the most benign presence in the
...
the correction in §67 — which leaves roughly **nine months** of the clearest
...
**3. A seventh blind spot, and it is new.** §64 lists six. This is the seventh,
...
that did not exist before. **This is listed in §64 as his seventh blind spot,
...
marriage most of all, and §53 says so at length: *his dissatisfaction, where it
...
Set that against what §57 established — that this is a chart whose central
...
2. **The marriage is durable precisely because its dissolution-house is weak.**
   §63 found the 8th from the Upapada is his **11th** — rank 11 of 12, carrying
...
§63 already settled the **mode**: this chart is built for employment inside an
...
### Against what §54 already found

§54 answered *"career growth"* from the chart alone, with no premise about a
...
- §54: **"Rahu–Shukra and Rahu–Surya are a money and recognition window, not a
...
- §54: **"advancement through demonstrated competence, not through position."**
  §22 finds the 6th outranks the 10th and the 10th lord ranks fourth.
- §54: **"growth is real, late, and stepped."** §22 finds both career grahas
  mature at 32 and 36, and puts the income crossover at April 2034.

**And they disagree about nothing, but they measure different things.** §54's
...
This is not a new finding; it is the mechanism §57 identified when asked why he
...
aspected by nothing but Ketu, and contains Upaketu** — §63 called it the
...
> 2038**, with the real expansion from **December 2040** — which §52 had
...
2. **The 6th and the D10 say employment.** §63's finding stands — the house of
...
3. **And §57 is the warning.** The one occupant of his three houses of desire
...
> §63 found the 7th empty, aspected only by Ketu and holding Upaketu, and none
...
since §54. **Here is where it actually comes from**: the graha of structure
...
**This reading declines longevity (§66) and continues to decline it**; what
...
Never asked, and it is a different question from *"career growth"* (§54) or
...
throughout.** §17 already called Rahu–Budha "the hinge" and §59 called it
...
(§27), and Ketu's function is to make a thing stop mattering; §57 established
...
§59's timeline already carries *"do not resign here"* against a much smaller
...
| 71 | Longevity through Ashtakavarga | **Declined — see §66** |
...
| 84–96 | Remedial measures | §65 derives remedy from the chart rather than from these. **Corrected in §35: chapters 85–94 also *define* the inauspicious birth conditions, all fifteen of which are now computed and all fifteen negative** |
...
| **43** | **Longevity** — Pindayu, Naisargayu, Amsayu, choice among them, rectifications | **Declined.** §66 refuses ayurdaya; this names precisely what was refused — three methods, not one |
...
This document's central mechanism, argued across §57 at length, is that **he
...
chapter that codifies exactly this.** §57 uses the word *renunciation* six
...
carries load-bearing claims here**: §45's rarity figure rests on *"both
...
> §45's rarity finding says in Baladi's**: the two lights are enthroned and
> underfed. **Two independent avastha schemes, the same verdict.**

### Whether the gap damaged the two claims that rest on avastha

**Claim A — §45's rarity headline**, *"both luminaries exalted and both weak by
...
> **What §57 gets from this is not what I expected.** It argued the
...
> almost exactly what §57 described behaviourally: a man who sets things down
...
1. **Lajjitadi computed** — and it independently confirms §45's rarity finding
...
5. **The sannyasa yogas come back on the boundary**, twice, each turning on
   whether a node counts as a body. §57 is neither confirmed nor refuted; it is
...
belong to the longevity question §66 declines.
...
answered *"what are his natural traits"* (§48) without any of them.
...
and can be recorded without touching longevity, which §66 declines and
...
from §66 onward and **does not reopen at the back door.**
...
| 84–96 | Remedial rites | **Diagnostic half now computed** *(above)*; the **ritual half stands open.** §65 derives remedy from the chart's own structure rather than from prescribed rites, and does not pretend that is equivalent |
...
| 43 | Longevity — Pindayu, Naisargayu, Amsayu | **declined** §66 |
...
| 71 | Longevity through Ashtakavarga | **declined** §66 |
...
| 84 | Remedial measures generally | ritual half open; §65 is the structural answer |
...
| 4 | Zodiacal signs; limbs of Kalapurusha; Nisheka Lagna | §9, §63 |
...
| 12–23 | Effects of the 1st to the 12th house, one chapter each | §9, §61–56 |
...
explicit null model** in §45. The correction is sound as general method and
...
is the same tension §57 names as setting down what he wanted most.
...
## 45. Rarity — measuring instead of asserting
...
## 47. Part two — the questions asked
...
|---|---|---|
| **48** | *"What are his natural traits"* | `verify_traits.py` |
| **49** | *"Why do people feel jealous or insecure about him"* | `verify_perception.py` |
| **50** | *"How 8th house transform him"* · *"When can he expect major transformation"* · *"Why do people go through such deep transformations does he has any purpose to it"* | `verify_eighth.py` · `verify_timeline.py` · `verify_purpose.py` |
| **51** | *"His wife traits"* | `verify_spouse.py` |
| **52** | *"Will his in laws be wealthy"* | `verify_inlaws.py` |
| **53** | *"So who are the people loving him and when can he experience it. And will he be satisfied with his wife love in marriage and vice versa"* | `verify_love.py` |
| **54** | *"Career growth"* | `verify_career.py` |
| **55** | *"How would the solar eclipse affect him"* | `verify_eclipse.py` |
| **56** | *"Which means he gets all but with pain"* · *"Which means his life is good but with friction"* · *"So it overall upward trajectory in life right"* · *"Any unique point that is so uncommon"* | `verify_cost.py` · `verify_audit.py` · `verify_rarity.py` |
| **57** | *"Why will he walk away from the things he wanted most"* | `verify_relinquish.py` |
...
or gaps that are still need to found about him"* became §68, most of which has
...
**§43**; and *"what if he is in USA"* became **§44**.
...
## 48. "What are his natural traits"
...
## 49. "Why do people feel jealous or insecure about him"
...
## 50. The three questions about transformation
...
| Contact | Vargas |
|---|---|
| **Occupies the 7th** | **D9, D27** *(an earlier draft added D11 — withdrawn in §56; Ketu is in D11's 10th)* |
...
## 52. "Will his in laws be wealthy"
...
## 53. "Who are the people loving him, and when can he experience it — and will he be satisfied with his wife's love, and she with his"
...
## 55. "How would the solar eclipse affect him"
...
## 56. The four claims he put to the chart
...
Measured, not asserted — §45 has the full method and the deflations. The single
answer:
...
## 57. Why he sets down the things he wanted most
...
## 59. The timeline all the answers share
...
## 60. Part three — the questions not asked
...
asked about** (§61–§63, twenty areas across two passes), **things about him
nobody thought to ask**
(§64–§66), **the corrections the exact birth data forced** (§67), and **what
remains unknown** (§68).

---

## 61. The people never asked about
...
## 62. The areas never asked about
...
## 63. The second pass — eight more never asked
...
> says — and it is exactly what the satisfaction analysis in §53 found from the
...
That is the same conclusion the purpose analysis in §50 reached from the
...
## 65. Remedy — never asked, and derivable
...
## 66. The question deliberately declined
...
## 67. Every correction the birth data forced
...
| Was | Now |
|---|---|
| **1. Birth time to the minute** — *"the only input that would change conclusions rather than add to them"* | **CLOSED.** Known to the second. It changed four dates and one frame-dependent count (§67) |
...
- **The parents' charts.** Both threads are read by bhavat bhavam from his
  chart alone, which is why §61 describes roles rather than people.
...
- **Ayurdaya is still not performed** — §66 gives the reasons, and the birth
...
## 69. The whole thing on one page
