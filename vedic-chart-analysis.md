...
### Why people are jealous or insecure around him

Envy is a reaction to the *image*, not to the substance, so Jyotisha reads it
from the arudha rather than the lagna. `verify_perception.py` computes the
apparatus: the Arudha Lagna and what touches it, the arudha-relative houses,
the 6th of rivals, the 11th of the peer circle, and **Drik Bala** — which
measures exactly how much benefic or malefic attention each graha receives.

Six mechanisms, and **not one of them is about arrogance.**
...
| Benefic aspects | **Chandra — one**, and it is in *Mrita* avastha with the chart's lowest Shodhya Pinda, so it softens very little |
| Upagraha in the sign | **Vyatipata** |

The image is an intense, concealing sign, occupied by the graha of
disappearance, **lit almost entirely by hard planets.** Set that against a
Kanya lagna whose actual business is diagnosis, correction and service.

**The image is harder and stranger than the person.** People do not react to
who he is. They react to that.
...
arudha withholds the method.

**Visible ascent plus withheld method is the single most reliable envy
generator in the classical vocabulary.** He is not concealing anything. The
concealment is structural.

#### 3. He wins contests he did not pick

**The 6th house — rivals, enemies, competition — is Kumbha at 41 bindus: the
highest-supported sign in the entire chart**, aspected by *both* Guru and its
own lord Shani.
...
8th house**, holding Surya, Budha and Shukra.

**What he goes through is what makes people compete with him.** He does not
have to provoke anybody; the transformation apparatus itself produces the
rivalry. And the **11th from the arudha is Kanya, the lagna itself** — his
image is fed by his actual substance, **which is why the gap never closes by
presentation alone.**

#### 5. He is visibly better than his output

Both luminaries are **exalted in sign and crippled in avastha**; the lagna and
Surya are **vargottama**. Others can sense substance that is not being cashed.

**Unspent potential reads as withholding rather than as modesty** — and people
find that far more provoking than actual success.
...
And **both personal points are Rakshasa gana.** Non-deference is experienced as
...
holds them.** The circle thins, it turns, and the concealed element in it is
what surfaces. (The 12 August 2026 eclipse falling partile on Gulika is that
mechanism firing on schedule.)

#### And his reputation is permanently under siege

**Drik Bala** measures net aspectual pressure:
...
**Guru carries −8.58, nearly three times the next worst.** And Guru is the only
graha in a kendra, the giver of **Amala Yoga** — the chart's reputation yoga —
the 4th and 7th lord, the **badhakesh**, and it carries **Yama Ghantaka 2°05′
away.**

**The one graha responsible for his good name is also the most aspectually
besieged body in the chart.** His reputation is under permanent pressure — not
because it is undeserved, but because the graha that holds it is the one
everything else is aimed at.

#### What is not in the chart

No yoga of ostentation. No Panchamahapurusha. No exalted graha in a kendra. No
strong 11th. And an Amala yoga under the heaviest malefic pressure in the
chart.
