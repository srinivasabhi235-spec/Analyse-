...
carried in the text where they occur and collected in §71.
...
| 20 | **The same thing, in plain words** | §18 and §19 without the Sanskrit or the arithmetic — what happened, what is coming, and how to handle it |
...
| 25 | **Bhanga — the cancellation rules** | Every classical cancellation doctrine tested: Kuja dosha, Kemadruma, neecha bhanga, papakartari, combustion exemption, yoga bhanga |
| 26 | **The navamsa, read as a chart** | D9 with its own lagna, house lords and yogas — vargottama, the D9 seventh, and the 64th navamsa |
| 27 | **House nature — every scheme** | Kendra, panapara, apoklima; trikona, upachaya, dusthana; the four purushartha trikonas; maraka and badhaka; and what each graha *is* for this lagna |
| 28 | **The current transit** | A live transit table verified against the ephemeris, then read as gochara from the natal Moon and lagna |
| 29 | **Job loss and career disruption** | Bhavat bhavam on the 10th, the one dated vulnerable window, and whether loss arrives or is chosen |
| 30 | **Career from D1 and D9 only** | Every career technique the two charts support — three references, argala, the arudha of the 10th, and the navamsa read as the fate of the career |
| 31 | **Provenance** | The reading mapped to its chapters in Parashara — and the one chapter it never opened |
| 32 | **Closing the three gaps** | Lajjitadi and Deeptadi computed, Sayanadi declined, and the sannyasa and penury combinations tested at last |
| 33 | **Rahu through Dhanishtha** | A claim from outside the reading, tested — the premise, the wrong reason, and the better one nobody gave |
| 34 | **The whole reading, swept against the titles** | Every chapter title as a checklist — and a second dasha system computed, which confirms the hinge to within eighteen days |
| 35 | **Every chapter, and where it stands** | All fifty-five chapters assigned a state — five computed here, fifteen inauspicious-birth conditions tested, and a hand-tally overturned |
| 36 | **Chapters 1 to 41** | The half of Parashara with no contents page — what lives there, and every disputed rule priced by what it would change |
| 37 | **The contents page for 1–45** | The missing half arrives — the varga apparatus checked against the source, a §35 hedge overturned, sixty-one yogas swept, and the one lagna in twelve with a symmetric lordship map |
| 38 | **The classical sequence** | The ten-step bhava krama run in strict order on the 10th house, with the running verdict logged after every step |
| 39 | **Guru through Ashlesha** | A transit claim about dreams, tested at step 10 where transits belong — three gandanta crossings, one retrograde |
| 40 | **When — the marriage question** | The 7th timed at step 9: the Upapada computed for the first time, and the double transit scanned month by month to 2040 |
| 41 | **When would he find his place** | Four senses of *place* — home, standing, belonging, elsewhere — computed side by side, ranked and timed |
| 42 | **The field, and the deepening** | The vocation karakas and the D24 — what kind of field, when he settles into it, and when depth actually begins |
| 43 | **Chandra grahan and the D10 lagna** | An eclipse claim tested four ways — including visibility from the birthplace, which decides it |
| 44 | **What if he is in the USA** | The one place §43 has to be amended — visibility belongs to the current location, not the birthplace, and the eclipse table inverts |
| 45 | **Does the eclipse trigger anything** | The two measures classical method actually gives an individual — and both come back favourable |
| 46 | **The D81, computed** | The nava-navamsa calculated at last — and the disclosure §2 undertook to make and three later sections did not |
| 47 | **Shani through the 8th, over the exalted Surya** | Three crossings, not one — the sign is the problem, not the contact, and the Ashtakavarga is rebuilt from first principles to say so |
| 48 | **The 8th–9th exchange, named from outside** | A description of the chart's central structure arrives from elsewhere — three of its six claims land, one inverts, and the dasha arithmetic says it never gets a mahadasha again |
| 49 | **Rarity** | A null model, so "remarkable" means something measurable |
| 50 | **The one structure** | What every instrument in Part one collapses into |
...
**[§46 audited that undertaking and found it kept once and broken three times.**
The D60 finding in §11 was flagged; the D24 claims in §13, §42 and §44 were not.
All three are now annotated at the point of use. **The census above is correct
as printed — §46 recomputed all twenty-seven schemes and reproduced this list
of eight movers and this 19-of-27 exactly.]**
...
configuration the chart contains — §49 measures it at roughly **1 in 3,571** —
...
mismatch at 84.5% of all charts** (§49). It is the default condition, not a
...
model §49 uses was applied to the rashi chain itself:**
...
- **the entire rarity measurement in §49**, which counts signs and spacing
...
## 10. Drishti — and the two houses nothing reaches
...
**A correction, found later by §49's placement-only pass: the 8th is not the
...
The consequences are worked out in §49.
...
**[Amended in §46: the D24 lagna is Vrishabha on the supplied longitude and
Mesha on the computed one, fifty-six seconds apart. On the computed value these
three sit in the 1st, not the 12th. The exaltation of Guru survives either way;
this 12th-house reading does not.]**
...
> 11th a minute later. **The finding agrees with five other techniques (§66),
...
computed but never read until §67 — one more correction the deeper varga pass
forced.)*
...
| **D81** | Nava-navamsha | *the navamsha of the navamsha* | **Computed in full in §46.** The graha signs are stable under the residual; the lagna is not, so the houses are not used |
...
**acute, hot, sharp, sudden.** §67 reads what that means.
...
dominant figure of the decade — §65 found her the most benign presence in the
...
the correction in §71 — which leaves roughly **nine months** of the clearest
...
**3. A seventh blind spot, and it is new.** §68 lists six. This is the seventh,
...
## 20. The same thing, in plain words

The last two sections are dense and technical. This one says the same thing in
ordinary words. **Nothing new is claimed here** — every statement below is a
plain-language version of something computed in §18 or §19, and the numbers
are there if you want them.

One thing to hold on to before starting: **the chart describes a shape, not a
script.** It says what kind of pressure arrives and roughly when. It does not
say what actually happened to a real person, and where this section sounds
like it is describing events, read it as *"this is the sort of thing that
period is built to produce."*

---

### What already happened — roughly ages 14 to 21

**The part of his chart that governs upheaval was in charge of those seven
years.** Not visiting. In charge. From late 2015 to late 2022.

**It was pointed at the family, not at him.** That is unusual and it is
specific: the same influence, in a different chart, would have gone after
health or career. Here it went after **home, the father, and the conditions
of his schooling.**

**The heaviest part was the middle, not the beginning.** Roughly ages 15 to
18, there was a slow grinding pressure — three straight years of it. Not a
single dramatic event. Something more like weight that does not lift.

**At 17 or 18 he was asked the question everyone gets asked at that age** —
*who are you, and what are you going to do* — **and the part of his chart that
answers that question is the weakest thing he owns.** So the question got
forced early and the answer was not available. That is not a character flaw.
It is a structural mismatch of timing.

**He had nothing external to lose.** No job, no household, no standing, no
reputation. Whatever that period took, it could not take those, because he did
not have them yet.

**And what it took, it gave back as self-reliance.** The technical reason is in
§19; the plain version is that this particular kind of pressure, in this
particular chart, converts into *capability* rather than just damage. He came
out of it able to work alone, under load, without anyone holding the structure
up for him. **That is the single most useful thing he owns, and it was
installed in those years.**

**It ended better than it ran.** The last year and a half of that period —
roughly 18½ to 20 — was the good part. The turn came at the end.

---

### What is coming — roughly ages 25 to 31

**Same area of life gets worked on. Completely different tool.**

Last time the pressure came from *inside* — the ruling period of those years
was itself the upheaval. This time it comes from *outside*: slow planetary
transits pressing on it while the ruling period is something else entirely.
**Before, the house was acting. Now, the house is being acted upon.**

**It is pointed at him and his work, not at his family.** Identity, career,
health, children. The family recedes; the self and the job come forward.

**There are three sources of pressure instead of one.** The earlier window had
one. This one has three overlapping — and they start earlier than this document
originally said: **June 2027, not late 2027.**

**Things will be attached to the outcome this time.** By the chart's own
timeline: a marriage around early 2028, a career foundation beginning the same
week, possibly a child around 2029. **He will have things that can be lost.
Last time he did not.**

**The same question gets asked again — and by the same weak instrument.** Around
December 2030 to mid-2033, the identical part of the chart that handled the
who-are-you question at seventeen handles it again. **Except now there is a
marriage, a child and a career attached to the answer.**

**But this time it converts.** This is the one measurement that holds no matter
how you calculate it: **the coming window turns pressure into position and
standing in a way the earlier one structurally could not.** The earlier one
produced a person. This one produces a life.

**And it also ends better than it runs.** From about 2033 to 2037 is the
material peak of his thirties.

---

### The difference in what comes out

| | **Before, 14–21** | **Ahead, 25–31** |
|---|---|---|
| **Where the pressure lands** | home, father, schooling | himself, his work, his marriage |
| **Where it comes from** | inside — the period itself | outside — slow transits |
| **How many sources** | one | **three** |
| **What he had to lose** | nothing external | **a marriage, a child, a career** |
| **What it builds** | a person | **a position** |
| **What it hands back** | **self-reliance and authority** | **it takes the wanting away instead** |

**That last row is the deepest difference and it is worth sitting with.**

The earlier period was governed by an influence that pays out through the part
of the chart associated with *healing and authority*. So what it burned away,
it returned in another form. **He got something back.**

The coming period's central stretch pays out through the part of the chart
associated with *dissolution* — and that part does not hand things back. **It
removes the wanting instead.** You do not end up compensated. You end up no
longer needing the thing.

Whether that reads as bleak or as a relief depends entirely on where you are
standing when it happens.

**So, in one line each:**

> **The past cost him things he had not chosen, and gave him back a self.**
>
> **The future will cost him things he will have chosen, and give him back a
> role.**
...
This is the part that matters, and there are seven things.
...
that did not exist before. **This is listed in §68 as his seventh blind spot,
and it is the only one on that list that exists because of something he has
actually lived.**

**2. Last time there was nothing to protect. This time there is.** The clear
window closes **3 June 2027** — about nine months from now. Whatever is worth
securing, secure it before then: the relationship, the health routine, the
working relationships that will matter. **Not because disaster is coming, but
because the last time this happened he had nothing to arrange and this time he
does.**

**3. Last time he endured. This time he can steer.** At fourteen he had no
choices. **At twenty-eight he will have them, and the chart's standing advice
— change where you stand rather than just working harder — becomes executable
for the first time.** He is built to work harder. That will be the wrong
instrument again, and it will feel like the right one.

**4. Expect the middle to be the worst, not the start.** Both windows put the
hardest stretch in the middle. **Around 2030 to 2031** is the equivalent of the
earlier 15-to-18 stretch. Knowing that in advance is worth something: it means
the difficult part arriving is a schedule, not a verdict.

**5. The turn comes at the end, both times.** Last time the good part was the
final eighteen months. This time it is **2033 to 2037.** He should not read the
middle of a period as its conclusion — he did that at seventeen and had no way
of knowing better.
...
marriage most of all, and §57 says so at length: *his dissatisfaction, where it
appears, is not evidence about her.*

**7. He will not be doing it alone this time, and that is the actual
difference.** Last time he was alone because there was no one else in the
structure. The chart's reading of the marriage is that it is **durable and
undemonstrative** — it holds without being effusive. **That is exactly the kind
of thing that is worth almost nothing at twenty-two and worth a great deal at
thirty.**
...
- **None of this is a prediction of events.** It describes the kind of pressure
  a period is built to produce, and the timing of it.
- **The only part of this document that has been tested against a real life is
  the past window** — and even that is offered for him to check, not asserted.
- **The dates are exact; the descriptions are not.** Sade Sati begins 3 June
  2027 and the Saturn return is 2 June 2031. What those *mean* in a life is
  interpretation.
- **This is Jyotisha on its own terms.** It is a framework with internal
  consistency. Nothing here demonstrates that the framework is true, and this
  document has never claimed otherwise.
- **And the reading has been wrong before.** It has corrected itself eight or
  nine times in this document, including twice about this very period. Treat it
  as a careful argument, not as an oracle.

---

## 21. The role, specifically — and why it is a different kind

§19 closed on a sentence: *the past cost him things he had not chosen and
returned a self; the future costs him things he will have chosen and returns a
role.* That leaves the obvious question unanswered. **Which role?**

The word was doing real work in that sentence, so `verify_role.py` makes it
earn it. Three things have to hold: that the past did **not** give him roles
(or the distinction collapses), that the chart **names** particular roles for
the coming window, and that those roles carry a **specific kind** of authority.
**Nothing here is a new prediction** — every date below is already in this
document. This names what occupies them.

### First: did the past give him roles too?

The roles available between ages 13.7 and 20.7 are son, student and brother.
The chart's own numbers for the houses that carry them:

| House | | Sign | SAV | Bhava rank | Occupants |
|---|---|---|---|---|---|
| 9 | father / son | Vrishabha | **22** | 7 | **Chandra, Mangal, Shani, Rahu** |
| 3 | siblings, effort | Vrischika | 28 | 8 | **Ketu** — severest gandanta pada |
| **4** | mother, home, schooling | Dhanu | 29 | **2** | *empty* |
| 5 | education, mind | Makara | 29 | 6 | *empty* |

**A correction to what this section was first drafted as saying.** I had
written that the Mangal years put *all four* of those under load. They do not.
**Only two carry direct weight** — the 9th, at the chart's second-lowest SAV
with four grahas including Rahu in Marana Karaka Sthana, and the 3rd, holding
gandanta Ketu. **The 4th is rank 2 of 12 and empty; the 5th is rank 6 and
empty.** Both are well built and receive nothing worse than Mangal's aspect.

That is a more precise account of those years than the reading had: the
pressure fell on **the father, and on siblings-and-effort** — not on home and
schooling as such, which is also why the domestic base came through it intact.

But the finding does not depend on all four being weak. **It depends on all
four being assigned.** Son, student, brother — every one of them is a position
you are *put in*. None is taken.

> **The past gave him no role.** It gave him positions he was born into, and
> put the two that carried his father and his effort under load. What he came
> out with was a **capability** — the ability to work alone under pressure.
> **That is a property of a person, not a position.**

### What the coming window names

| Role | When | House | | |
|---|---|---|---|---|
| **HUSBAND** | Rahu–Guru, **to 31 January 2028** | 7th — Meena | SAV **33** | rank 4 |
| **THE ONE RESPONSIBLE** | Rahu–Shani, **31 Jan 2028 – 7 Dec 2030** | 10th — Mithuna | SAV 29 | rank 9 |
| **FATHER** | inside Shani–Shukra, **Feb–Jul 2029** | 5th — Makara | SAV 29 | rank 6 |

**Husband.** Guru rules both the 7th and the 4th and runs the antardasha;
transit Shani sits in the natal 7th until 3 June 2027; transit Guru aspects it.
**Three independent activators of the 7th at once** — the clearest such window
in the visible timeline.

**The one responsible.** Shani carries **four career credentials
simultaneously** — D10 lagna lord, Amatyakaraka, lord of the 41-bindu 6th, and
occupant of D9's 10th. Nothing else in the chart carries more than two. This is
the sub-period the reading has called the foundation from the beginning.

**Father.** Shani rules the 5th and runs the antardasha, Shukra is the
Atmakaraka, and transit Guru crosses the natal lagna across 2028. The 5th is
loaded far more heavily here than in the past window.

> **All three are roles he enters rather than inherits.** That is what the word
> in §19 was carrying, and it holds: son, student and brother were assigned;
> husband, office-holder and father are taken on.

### What kind of authority — and it is not the obvious kind

Here the chart is unusually specific, and it says something most readings would
soften. Four measurements, all pointing the same way.

**1. The 10th lord ranks fourth as a career agent in his own chart.** Budha
rules the 10th and scores **3.77**. Shani, which rules nothing in the career
houses, scores **7.96**. **The graha with the title does not have the power.**

**2. No Panchamahapurusha yoga.** With one kendra occupied, and that by a graha
in an enemy sign, none of the five great-person yogas can form. **Nothing in
this chart confers stature automatically.**

**3. Both Jaimini authority indicators land on the empty 12th — and the 12th is
the strongest bhava in the chart.** A second correction to the draft: I read
rank 1 as weakness. It is the opposite. **12.59 rupas, rank 1 of 12, the
best-built house he owns, and empty** — while the 10th itself ranks **9 of 12**.
So his seat of public authority is real and it is **located out of sight**:
foreign, secluded, behind the scenes. **Not absent. Unwitnessed.**

**4. The 6th carries 41 bindus**, the highest of any sign, and the D10
ascendant is that same sign. **The house of service, competition and applied
problem-solving is the strongest thing he owns by that measure.**

> **The role is responsibility without title.**
>
> He becomes the person things are handed to — not the person whose name is on
> the door. The chart is emphatic that the second is not available and does not
> become available on its own. **The one who is called when it is broken,
> contested or opaque, and who is trusted to resolve it.**
>
> That is the authority of the **expert** and the **trusted hand**, and it is
> exactly what a Kumbha D10 ascendant under Shani, a 41-bindu 6th, and Amala
> Yoga describe between them.

### All three roles are the same role
...
| **The one responsible** | something depends on him and he is not free to hand it back |
| **Father** | someone depends on him absolutely, and there is no version where he is not responsible |
...
Set that against what §61 established — that this is a chart whose central
...
### And what makes it survivable

Three answers, each found for other reasons and worth collecting here.
...
2. **The marriage is durable precisely because its dissolution-house is weak.**
   §67 found the 8th from the Upapada is his **11th** — rank 11 of 12, carrying
...
3. **Shani and Guru are the only grahas in adult avastha**, and they govern
   ...
   **Qualified by §32.** That reads the Baladi scheme, which reports both
   simply as adult. A second avastha scheme — Lajjitadi, computed later —
   separates them sharply: **Shani comes out *Mudita*, delighted; Guru comes
   out *Kshudita*, starved, and is the only graha in the chart that is neither
   proud nor delighted.** The point stands, but **Shani carries it and Guru
   does not** — and the scheme this section originally used could not see the
   difference.
...
occurs. It says the chart activates those houses on those dates, and that the
roles it names are of a particular kind. **Whether a life fills them is not
something Jyotisha can settle.**

---

## 22. Career and earning through a job — how it grows

§67 already settled the **mode**: this chart is built for employment inside an
...
`verify_earning.py` separates four things the reading had been lumping
together, because this chart treats them very differently:

| | Channel | House |
|---|---|---|
| **STANDING** | position, title, what the work is | 10th |
| **SERVICE** | the employment relation itself, competition | 6th |
| **INCOME** | gains arriving — the flow | 11th |
| **RETENTION** | what stays | 2nd |

**Nothing here is a new dasha.** Every date already exists in this document.
What is new is the separation of the channels, and the growth curve across
them.

### Where he stands right now

Today is **19 August 2026**, age **24.3** — in **Rahu–Guru**, which runs
**Sep 2025 – Jan 2028**, inside the Rahu mahadasha (Dec 2022 – Dec 2040).

**A job taken now attaches to Rahu–Guru, and Guru is not a neutral marker
here.** It **occupies the 10th and forms Amala Yoga** there, rules the 7th and
the 4th, scores **5.89 as a career agent — rank 2 of 9**, carries a net balance
of **+22.20**, and **matured at 16**, so it runs at full strength. Transit Guru
is crossing the **11th, the income house, from August 2026 to June 2027.**

> **The entry point is genuinely good** — and it is the last antardasha of its
> kind before the structural window opens. **This is the on-ramp, not the
> destination.**

### The four channels are not the same strength

| | Channel | Sign | SAV | Bhava rank | Lord | SP | Net |
|---|---|---|---|---|---|---|---|
| 10 | **STANDING** | Mithuna | 29 | 9 | Budha | 152 | −11.41 |
| **6** | **SERVICE** | Kumbha | **41** | 10 | Shani | 184 | −34.35 |
| 11 | **INCOME** | Karka | 28 | **11** | **Chandra** | **33** | +20.05 |
| 2 | **RETENTION** | Tula | 24 | **3** | **Shukra** | 95 | **+35.62** |

**SERVICE is the strongest thing he owns.** SAV 41 is the highest of any sign
in the chart, and the D10 ascendant is that same sign. **The employment
relation itself is the strong part.**

**RETENTION is well served by one measure and not the other**, and that has to
be said rather than smoothed. The 2nd ranks **3 of 12** by Bhava Bala and its
lord Shukra carries the **best net balance in the chart** and is the
Atmakaraka — but its **SAV is only 24, joint third-lowest of the twelve**.
**Structurally sound, thinly supplied.** The vessel is well made; the bindus
say it does not fill quickly.

**INCOME is the weak link, and it is weak twice over.** The 11th ranks **11 of
12** and carries **both Gulika and Mandi**; its lord Chandra has **Shodhya
Pinda 33 — the lowest in the chart** — and a career score of **0.14**, also the
lowest.

**STANDING is middling.** The 10th ranks 9, and its lord Budha is combust in
the 8th — the only graha failing its Shadbala minimum.

> He is strong at **doing the job**, strong at **keeping what arrives**, weak
> at **the flow arriving in the first place**, and the **title** is the least
> supported of the four.
>
...
### So how does the money actually arrive?

If the flow-house is the weak one, the money comes from somewhere else — and
the chart is specific. **Shukra, the 2nd lord, sits in the 8th house**, with
the highest Ishta Phala and the best net balance in the chart.
...
inheritance, a payout attached to an occasion. Set that beside an 11th at rank
11 with both shadow points and the prediction is not ambiguous:

> **Salary accretion is the weak channel. Lump arrivals attached to events are
> the strong one.**
>
> The base rises slowly and unspectacularly; the real jumps come from things
> that are *not* the annual increment. **His increment is not where his money
> is.**

**And the 6th — the competition house — is the strongest one.** A 6th at 41
bindus against a 10th that is merely ordinary says growth comes from **contests
won, not from position held**: applying for the thing, being measured against
others and coming out ahead, changing employer. **The weak 11th says the same
thing from the other side** — gains do not flow to him because he is there.

> **His raises come from moving, not from waiting.**

### The growth curve, dated

Career score is the document's existing figure for the antardasha lord. Income
is built in the script and shown transparently: ruling the 2nd or 11th +3 each,
occupying them +2 each, Shodhya Pinda 0–3, net ±2 scaled, dhana karaka +1.

| Antardasha | From | To | Career | Income |
|---|---|---|---|---|
| **Rahu–Guru** | Aug 2026 | Jan 2028 | 5.89 | 3.28 |
| **Rahu–Shani** | Jan 2028 | Dec 2030 | **7.96** | **0.84** |
| Rahu–Budha | Dec 2030 | Jun 2033 | 3.77 | 1.57 |
| Rahu–Ketu | Jun 2033 | Jul 2034 | 2.36 | 2.02 |
| **Rahu–Shukra** | **Jul 2034** | **Jul 2037** | 4.53 | **6.17** |
| Rahu–Surya | Jul 2037 | Jun 2038 | 3.25 | 3.95 |
| Rahu–Chandra | Jun 2038 | Dec 2039 | **0.14** | 4.49 |
| Rahu–Mangal | Dec 2039 | Dec 2040 | 2.36 | 2.02 |

**Peak career is Rahu–Shani, Jan 2028 – Dec 2030. Peak income is Rahu–Shukra,
Jul 2034 – Jul 2037. They are four years apart, and the gap is the answer.**

**Note the row that matters most.** Rahu–Shani carries the **highest career
score in the visible timeline and the lowest income score** — 7.96 against
0.84. **The period that builds the career pays the least while it is running.**

*(One caution on Rahu–Chandra: its income score of 4.49 comes almost entirely
from Chandra ruling the 11th. The same Chandra has the lowest delivery in the
chart. Rulership without delivery — read it as a favourable channel that
supplies thinly.)*

### The two maturities that set the timetable

This needed no new computation — only putting the maturity table beside the
career table.

| Graha | Matures | Date | Career score | |
|---|---|---|---|---|
| **Budha** | 32 | **Apr 2034** | 3.77 | the 10th and lagna lord — nominal |
| **Shani** | 36 | **Apr 2038** | **7.96** | the actual career engine |

**Neither is mature yet. He is 24.**

- The **career-defining antardasha** (Rahu–Shani, Jan 2028 – Dec 2030) runs on
  a graha that **will not be mature for another eight years**.
- The **career hinge** (Rahu–Budha, Dec 2030 – Jun 2033) runs on a graha that
  **does not mature until Apr 2034** — about **ten months after that period
  closes**.

**A correction to the draft.** I had written that Budha matures *inside* its
own antardasha. It does not, and the dates say so. The true version is worse
for that period and better for what follows: **the career hinge is run by Budha
and finishes before Budha is ready.**
...
> foundation first, return later** — with the crossover at **April 2034**.

### Where transit support and antardasha support coincide

Merged occupancy intervals for the two slow grahas across the four channels —
computed as intervals rather than ingress dates, because retrograde re-entry
otherwise opens a phantom second window.

| Graha | Channel | | Window |
|---|---|---|---|
| Guru | 11th | INCOME | **Aug 2026 – Jun 2027** |
| Guru | 2nd | RETENTION | Jan 2029 – Sep 2030 |
| Guru | 6th | SERVICE | Mar 2033 – Mar 2034 |
| **Shani** | **10th** | **STANDING** | **Jun 2032 – Jul 2034** |
| **Shani** | **11th** | **INCOME** | **Jul 2034 – Aug 2036** |
| Guru | 10th | STANDING | Sep 2036 – Sep 2037 |
| Guru | 11th | INCOME | Sep 2037 – May 2039 |

| Antardasha | Career + income | Overlapping transit support |
|---|---|---|
| **Rahu–Shukra** | **10.70** | **Guru 10th, Shani 11th** |
| **Rahu–Guru** | **9.17** | Guru 11th |
| Rahu–Shani | 8.80 | Guru 2nd |
| Rahu–Surya | 7.20 | Guru 11th, Guru 10th |
| Rahu–Budha | 5.34 | Guru 6th, Shani 10th |
| Rahu–Chandra | 4.63 | Guru 11th |
| Rahu–Ketu | 4.38 | Guru 6th, Shani 10th |

**The convergence is Rahu–Shukra, Jul 2034 – Jul 2037.** Four independent
things land on that window, and none was chosen to make them agree:

1. the **highest income score** of any antardasha in the visible timeline
2. transit **Shani crossing the 11th**, the income house, Jul 2034 – Aug 2036
3. **Budha — the 10th and lagna lord — maturing April 2034**
4. the document's existing finding, reached by entirely different means, that
   **2033–2037 is the material peak of his thirties**

> **That is the answer to "how will it grow", and it is not the comfortable
> one: the career-defining work happens 2028–2030, and the money shows up
> about four years after it.**

**The second-ranked window is the one he is in.** Rahu–Guru scores 9.17 with
transit Guru on the income house to June 2027 — **the near term is
well-supported.** It is the stretch *after* it, 2028–2033, that is heavy on
construction and light on return.

### Against what §58 already found

§58 answered *"career growth"* from the chart alone, with no premise about a
...
- §58: **"Rahu–Shukra and Rahu–Surya are a money and recognition window, not a
...
- §58: **"advancement through demonstrated competence, not through position."**
  §22 finds the 6th outranks the 10th and the 10th lord ranks fourth.
- §58: **"growth is real, late, and stepped."** §22 finds both career grahas
  mature at 32 and 36, and puts the income crossover at April 2034.

**And they disagree about nothing, but they measure different things.** §58's
...
> Put together: **money arrives 2034–2037, position arrives from 2040.** The
> job he holds now is the instrument for the first, not yet for the second.

### What this does not say

1. **No amount.** Jyotisha does not produce a salary figure, and this reading
   has refused numeric claims everywhere else.
2. **No guarantee of the job itself.** The premise came from him. The chart is
   being asked what happens to it, not whether it exists.
3. **The weak 11th is a statement about flow, not about poverty.** The 2nd
   ranks 3 and its lord has the best net balance in the chart. **A slow-filling
   vessel that does not leak is not an empty one.**
4. **And the reading's standing advice applies exactly here.** The 6th outranks
   ...
   is built to do the second — it will feel like the right instrument and will
   be the wrong one. That is already listed among his blind spots.

---

## 23. The same question, from placement alone

§22 answered career and earning using Shodhya Pinda, Ashtakavarga bindus, Bhava
Bala ranks, a career score, and an income score **I built myself**. That is a
fair thing to object to. Half of those are constructed rather than classical,
and **a reading that only works with its own scoring is not a reading.**

So `verify_placement.py` throws all of it away. Nothing in this section uses
Shadbala, Ashtakavarga, Shodhya Pinda, Bhava Bala, Ishta/Kashta, Vimshopaka, or
any score. What is left is what Parashara actually works from: **which graha is
in which house, what it rules, what condition it is in, what it aspects, and
who it sits with.** Everything below is countable off the chart by hand.

**The test at the end is the one that matters: does the answer survive?**

### Where every house lord sits

This is the most informative table you can build without a number in it.

| House | Sign | Lord | Sits in | |
|---|---|---|---|---|
| 1 | Kanya | Budha | **8** | self → transformation |
| 2 | Tula | Shukra | **8** | wealth → others' resources |
| 3 | Vrischika | Mangal | **9** | effort → fortune |
| 4 | Dhanu | Guru | **10** | home → career |
| 5 | Makara | Shani | **9** | mind → fortune |
| 6 | Kumbha | Shani | **9** | service → fortune |
| 7 | Meena | Guru | **10** | partnership → career |
| 8 | Mesha | Mangal | **9** | transformation → fortune |
| 9 | Vrishabha | Shukra | **8** | fortune → transformation |
| 10 | Mithuna | Budha | **8** | career → transformation |
| 11 | Karka | Chandra | **9** | income → fortune |
| 12 | Simha | Surya | **8** | loss → transformation |

> **Every one of the twelve lords sits in the 8th, the 9th or the 10th.**
> Three houses out of twelve receive the entire chart. You need no strength
> measure to see what that means: **whatever happens in this life is routed
> through transformation, fortune and work. There is no other address.**

### Career, read only from placement

**The 10th lord is Budha, and it sits in the 8th.** Classically unambiguous:
the house of career is owned by a graha standing in the house of crisis,
research, hidden things and other people's resources. The work is
**investigative**, and the career is **not stable in form**.

**And that same graha is combust** — 9.00° from Surya, inside the 14° limit.
A combust 10th lord means the career significator is swallowed by the Sun:
**his own position obscured by the authority he stands next to.** Work done
under someone else's name. That is placement, not opinion.

**But the 10th is not empty.** Guru occupies it — **Amala Yoga** by placement
alone, one of the few classical yogas needing no strength test: a natural
benefic in the career house gives lasting reputation and clean standing.
**And the qualification is also pure placement** — Guru is in Mithuna, its
enemy's sign. **The reputation is real and the instrument is uncomfortable.**

### The aspect census — and a correction to §10

| House | Occupants | Aspects received |
|---|---|---|
| 1st | — | Rahu's 5th |
| **2nd** | — | **Surya's 7th, Budha's 7th, Guru's 5th, Shukra's 7th** |
| 3rd | Ketu | Chandra's 7th, Mangal's 7th, Shani's 7th, Rahu's 7th |
| 4th | — | Mangal's 8th, Guru's 7th |
| 5th | — | Rahu's 9th |
| 6th | — | Guru's 9th, Shani's 10th |
| 7th | — | Ketu's 5th |
| **8th** | Surya, Budha, Shukra | **none** |
| 9th | Chandra, Mangal, Shani, Rahu | Ketu's 7th |
| **10th** | **Guru** | **none** |
| 11th | — | Shani's 3rd, Ketu's 9th |
| 12th | — | Mangal's 4th |

**§10 reports that nothing aspects the 8th and calls it the one sealed chamber
in the chart. Counted properly there are two — and the second is the career
house.** That section has been corrected.

> **The 10th holds Guru and receives nothing from outside** — no help, no
> interference, no correction. **His career runs on its single occupant and on
> nothing else.** Whatever Guru is worth in the 10th is the whole of what the
> career house has.

**And the 2nd house is empty and receives four aspects — the most of any house
in the chart.** Among them **Guru**, the most benefic aspect in Jyotisha, and
**Shukra, its own lord aspecting its own house from the 8th.** A house that is
empty but aspected by its own lord and by Jupiter is classically **well
protected**. No strength table shows this.

### Earning, read only from placement

**The 2nd lord Shukra is in the 8th.** Wealth held is ruled by a graha in the
house of other people's resources — money through what is *transferred* rather
than earned in increments, arriving in events rather than in a steady line.

**The 11th lord Chandra is in the 9th, exalted.** Income is ruled by a graha
standing **exalted** in the house of fortune and elders. **This is a good
placement**, and it says something specific: **gains come through seniors,
mentors, teachers and well-disposed elders — through people who favour him,
not through mechanism.**

### The yogas that are pure placement

**Parivartana.** The 8th lord Mangal is in the 9th and the 9th lord Shukra is
in the 8th — **an outright exchange.** Transformation and fortune are not two
departments here; they are one mechanism wearing two names, and **neither can
be reached except through the other.**

**Vimala Yoga.** The 12th lord Surya stands in the 8th — a dusthana lord in a
dusthana, present by placement.

**Raja yoga.** Budha (lagna and 10th — kendra) conjunct Shukra (9th — trikona),
**in the 8th.**

**Dhana combination.** Chandra (11th) with Shani (5th) **in the 9th.** One
qualification, also pure placement: **Shani rules the 5th and the 6th** — a
trikona and a dusthana on one body. Schools differ on whether the trikona
prevails or the dusthana taints it. This reading does not adjudicate; it
records that **the chart's income combination is built on a graha with divided
loyalties.**

> **Note where they sit.** The raja yoga is in the **8th**. The income
> combination is in the **9th**. **Neither is in a career house** — so his
> elevation and his gains both arrive through the 8th–9th axis, through
> upheaval and through fortune, **rather than through the 10th.**
>
> **He is not promoted into things. He is delivered into them.**

### The career varga, still only placement

D10 ascendant **Kumbha**, lord **Shani**. Three grahas hold good D10 houses by
placement alone: **Shukra in the D10 10th itself**, and **Guru and Shani in D10
trikonas**. And **Budha — the birth chart's 10th lord — falls in a D10
dusthana**, the same verdict the rashi chart gave, reached independently in the
career varga.

> **The shape of his working life is owned by Shani** — structure, patience,
> service, long institutional time — **not by the 10th lord of the birth
> chart.**

### So does the answer survive without the numbers?

§22's four claims, tested against placement alone:

**1. "The employment relation is the strong part, not the title." — SURVIVES**,
by a different route. The 10th lord is combust in the 8th while the D10
ascendant is owned by Shani, the graha of service inside structures. No bindu
count required.

**2. "Income is the weak channel." — DOES NOT SURVIVE IN THAT FORM.** This is
the correction. **By placement the 11th lord is exalted. That is not
weakness.** What placement says instead is that income is **conditional rather
than weak**: it comes through the 9th — through elders, mentors and fortune —
and not through mechanism or accumulation. The score-based reading called that
*"weak flow"*; placement calls it *"flow that depends on people."* **Those are
different claims, and placement is the more classical one.**

**3. "Money arrives as events, not increments." — SURVIVES CLEANLY.** The 2nd
lord in the 8th says it alone, and the 8th–9th exchange reinforces it. This was
never a scoring claim.

**4. "Raises come from moving, not waiting." — PARTLY SURVIVES, WITH A CHANGED
REASON.** It rested on the 6th's bindu count, now discarded. What placement
supports is different: **the raja yoga sits in the 8th and the income
combination in the 9th, so advancement does not come through the 10th house at
all.** Change is still the mechanism — but because his elevation is not located
in his career house, not because he wins competitions.

> **And one thing placement says that the scores never did.** The 2nd is empty
> and aspected by its own lord and by Guru; the 11th lord is exalted; the 10th
> is sealed but holds Amala Yoga.
>
> **Read without a single strength figure, this is a better wealth chart than
> §22 described. The bindus were dragging the reading pessimistic.**
...
This is not a new finding; it is the mechanism §61 identified when asked why he
...
aspected by nothing but Ketu, and contains Upaketu** — §67 called it the
...
> 2038**, with the real expansion from **December 2040** — which §56 had
...
2. **The 6th and the D10 say employment.** §67's finding stands — the house of
...
3. **And §61 is the warning.** The one occupant of his three houses of desire
...
## 25. Bhanga — the cancellation rules, tested

*"Are there any cancel-out rules for the charts given"* is a better question
than it looks, and **this document had largely not answered it.** A search of
the reading returns no neecha bhanga, no Kuja dosha, no papakartari, no yoga
bhanga. Kemadruma is mentioned five times and never actually tested.

One item in that gap is substantial: **Mangal dosha had never been computed at
all**, despite three sections on marriage. It is the single question families
actually ask before a match.

Jyotisha's cancellation doctrines come in four families, and they work in
opposite directions:

| | |
|---|---|
| **A dosha is cancelled** | an affliction annulled by a counter-condition — *Kuja dosha bhanga, Kemadruma bhanga* |
| **A weakness is cancelled** | debilitation or combustion undone — *neecha bhanga, combustion exemptions* |
| **A yoga is cancelled** | a combination forms but cannot deliver — *yoga bhanga* |
| **A yoga requires affliction** | and is spoiled by strength — *the viparita raja yogas* |

Every rule below is **stated before it is applied**, so the reasoning can be
checked rather than taken. Where schools disagree, the disagreement is reported
rather than resolved.

### Two doctrines that are moot before we start

**Neecha bhanga.** The rule rescues a debilitated graha when its dispositor
sits in a kendra, or the graha exalted in that sign does, or the dispositor
aspects it. **Debilitated grahas in the rashi chart: none.** Every graha is
exalted, own, friendly, neutral or in an enemy sign — **not one is fallen.**
For a chart carrying this much load that is worth stating plainly. **There is
nothing to rescue.**

**Combustion exemption.** Combustion is annulled when the combust graha is
retrograde, in its own sign, or exalted.

| Budha, combust at **9.00°** from Surya | |
|---|---|
| retrograde? | **No** — speed +2.0609, direct |
| own sign? | **No** — in Mesha |
| exalted? | **No** |

> **No exemption applies.** The combustion of the lagna and 10th lord stands
> uncancelled — and since **no graha in this chart is retrograde**, no other
> body claims the exemption either.

### Kuja dosha — computed here for the first time

**The rule.** Mangal in the 1st, 2nd, 4th, 7th, 8th or 12th afflicts marriage,
reckoned from the **lagna**, from **Chandra**, and in many South Indian
traditions also from **Shukra**.

| Reckoned from | Mangal stands in | |
|---|---|---|
| **Lagna** | the **9th** | **clean** |
| Chandra | the 1st | **dosha** |
| Shukra | the 2nd | **dosha** |

**Present from Chandra and Shukra, absent from the lagna** — the single most
common configuration in real charts, and exactly why the doctrine is argued
about. **From the lagna, the reference most schools weight heaviest, he is
clean.**
...
| Cancellation rule | |
|---|---|
| 1. Mangal own sign or exalted | No — Vrishabha, neutral |
| **2. conjunct or aspected by Guru or Chandra** | **YES — conjunct Chandra** |
| **3. conjunct or aspected by Shani** | **YES — conjunct** |
| 5. in a kendra from Guru | No — 12th from Guru |
| 6. partner carries the same dosha | Unknowable — not supplied |

**Two cancellations fire, and both are strong ones.** Mangal is conjunct
**Chandra — and Chandra is exalted there** — and conjunct **Shani**. Rule 2 is
the most widely accepted cancellation in the whole doctrine, and it applies
here in its strongest form: **not a mere aspect but a conjunction, with the
Moon in its exaltation sign.**

> **Kuja dosha is absent from the lagna, present from Chandra and Shukra, and
> cancelled by conjunction with an exalted Chandra and with Shani.**
>
> Note what that does *not* say. It does not say the marriage is unafflicted —
> §67 found the 7th empty, aspected only by Ketu and holding Upaketu, and none
> of that involves Mangal. **It says the specific dosha people ask about is not
> the problem in this chart.**

### Kemadruma does not form

**The rule.** Kemadruma arises when no graha occupies the 2nd or 12th from
Chandra, and none is conjunct it — isolation, and support that does not arrive.

| | Sign | Occupants |
|---|---|---|
| 2nd from Chandra | Mithuna | **Guru** |
| 12th from Chandra | Mesha | **Surya, Budha, Shukra** |
| conjunct Chandra | Vrishabha | **Mangal, Shani, Rahu** |

> **It does not form, and it is not close.** All three positions are occupied.
> The chart's most-cited yoga of isolation is comprehensively absent.

### Papakartari — none, and for a structural reason

**The rule.** A house hemmed between malefics — one in the house before and one
in the house after — is under papakartari, scissors affliction.

**No house in this chart is under papakartari.** The 9th shows a
**shubhakartari** (benefic enclosure) — Budha and Shukra before, Guru after —
but it is **qualified rather than clean, because Surya sits in the 8th too**,
so the enclosure is mixed.

> This follows directly from the stellium. **Seven grahas occupy two adjacent
...
### Yoga bhanga — the family that actually bites here

**The rule**, and it is the least discussed of the four. A yoga can form
perfectly and still fail to deliver. The classical spoilers: its grahas stand
in a **dusthana**; a participant is **combust**; a participant is in an **enemy
sign**; its lords also rule dusthanas.

| Yoga | Located | Condition of participants |
|---|---|---|
| **Raja — Budha (1st, 10th) with Shukra (2nd, 9th)** | **8th — a dusthana** | **Budha neutral, COMBUST**; Shukra neutral |
| Amala — Guru in the 10th | 10th | Guru in **enemy** sign |
| Vimala — Surya, the 12th lord, in the 8th | 8th — a dusthana | Surya **exalted** |

> **The raja yoga is spoiled in two ways at once**: it sits in the 8th, and one
> of its two participants is combust. It is a genuine raja yoga — kendra lord
> with trikona lord, no argument — **standing in the crisis house with its
> kendra lord swallowed by the Sun.**
>
> **This is the central yoga bhanga of the chart**, and it is the structural
> reason a reading that keeps finding raja yogas keeps also finding they do not
> simply pay out.
...
### And the yoga that may be cancelled by strength

**The rule inverts everything above.** The viparita raja yogas — Harsha, Sarala,
Vimala — arise when a dusthana lord stands in a dusthana. Their whole logic is
that **a bad house's ruler, badly placed, cancels its own harm.** The yoga
therefore *depends on the lord being spoiled.*

A significant body of opinion holds that **a viparita yoga is itself cancelled
when the dusthana lord is strong** — because a graha in good condition does not
ruin the house it rules, and there is nothing for the inversion to work on.

**Vimala is formed**: the 12th lord Surya stands in the 8th. **But Surya is
exalted, vargottama, and the best-dignified graha in the chart.**

> By the formation rule it is **present**. By the affliction rule it is
> **cancelled** — an exalted 12th lord is not a spoiled one, and viparita needs
> spoilage.
>
> **This reading does not adjudicate.** It records that the chart's one
> viparita yoga rests on a graha too well placed to satisfy the doctrine that
> produces it — and notes that **§9 already found Vimala dissolving under every
> cuspal house frame**, by a completely different mechanism. **Two independent
> routes to doubting the same yoga is worth recording.**

### What the cancellation pass changes

1. **Kuja dosha** — the biggest practical result, and a favourable one. **Not
   an obstacle.**
2. **Kemadruma** — absent, comprehensively.
3. **Papakartari** — none, for a structural reason.
4. **Neecha bhanga** — does not arise; no graha is debilitated.
5. **Combustion** — **not** cancelled. The weakness of the lagna and 10th lord
   stands exactly as the reading has always described it.
6. **Yoga bhanga** — the raja yoga is spoiled twice, Amala is diminished, and
...
> result — **a chart protected from the standard misfortunes and made to work
> for its advantages.** It is the same asymmetry the reading keeps meeting from
> every other direction.

---

## 26. The navamsa, read as a chart

§11 prints the D9 alongside the other fifteen Shodashavarga charts — a
placement list with house class and dignity. **That is everything this document
has ever done with it.** For the varga that ranks second only to the rashi
chart, and governs the spouse, dharma, the second half of life and the real
inner strength of every graha, **a table row is not enough.**

`verify_navamsa.py` reads it as a chart: its own lagna, its own house lords,
dignity gained and lost between D1 and D9, yogas forming inside it, and two
classical points the reading had never computed.

*One methodological note. Applying Parashari drishti* inside *a divisional
chart is done by many and rejected by others, on the grounds that a varga maps
dignity rather than a sky. Nothing load-bearing below depends on it.*

### The first fact, and this document has never stated it
...
> **The ascendant is vargottama.** §11 prints it in a table without remarking
> on it.

Classically, and without any strength measure: **the person is the same person
in the inner chart as in the outer one.** The self does not change shape
between what is presented and what is actually there. A vargottama lagna gives
steadiness of identity, resilience, and specifically that **the second half of
life confirms the first rather than contradicting it.**

**For a chart this full of tension between measures, it is the single most
stabilising thing in it.**

And note who sits on it: **Rahu occupies the D9 lagna** — and runs the
mahadasha to December 2040. **The current eighteen years are governed by the
graha placed on the inner self**, which is a structural reason the reading
keeps describing this period as identity-level rather than circumstantial.

### The navamsa as a chart

**D9 lagna Kanya, lord Budha — in D9 house 11, Karka, enemy sign.**

| D9 house | Sign | Lord | Lord in | Occupants | |
|---|---|---|---|---|---|
| **1** | Kanya | Budha | 11 | **Rahu** | self |
| 2 | Tula | Shukra | 3 | — | wealth, speech |
| 3 | Vrischika | Mangal | 7 | Shukra | effort |
| 4 | Dhanu | Guru | 6 | — | home, mother |
| 5 | Makara | Shani | 10 | Chandra | children, mind |
| 6 | Kumbha | Shani | 10 | Guru | service, illness |
| **7** | Meena | Guru | 6 | **Mangal, Ketu** | **SPOUSE** |
| 8 | Mesha | Mangal | 7 | Surya | transformation |
| 9 | Vrishabha | Shukra | 3 | — | dharma, father |
| **10** | Mithuna | Budha | 11 | **Shani** | career |
| 11 | Karka | Chandra | 5 | Budha | gains |
| 12 | Simha | Surya | 8 | — | loss, moksha |

**Compare that with §23's finding about the rashi chart**, where all twelve
lords crowd into just three houses. **In the navamsa they scatter across
seven.** The outer chart is concentrated; **the inner chart is distributed.**

### What each graha gains and loses between D1 and D9

This is the navamsa's classical job: a graha strong outside and weak inside
**promises more than it delivers.**

| Graha | D1 | D9 | |
|---|---|---|---|
| **Surya** | exalted | exalted | unchanged — **VARGOTTAMA** |
| **Chandra** | **exalted** | neutral | **weaker inside** |
| Mangal | neutral | **friend** | **stronger inside** |
| **Budha** | neutral | **enemy** | **weaker inside** |
| Guru | **enemy** | neutral | **stronger inside** |
| Shukra | neutral | neutral | unchanged |
| Shani | friend | friend | unchanged |

**Two of those four shifts change claims already in this document.**

**Chandra is exalted in D1 and only neutral in D9** — the classic
promises-more-than-it-delivers pattern, and it lands on a claim made two
sections ago. **§24 leaned on the 11th lord being exalted** as the counterweight
to a badly built 11th house. **The navamsa qualifies that.** The exaltation is
real outside and does not hold up inside, so the gains-through-elders channel
is **a genuine promise that thins on delivery.** §24 is not overturned — the
placement is still the best thing the 11th has — **but it was stated more
confidently than the navamsa supports.**

**Budha is neutral in D1 and enemy in D9.** The lagna and 10th lord is combust
outside and uncomfortable inside. **It gets worse, not better** — there is no
chart in the pair where the instrument of self is at ease.

And the two that improve matter too. **Guru rises from enemy to neutral**, so
the marriage and home significator is better inside than out. **Mangal rises
from neutral to friend** — which bears directly on the next finding.

**Vargottama, computed:** grahas — **Surya alone**; lagna — **yes**.

> A graha both exalted and vargottama is about as well-made as Parashari
> dignity gets, and this chart has exactly one. **It is the 12th lord, standing
> in the 8th. The best-built thing in the chart rules loss and sits in crisis.**

### The D9 seventh — the point of the varga

| | |
|---|---|
| D9 7th sign | Meena |
| D9 7th lord | **Guru — in D9 house 6, a dusthana** |
| D9 7th holds | **Mangal, Ketu** |

**Two malefics occupy the navamsa seventh.** §11 lists both placements and
never puts them side by side. Read as a chart they are one configuration: the
house of the spouse, in the varga of the spouse, holding the graha of severance
and the graha of friction and nothing else. **And its lord — the same Guru that
rules the D1 7th — falls in a D9 dusthana.**

**With one mitigation the dignity table supplies:** Mangal is in **Meena, a
friendly sign**, and is one of only two grahas that *gain* dignity in the
navamsa. **A well-dignified malefic in the 7th is not the same as an afflicted
one** — friction that is competent rather than chaotic. Ketu carries no dignity
either way.

**What this does not overturn:** the D1 7th is Meena at SAV 33 and Bhava rank
4; the Upapada falls in the rank-2 4th; the 8th from the Upapada is too weak to
dissolve the marriage; and Kuja dosha is cancelled (§25).

> **The outer chart says the marriage is structurally sound. The inner chart
> says it is emotionally austere.** Those are not contradictory — they are the
> two halves of what this reading has called **durable and undemonstrative**
> from the beginning. **The D9 is where the "undemonstrative" comes from, and
> until now that word was never actually sourced.**

### The navamsa carries no yoga at all

Computed within D9: **no kendra lord shares a house with a trikona lord. No
exchange.**

Set that against the rashi chart, which has both — Budha with Shukra in the
8th, and the 8th/9th parivartana. **The outer chart is full of combinations and
the inner chart is bare.**

> Classically that reads one way: **what he has is not seconded from the
> inside.** The rashi yogas are real — §25 shows exactly how they are spoiled —
> but **a chart whose navamsa confirmed its rashi chart would deliver more
> easily than this one does.**

### The 64th navamsa — never computed here

**The rule.** From the navamsa occupied by the Moon, and separately from the
lagna's navamsa, the **64th navamsa** forward is a classical sensitive point —
the **Khara**, or harsh, navamsa. Its lord, the **Khareshi**, is watched.
Counting inclusively, that is 63 navamsas on; each navamsa advances the
navamsa-sign by one, and 63 mod 12 = 3, so **it is the 4th sign from the
navamsa occupied.**

| From | Navamsa | 64th navamsa | **Khareshi** |
|---|---|---|---|
| **Chandra** | Makara | Mesha | **Mangal** |
| **Lagna** | Kanya | Dhanu | **Guru** |

**A correction to the draft.** I had written that both Khareshis are the same
graha. **They are not**, and the computation says so plainly. The true version
is more pointed, because of what those two grahas rule:

> **Mangal**, the Khareshi from the **mind**, rules the **3rd and 8th** — the
> graha whose mahadasha ran ages 13.7 to 20.7, **the transformation already
> lived.**
>
> **Guru**, the Khareshi from the **body**, rules the **4th and 7th** — **the
> marriage, which is the thing ahead.**
>
> **One points at what is done. The other points at what is coming.** Neither
> is a prediction; both are markers the tradition says to watch, and they are
> watching the two things this reading has spent the most time on.

### The second half of life

The navamsa is weighted more heavily after about 35.

**Shani in the D9 tenth** is the placement that matters most for the later
decades, and it is one of the four career credentials the reading has cited
since §58. **Here is where it actually comes from**: the graha of structure
occupies the career house of the chart that governs the second half of life.
Its own mahadasha opens December 2056.

**And the D9 lagna lord is Budha, in an enemy sign.** Whatever else the second
half improves, **the instrument of self does not become easy.**

### What the deep pass adds

1. **The lagna is vargottama** — never stated, and the most stabilising fact in
   the chart.
2. **Rahu occupies the D9 lagna** and runs the mahadasha to 2040.
3. **The D9 7th holds Mangal and Ketu**, its lord in a D9 dusthana — the source
   of "undemonstrative".
4. **The navamsa contains no raja yoga and no exchange**, where the rashi chart
   has both.
5. **Chandra weakens inside**, qualifying §24's counterweight.
6. **The two Khareshis are the lords of the 8th and the 7th** — what is done,
   and what is coming.

> **The outer chart is crowded, contradictory and full of combinations. The
> inner chart is steady, bare and austere.**
>
> A vargottama lagna on an empty-handed navamsa is **a person who is exactly
> what he appears to be, holding fewer cards than the outer chart suggests.**

---

## 27. House nature — every scheme, assembled

The words *kendra*, *trikona*, *upachaya* and *dusthana* appear **237 times in
this document and are never once set out as a system.** They are used as
adjectives. And **two whole classification families are missing altogether** —
**maraka**, with zero mentions in the entire reading, and **panapara /
apoklima**, the succedent and cadent houses, also zero. For this chart the
second omission turns out to matter a great deal.
...
| Scheme | | |
|---|---|---|
| **By angle** | kendra 1 4 7 10 · panapara 2 5 8 11 · apoklima 3 6 9 12 | strength of position |
| **By benefit** | trikona 1 5 9 · upachaya 3 6 10 11 · dusthana 6 8 12 | quality of result |
| **By purushartha** | dharma 1 5 9 · artha 2 6 10 · kama 3 7 11 · moksha 4 8 12 | which aim of life |
| **By mortality** | maraka 2 7 | classical difficulty markers |
| **By obstruction** | badhaka — the 7th, for a dual lagna | what blocks |
| **By modality** | chara / sthira / dwiswabhava, from the sign | how it moves |

### All six, applied

**Lagna Kanya — a dwiswabhava sign, so the badhaka is the 7th.**

| Ho | Sign | Modality | Angle | Benefit | Aim | Lord | Occupants |
|---|---|---|---|---|---|---|---|
| 1 | Kanya | dwiswabhava | **kendra** | trikona | dharma | Budha | — |
| 2 | Tula | chara | panapara | — | artha | Shukra | — **maraka** |
| 3 | Vrischika | sthira | apoklima | upachaya | kama | Mangal | **Ketu** |
| 4 | Dhanu | dwiswabhava | **kendra** | — | moksha | Guru | — |
| 5 | Makara | chara | panapara | trikona | dharma | Shani | — |
| 6 | Kumbha | sthira | apoklima | **upachaya+dusthana** | artha | Shani | — |
| 7 | Meena | dwiswabhava | **kendra** | — | kama | Guru | — **maraka+badhaka** |
| 8 | Mesha | chara | panapara | dusthana | moksha | Mangal | **Surya, Budha, Shukra** |
| 9 | Vrishabha | sthira | apoklima | trikona | dharma | Shukra | **Chandra, Mangal, Shani, Rahu** |
| 10 | Mithuna | dwiswabhava | **kendra** | upachaya | artha | Budha | **Guru** |
| 11 | Karka | chara | panapara | upachaya | kama | Chandra | — |
| 12 | Simha | sthira | apoklima | dusthana | moksha | Surya | — |

### Where the nine grahas fall

| Scheme | | |
|---|---|---|
| **kendra** | **1** | Guru |
| panapara | 3 | Surya, Budha, Shukra |
| **apoklima** | **5** | Chandra, Mangal, Shani, Rahu, Ketu |
| trikona | 4 | Chandra, Mangal, Shani, Rahu |
| upachaya | 2 | Guru, Ketu |
| dusthana | 3 | Surya, Budha, Shukra |
| **maraka** | **0** | — |

**This is the result nobody has stated.**

> **One graha in a kendra. Five in the cadent houses.**

The kendras are the pillars — visible action, standing, effect on the world.
The apoklima houses are the weakest angular position in the scheme; grahas
there act **late, indirectly, and off the main axis.**

**Eight of nine grahas sit outside the kendras.** This document has noted "one
kendra occupied" exactly once, in passing, as the reason no Panchamahapurusha
yoga can form. **It never drew the consequence:**
...
> results arriving through the 8th–9th axis rather than the 10th, and
> advancement that has to be built rather than occupied.

### The purushartha split

Every graha sits in exactly one of the four aims, so this is a clean partition
of the nine.

| | Houses | | Count |
|---|---|---|---|
| **Dharma** | 1 5 9 | meaning, ethics, the father, fortune | **4** |
| Artha | 2 6 10 | resources, work, the material | **1** |
| Kama | 3 7 11 | desire, relationship, attainment | **1** |
| **Moksha** | 4 8 12 | release, endings, the interior | **3** |

> **Seven of nine grahas sit in dharma and moksha. One in artha. One in kama.**

And note *which* one is in kama: **Ketu, the graha that removes wanting, alone
in the 3rd.** §24 found that when asked about a rank ladder. Here it turns out
to be part of a much larger pattern.

> The chart is not merely thin on desire. **It is weighted seven to two toward
> meaning and release over acquisition and wanting** — and that was sitting in
> the classification the whole time.

### The overlaps, where the schemes earn their keep

| Ho | Labels | Occupants |
|---|---|---|
| **6** | apoklima · upachaya · **dusthana** · artha | empty |
| 10 | kendra · upachaya · artha | Guru |
| 8 | panapara · dusthana · moksha | Surya, Budha, Shukra |
| **9** | **apoklima · trikona** · dharma | Chandra, Mangal, Shani, Rahu |
| 3 | apoklima · upachaya · kama | Ketu |
| 1 | kendra · trikona · dharma | empty |

**The 6th is the interesting one** — apoklima, upachaya, dusthana *and* artha
at once. A house that is simultaneously a place of suffering and **a place that
improves with time**, whose aim is material. That is exactly why the reading
keeps finding the 6th doing useful work — 41 bindus, the D10 ascendant sign —
while also calling it a dusthana. **Both labels are correct and they describe
the same mechanism: adversity that compounds into competence.**

**The 9th is apoklima and trikona together**, holding four grahas: the most
fortunate class of house in the weakest angular position. **Fortune that is
real but does not act directly.**

**And the 10th is kendra and upachaya at once.** His career house is both a
pillar and a slow-builder. **It does not arrive; it accrues.**

### What each graha *is* for this lagna

House nature also determines what a graha **is**, because a graha takes its
character from what it rules. Rules stated before applying them: trikona lords
are benefic; dusthana lords malefic; lords of 3 and 11 malefic by lordship; **a
natural benefic ruling two kendras takes kendradhipati dosha** and behaves as a
malefic; the lagna lord is benefic regardless.

| Graha | Rules | | Verdict |
|---|---|---|---|
| Surya | 12 | dusthana | malefic — dusthana lord |
| Chandra | 11 | upachaya | malefic by lordship |
| Mangal | 3, 8 | upachaya; dusthana | malefic — dusthana lord |
| **Budha** | 1, 10 | trikona+kendra; kendra | **benefic — lagna lord** *(kendra dosha contested)* |
| **Guru** | 4, 7 | **kendra; kendra** | **MALEFIC — kendradhipati dosha** |
| **Shukra** | 2, 9 | neutral; **trikona** | **benefic — trikona lord, no dosha** |
| Shani | 5, 6 | trikona; dusthana | **mixed** |

**Guru is a functional malefic for this lagna.** It rules the 4th and 7th, both
kendras, and is a natural benefic — full kendradhipati dosha. The reading
already lists this as one of Amala Yoga's six qualifications (§14), **but has
never stated it as what it is: the chart's great benefic is, by lordship,
working against him. And Guru rules his marriage and his home.**

**Shukra is the cleanest benefic he has** — one trikona, no kendra, no
dusthana, **no dosha of any kind.** It is also the Atmakaraka and carries the
best net balance in the chart.

> **For a Kanya lagna, Shukra is the graha to trust** — and this reading has
> been circling that conclusion from six directions without ever stating the
> lordship reason.

### Maraka — zero mentions until now

**The rule.** The 2nd and 7th are maraka houses and their lords are marakas.
**This reading declines longevity (§70) and continues to decline it**; what
follows is structural only, with no application to lifespan.

| | Sign | Lord | Occupants |
|---|---|---|---|
| 2nd | Tula | **Shukra** | **empty** |
| 7th | Meena | **Guru** | **empty** |

**Both maraka houses are empty.** And their lords are the two grahas just
identified as the extremes of the functional scale — **Shukra, the cleanest
benefic, and Guru, the one carrying kendradhipati dosha.**

**The 7th is also the badhaka** for a dual lagna, so it carries **maraka,
badhaka, kendra and kama simultaneously** — four labels. §24 found it empty,
aspected by nothing but Ketu, holding Upaketu. **It is the most heavily
classified and least occupied house in the chart.**

### What the census says that nothing else does

1. **One graha in a kendra, five in apoklima.** No direct angular leverage —
   the structural root of "responsibility without title".
2. **Seven of nine in dharma and moksha**, one each in artha and kama, and the
   one in kama is the graha that removes wanting.
3. **The 6th carries four labels at once** — which is why it reads as both his
   weakest class of house and his strongest measured one.
4. **Guru is a functional malefic here**, and it rules his home and his
   marriage. **Shukra takes no dosha at all.**
5. **Both maraka houses are empty**, their lords the best and worst of his
   functional grahas.

> **A chart with almost nothing on its pillars, almost nothing in its houses of
> wanting, and almost everything in the houses of meaning and release.**
>
> Which is the same sentence this reading reached from Ashtakavarga, from
> Jaimini, from the navamsa and from the dasha sequence. **The classification
> gets there with no arithmetic at all.**

---

## 28. The current transit, verified and read

He supplied a live transit table. **This document's discipline with supplied
data is to verify it first** — §2 did that with the birth data and found a
constant ayanamsa offset — so the same is done here before a word of
interpretation.

### Verifying it

The Moon fixes the moment: it moves about 13° a day, so a match to the
arcminute pins the time to within a couple of minutes. Searching 18–24 August
2026 for a Moon at 227.07 sidereal returns **one** answer:

> **21 August 2026, 12:42 IST.** Which is today.

| Body | Supplied | Computed | Diff | Sign |
|---|---|---|---|---|
| Surya | 124.03 | 124.04 | 0.5′ | Simha |
| Chandra | 227.07 | 227.07 | 0.0′ | Vrischika |
| Mangal | 72.29 | 72.29 | 0.2′ | Mithuna |
| Budha | 117.41 | 117.41 | 0.2′ | Karka |
| Guru | 107.18 | 107.19 | 0.3′ | Karka |
| Shukra | 169.75 | 169.76 | 0.4′ | Kanya |
| Shani | 349.97 | 349.98 | 0.3′ | Meena |
| Rahu | 305.63 | 305.64 | 0.5′ | Kumbha |
| Ketu | 125.63 | 125.64 | 0.5′ | Simha |

**Worst disagreement across all nine: 0.5 arcminutes.** Uranus and Neptune
reproduce equally well. **Pluto is out by 22.8′** — too large for rounding;
different sources use different Pluto models, and it changes nothing here.
**The outer planets are not used below.** Parashari jyotisha works with nine
grahas; Uranus, Neptune and Pluto have no rulership, no aspect doctrine, no
dasha, and no place in any technique this reading applies.

**And one row does not verify.**

| | |
|---|---|
| supplied Lagna | **83.90** — Mithuna 23°54′ |
| Guntur ascendant at 12:42 IST | **219.44** — Vrischika 9.44° |

That is most of a chart apart. Working backwards: an ascendant of 83.90 occurs
at Guntur at **03:02 IST**, ten hours earlier, when the Moon would read 222.27
rather than 227.07. Solving instead for a longitude that would give that
ascendant *at this instant* returns **−65°** — the western Atlantic.
...
for a stored location or a stale timestamp.

> **And it does not matter for anything below.** Gochara is read from the
> **natal** Moon and the **natal** lagna. The transit ascendant plays no part
> in it. **The one row that cannot be verified is the one row the technique
> does not use.**

### Where the transits fall

Natal lagna **Kanya**; natal Chandra in **Vrishabha**. Each transit weighted by
the **transiting graha's own bindus** in the sign it occupies — the
Ashtakavarga method, and the thing that separates a transit reading from a list
of positions. Threshold is 4.

| Graha | Transit sign | Dignity | From lagna | From Moon | Bindus | Gochara |
|---|---|---|---|---|---|---|
| Surya | Simha | own | 12th | 4th | 4 | not favourable |
| Chandra | Vrischika | debilitated | 3rd | 7th | 4 | **favourable** |
| Mangal | Mithuna | enemy | 10th | 2nd | 4 | not favourable |
| **Budha** | Karka | enemy | 11th | 3rd | **2** | not favourable |
| **Guru** | Karka | **exalted** | **11th** | 3rd | 5 | not favourable |
| Shukra | Kanya | **debilitated** | **1st** | 5th | 5 | **favourable** |
| **Shani** | Meena | neutral | 7th | **11th** | 5 | **favourable** |
| Rahu | Kumbha | — | 6th | 10th | — | **favourable** |
| Ketu | Simha | — | 12th | 4th | — | not favourable |

**Four of nine favourable by classical gochara from the Moon.**

### The four things that actually matter today

**1. Guru is exalted, in his 11th, during its own antardasha.** Transit Guru in
**Karka — its exaltation sign** — in the **natal 11th**, on 5 bindus, while
**Rahu–Guru** runs to 31 January 2028. Three things point at the same graha at
once. §22 computed that window from the ephemeris — *"Guru in the 11th, INCOME,
Aug 2026 – Jun 2027"* — and here it is in his own data, **with an exaltation
that section never mentioned.**

**And the counter-reading, which gets equal weight.** Measured the classical
way, from the natal Moon, **Guru is in the 3rd — not one of its benefic gochara
houses.**

> From the natal **lagna**: 11th, exalted, 5 bindus — **good.**
> From the natal **Moon**: 3rd — **not good.**
>
> The two references disagree, and this reading does not get to keep only the
> favourable one. **What survives both:** it is the antardasha lord, it is
> exalted, and it is in the income house until June 2027. **Real, and
> qualified** — the same shape as everything else in this chart.

**2. Shani is in the 11th from the Moon — its single best position.** The 3rd,
6th and 11th from the Moon are the only places Saturn is benefic in gochara,
**and it is in the best of them**, on 5 bindus, sitting in the natal 7th.

> **Saturn leaves Meena for Mesha on 3 June 2027** — the 12th from his natal
> Moon — **and Sade Sati begins.**
>
> **The transit is currently in its most favourable classical position, and its
> next move is into its worst.**

§21 dated the marriage window's close to 3 June 2027 and §20 called it "the
clear window". **This is what that looks like from inside: the clear part is
running now, with about nine months left.**

**3. Budha is combust, on 2 bindus, and running the pratyantardasha.** Transit
Budha is **6.62° from the Sun** — his own table marks it — with **2 bindus, the
lowest of any transiting graha**, in an unfavourable gochara house. And the
current pratyantardasha is **Rahu–Guru–Budha, May–September 2026.**

> Budha is also his **natal lagna lord and 10th lord, combust natally too** —
> the same affliction repeating in transit over the graha that already carries
> it. **This is the weakest few weeks of the current antardasha**, and it ends
> in September. Nothing dramatic is implied; it is a reason not to read the
> last month as representative of the window.

**4. Mangal is 2.51° from his natal Guru.** Transit Mangal at 72.29 against
natal Guru at 74.80 — passing over the graha that forms Amala Yoga in his 10th,
rules his 4th and 7th, and runs the current antardasha. Mangal carries exactly
4 bindus in Mithuna — the threshold, adequate rather than strong. **A malefic
transit over the antardasha lord is a short contact, not a period**; Mangal
clears the degree within days. Worth noting because of *what* it lands on, not
because it forecasts anything.

### What the transit confirms

This is the useful part of a live chart: **it tests dated claims made earlier
from computation alone.**

| Claim | Made in | Status |
|---|---|---|
| Transit Shani in the natal 7th until 3 Jun 2027 | §21 | **confirmed** |
| Guru in the 11th, Aug 2026 – Jun 2027 | §22 | **confirmed** |
| Antardasha Rahu–Guru to Jan 2028; pratyantar Budha to Sep 2026 | §22 | **consistent** |
| Sade Sati begins 3 Jun 2027 — Shani not yet in the 12th from the Moon | §17 | **consistent** |

**Four dated claims, all made before this data arrived, all holding.**

### The honest summary of this moment

**Favourable:** Guru exalted in the income house running its own antardasha;
Shani in its best gochara position; Shukra crossing the natal lagna — **though
debilitated in Kanya, which has to be said rather than glossed**; Rahu in the
6th, an upachaya, where nodes do well.

**Not favourable:** Budha combust on 2 bindus while running the
pratyantardasha; Surya and Ketu together in the natal 12th; **five of nine
grahas outside their benefic gochara houses.**

> **This is the good stretch, and it is dated.** Saturn is in the best position
> it occupies in the whole cycle and moves to the worst on **3 June 2027**.
> Jupiter is exalted in the house of gains until it leaves Karka. **Nine
> months.**
>
> §20 said *"whatever is worth securing, secure it before then."* **The
> supplied transit chart is that advice with the clock showing.**

---

## 29. Job loss and career disruption

Never asked, and it is a different question from *"career growth"* (§58) or
*"how will earning grow"* (§22). Those ask what the career **does**. This asks
what happens when it **breaks**.

The apparatus is mostly **bhavat bhavam** — reading a house from another house:

| | |
|---|---|
| the 10th | the job and the standing themselves |
| the 10th **lord** | the instrument that carries them |
| **12th from the 10th = the 9th** | loss of career, expenditure of it |
| 8th from the 10th = the 5th | sudden upheaval of career |
| the 6th | the employment relation, disputes, rivals |
| the badhaka = the 7th | obstruction |

### The first result shapes everything else

| | Sign | Occupants |
|---|---|---|
| **the 10th** | Mithuna | **Guru** |
| the 10th lord | **Budha — in the 8th, combust** | |
| **12th from 10th = 9th** | Vrishabha | **Chandra, Mangal, Shani, Rahu** |
| 8th from 10th = 5th | Makara | empty |
| the 6th | Kumbha | empty |
| badhaka = 7th | Meena | empty |

> **Aspects on the 10th house: none. Nothing reaches it.**

§23 found the 10th is one of only two houses in this chart receiving no aspect
at all. Applied to *this* question it says something specific and rather
reassuring:
...
> is **Guru**, forming Amala Yoga.
>
> **The chart contains no structure for a career being destroyed from
> outside.**

### The vulnerability is the lord, not the house

Everything fragile about his career sits in **Budha**:

| | |
|---|---|
| combust | 9.00° from Surya, no exemption (§25) |
| placed | in the **8th** — a dusthana |
| Shadbala | **the only graha failing its minimum** |
| Dig Bala | 4.28 of 60 — lowest of any body |
| D9 | **enemy sign** — worse inside, not better (§26) |
| D10 | falls in a D10 dusthana |
| as career agent | ranks 4th in his own chart |

> **The career house is protected and unreachable. The career lord is the
> weakest graha in the chart.**
>
> So job loss here does not arrive as an external event striking his position.
> It arrives as **the instrument failing to hold** — his own footing, his own
> clarity about what he is doing, his own visibility.

**And the 12th-from-the-10th is the crowded house.** The loss-of-career house
is the **9th**, holding four grahas including **Rahu in Marana Karaka Sthana**
and Shani. That has to be read carefully rather than dramatically: the 9th is
*also* the trikona of fortune, and this reading has treated it as such
throughout. Both are true at once.

> Classically the 12th from a house is where its matters are **spent** — not
> destroyed, spent. Four grahas there says career is repeatedly **poured into
> something**: dharma, elders, teaching, belief, the father, foreign concerns.
> **The structure of a man who gives his working life away to something he
> considers larger, more than once.**
>
> And it is the same 9th where §24 found his gains come from. **Career flows
> out through the house his gains flow in through.**

### Five things arguing against serious loss

1. **Amala Yoga** — a benefic alone in the 10th gives reputation that does not
   tarnish. §25 found it diminished by an enemy sign but **not cancelled**.
2. **The 10th is unaspected** — nothing can reach it.
3. **The 6th is his strongest house by bindus (41)** — and the 6th is the house
   of the employment relation and of winning contests. **Protection in exactly
   the domain where jobs are lost:** disputes, rivals, reviews, competition for
   a role.
...
5. **The lagna is vargottama** (§26) — identity does not collapse when
   circumstances do.

> **This is not a chart that describes career ruin. It describes a career that
> is hard to build and hard to destroy.**

### The one dated window

Two things must coincide: a dasha that activates the career apparatus, and a
transit that pressures it.

**Dasha side** — periods run by the 10th lord, the 8th lord, or Ketu:

| | | |
|---|---|---|
| **Rahu–Budha** | Dec 2030 – Jun 2033 | the 10th lord itself — combust, in the 8th |
| **Rahu–Ketu** | Jun 2033 – Jul 2034 | severance |
| Rahu–Mangal | Dec 2039 – Dec 2040 | the 8th lord |

**Transit side** — **Shani in Mithuna, the natal 10th: 31 May 2032 – 13 July
2034**, carrying **1 bindu of 8**.

> One bindu is **the weakest planet-sign cell in this chart's entire
> Ashtakavarga.** §17 found it while dating Sade Sati and read it for the Moon.
> Read for the *career* it says something sharper: **Saturn crosses his career
> house on the least support any transit in his chart ever has** — and it is
> simultaneously the third phase of Sade Sati.

**A correction to the draft.** I had written the concentration as ending June
2033. The overlap says otherwise: **Rahu–Ketu also runs entirely inside the
Shani transit**, and Ketu is the *more* relevant graha here, not the less.

| | |
|---|---|
| **Jun 2032 – Jun 2033** | Shani in the 10th **+ Rahu–Budha** — the 10th lord's own period, the chart's weakest graha |
| **Jun 2033 – Jul 2034** | Shani in the 10th **+ Rahu–Ketu** — severance, under the same one-bindu transit |

**Twenty-five months, in two phases, with the third phase of Sade Sati running
throughout.** §17 already called Rahu–Budha "the hinge" and §63 called it
identity and career reassessment — both reached before this question was asked.

> **That is the career-vulnerable stretch in this chart, and there is only
> one.** Nothing else in the visible timeline stacks three career-negative
> factors — and **the second phase is the more exposed**, because Ketu is what
> it is.

### What kind of loss — and this is the real answer

The chart is unusually clear about the mechanism, and it is not the expected
one.

**Against being removed:** nothing aspects the 10th, so no malefic can strike
the position; the 10th holds only Guru and Amala stands; the 6th — disputes and
rivals — is his strongest house by bindus; the 10th is upachaya and recovers.

**For leaving:** **Ketu is the sole occupant of the three houses of desire**
(§27), and Ketu's function is to make a thing stop mattering; §61 established
the chart's central mechanism as **setting things down**; the
12th-from-the-10th holds four grahas, so career is *spent*; and the 10th lord
sits in the **8th**, the house of endings that are not endings.

> **Job loss in this chart is overwhelmingly likely to be resignation rather
> than dismissal.**
>
> The structures that would show someone being fired are **genuinely absent,
> not merely weak**. The structures that show someone walking out of a role
> that has stopped meaning anything to him are **the strongest signatures the
> chart owns.**

**And the warning follows from that.** In **June 2032 – July 2034**, under
Saturn in the 10th on one bindu and the 10th lord's own weak period, the danger
is not that someone takes his job.

> **It is that he puts it down, at the worst possible moment, and calls it a
> decision.**

§63's timeline already carries *"do not resign here"* against a much smaller
window in December 2028. **The same advice belongs to 2032–34 and carries far
more weight there** — and this reading had never put it there.

### What this does not say

1. **No event is predicted.** Whether a job is lost is not something Jyotisha
   settles.
2. **Gaps between jobs are not ruin.** The 10th is an upachaya with an
   unblemished benefic in it. **Interruption is much better supported than
   collapse.**
3. **The 2032–34 window is six years out.** Nothing here bears on the job he
   holds now — §28 found the current transits are the favourable stretch,
   running to June 2027.
4. **The chart's standing advice applies.** The 6th outranks the 10th, so a
   change of position is his strongest move — **but a change made *from* a
   position, not from having left one.** That distinction is the whole of it.

---

## 30. Career from D1 and D9 only

**The constraint, stated plainly, because it shapes everything.** He asked for
both charts read deeply with every career concept applied, and for nothing else
brought in. So this uses **the rashi chart and the navamsa and nothing else** —
no D10, the dedicated career varga; no Ashtakavarga, Shadbala or constructed
scores (his earlier instruction, kept); no transits or dasha, which are timing
rather than career concepts.

What is left is larger than it sounds. **Four of the techniques below have
never been applied in this document at all.**

### Three career references, not one

Parashara reads a house from the lagna, from **Chandra** and from **Surya**.
Most readings use only the first. **This document has used only the first.**

| Reference | 10th from it | Lord | Natal house | Occupants |
|---|---|---|---|---|
| the **lagna** | Mithuna | **Budha** | 10th | Guru |
| **Chandra** — the mind | Kumbha | **Shani** | 6th | empty |
| **Surya** — the soul | Makara | **Shani** | 5th | empty |

> **Budha is the career lord from the lagna only. Shani is the career lord from
> both Chandra and Surya.**

That is the whole of an argument the reading kept running into — §21 found the
10th lord ranks fourth as a career agent behind Shani, §23 found the same from
placement, §29 found the career vulnerability is entirely in Budha. **All of it
follows from one placement fact, with no score anywhere:**

> His **nominal** profession is Budha's — analysis, communication, commerce.
> His **actual** working life belongs to Shani: structure, service, endurance,
> time.

### The 10th house in D1, and what intervenes in it

| | |
|---|---|
| sign | Mithuna — dwiswabhava, air |
| lord | **Budha, in the 8th**, neutral, combust |
| occupants | **Guru** |
| **aspects on it** | **none** |
| class | kendra + upachaya + artha |

**Argala** — never computed here. Grahas in the 2nd, 4th and 11th from a house
intervene in its affairs; each has a specific counter-house whose occupants
obstruct it (the 12th counters the 2nd, the 10th the 4th, the 3rd the 11th).

| Argala from | = house | Occupants | Counter | Verdict |
|---|---|---|---|---|
| 2nd | 11th | empty | 9th | no argala |
| 4th | 1st | empty | 7th | no argala |
| **11th** | **8th** | **Surya, Budha, Shukra** | **12th — empty** | **UNOBSTRUCTED** |

> **One argala exists and it is unopposed.** Three grahas in the 8th intervene
> in his career, and the house that would block them is empty.
>
> Everything that acts on his career acts **through the 8th house** — crisis,
> research, other people's resources, what is hidden, what is inherited. **Not**
> through the 11th of networks, which is empty; **not** through the 1st of
> self-assertion, also empty.
>
> **The career is reached by exactly one route, and that route is wide open.**

### The 10th lord, in full

Budha at 10°27′ Mesha — the **8th house**, neutral dignity, **combust at 9.00°
with no exemption**, ruling the 1st and 10th, sitting with Surya and Shukra.
Nakshatra **Ashwini pada 4, lord Ketu.**

**The payout channel is the thing to notice.** A graha works in its sign lord's
field but is *paid out* by its nakshatra lord.

> **The lord of his career is paid out by a shadow graha.** Ketu owns no sign,
> has no substance, and its function is severance. **The 10th lord's results
> are delivered through the one body that specialises in things ceasing to
> matter** — exactly the mechanism §29 found for job loss, reached here by a
> different route using only the nakshatra table.

### The Arudha of the 10th — never computed here

Count from the house to its lord, then the same distance again. The result is
not what the house *is* but **what it looks like from outside.** The document
computed the Arudha Lagna and the Upapada and never A10.

> from the 10th (Mithuna) to its lord in Mesha = **11 signs**
> the same 11 again from Mesha = **Kumbha**
>
> **A10 = Kumbha — his natal 6th house.**

And set that beside the first table:

| | |
|---|---|
| the 10th from **Chandra** | **Kumbha** |
| the **Arudha** of the 10th | **Kumbha** |

**The same sign, by two completely unrelated techniques** — one a house-count
from the Moon, the other a reflection formula from the lord.
...
### The same apparatus in the navamsa

| | |
|---|---|
| D9 lagna | Kanya — **vargottama** |
| D9 10th sign | **Mithuna — the same sign as D1** |
| D9 10th lord | Budha, in D9 house 11, **enemy** |
| D9 10th holds | **Shani** |
| aspects on it | **Guru, Mangal** |

**The navamsa gives the career house the same sign as the rashi chart.** Not
vargottama in the technical sense — that applies to a graha or the lagna — but
the same structural statement: **the profession does not change shape between
the outer life and the inner one.**

**And Shani occupies it.** In D1 the 10th holds Guru and Shani is absent; in D9
the 10th holds Shani and Guru is absent.
...
**Where the rashi 10th lord goes in the navamsa.** A graha's navamsa is read as
the *fate* of what it rules. Budha goes from a dusthana in D1 to an **enemy
sign** in D9.

> **It does not recover inside.** §26 found this for Budha generally; applied
> to the career it says the profession never becomes comfortable. **Not that it
> fails — that it never stops costing effort.**

By contrast: **Shani holds friendly dignity in both charts and occupies the
navamsa 10th.** Guru improves from enemy to neutral but **leaves the career
house.**

### The career karakas across both charts

| Karaka | D1 house | D1 | D9 house | D9 | |
|---|---|---|---|---|---|
| **Surya** | 8th | **exalted** | 8th | **exalted** | authority, the soul of the work |
| **Shani** | 9th | friend | **10th** | friend | karma, labour, service, duration |
| Budha | 8th | neutral | 11th | **enemy** | commerce, skill |
| Guru | **10th** | **enemy** | 6th | neutral | counsel, teaching |
| Mangal | 9th | neutral | 7th | friend | technical force, contest |

> **Surya is the karaka of authority, exalted in both charts — the only graha
> that is — and it stands in the 8th in both.** As exact a statement of
> "authority that is real and not visible" as the two charts can produce.

### What the two charts agree and disagree on

**Agreed.** The career house is Mithuna in both. Budha, its lord, is
compromised in both. Surya, the karaka of authority, is exalted and in the 8th
in both. The career sits on an 8th-house axis in both.

**Disagreed.** D1 puts Guru in the 10th and forms Amala; D9 puts Shani there
instead.

**And one place where the computation corrected my draft.** I had written that
the D9 10th is unaspected like the D1 10th. **It is not:**

| | |
|---|---|
| **D1 10th** | aspected by **nothing** |
| **D9 10th** | aspected by **Guru** (its 5th, from the D9 6th) and **Mangal** (its 4th, from the D9 7th) |

> The career house is **sealed in the outer chart and contacted in the inner
> one** — and one of the two contacts is the great benefic. **Guru leaves the
> career house in the navamsa but keeps aspecting it.** Mangal, the other
> contact, is in a friendly sign there — friction that is competent.

**The three-reference test breaks the tie.** Shani rules the 10th from Chandra
and from Surya; Budha rules it only from the lagna; Shani occupies the navamsa
10th. **Guru holds one position out of four.**
...
> And **Amala exists in the rashi chart only** — though Guru still *aspects*
> the career house from inside the navamsa.
>
> **That last line is worth sitting with.** The yoga of spotless reputation is
> an outer-chart fact. Inside, Guru no longer occupies the career house; it
...
1. **The D10 is the dedicated career varga and it is excluded.** Its ascendant
   is **Kumbha — the same sign A10 and the 10th-from-Chandra both returned** —
   so it would have agreed rather than added. That agreement is worth knowing
   and is not used above.
2. **No timing.** Nothing here dates anything; the windows are in §22, §28 and
   §29.
3. **No strength measures.** Everything above is placement, lordship, aspect,
   dignity, nakshatra and arudha. **A reading that needs its own scoring to work
   is not a reading — and this one did not need it.**

---

## 31. Provenance — the reading mapped to Parashara

Every technique in this document has been applied from working knowledge and
verified by computation. **None of it has been checked against the source
text.** That is a real weakness in a reading that has otherwise insisted on
verifying everything, and it was raised directly: *rewrite the whole analysis
...
table of contents rather than from recall. **It is not verse citation.** No
verse of BPHS has been read, and nothing below quotes one. What it gives is
something the document did not have at all: **an address for each technique, so
a reader with the book can check it.**

### What Volume 2 covers, and where this reading uses it

| BPHS Vol 2 | Chapter subject | Used in this reading for |
|---|---|---|
| **46** | Dasas of planets — Vimshottari and eighteen others | The whole timeline; §17 |
| 47 | Effects of dasas generally | §18, §19 |
| **48** | **Dasas of the lords of each house** — with special treatment of the 6th, 8th and 12th lords | **§18–19 read the Mangal mahadasha as the 8th lord's period. This chapter is the doctrine for that, and has not been consulted.** |
| 49, 64, 65 | Kalachakra dasa and its antardasas | **Not used anywhere** |
| **50** | Chara dasa; **badhaka houses for movable, fixed and dual rasis** | §27 took the badhaka as the 7th for a dual lagna |
| 51 | Working out antardasas | §17 |
| 52–60 | Antardasa effects under each mahadasha lord | §22, §29 |
| **61** | **Pratyantar dasas** | §22 and §28 date the current sub-sub-period |
| 62, 63 | Sookshma and Prana dasas | **Computed in §35**, then declared out of scope — a prana runs 63 hours and the birth time carries a minute of residual |
| **66** | **Ashtakavarga construction** — bindus and rekhas | §8 |
| **67** | **Trikona sodhana** | §8's reduced Ashtakavarga |
| **68** | **Ekadhipatya sodhana** | §8's reduced Ashtakavarga |
| **69** | **Pinda sadhana** | **Shodhya Pinda — used as a delivery measure throughout §19 and §22** |
| 70 | Effects of each planet's Ashtakavarga | §8 |
| 71 | Longevity through Ashtakavarga | **Declined — see §70** |
| **72** | **Sarvashtakavarga, and the rekha thresholds per rasi** | **§22 and §28 judge transits by bindu counts. This chapter sets the classical thresholds and has not been checked.** |
| 73 | Rays of the planets | **Computed in §35**, with its scaling assumption labelled, and supporting nothing |
| **74** | **Sudarshana Chakra** — the twelve houses read from lagna, Moon and Sun | **§30's "three career references" is this technique. The reading reached it independently; this is its address.** |
| **75** | **Panchamahapurusha yogas** | §21 asserts none can form |
| 76, 77 | Elements and gunas | **Computed in §35** — and both turn out to restate the stellium |
| 78 | Lost horoscopy | Not applicable |
| **79** | **Yogas leading to asceticism** — combinations for entering holy orders *and relinquishing them* | **See below. This is the gap.** |
| 80 | Female horoscopy | Not applicable |
| 81–83 | Body features, moles, curses from past births | **Not used** |
| 84–96 | Remedial measures | §69 derives remedy from the chart rather than from these. **Corrected in §35: chapters 85–94 also *define* the inauspicious birth conditions, all fifteen of which are now computed and all fifteen negative** |
...
| **43** | **Longevity** — Pindayu, Naisargayu, Amsayu, choice among them, rectifications | **Declined.** §70 refuses ayurdaya; this names precisely what was refused — three methods, not one |
...
This document's central mechanism, argued across §61 at length, is that **he
sets down the things he wanted most**: Ketu as the sole occupant of the three
houses of desire, the chart weighted seven to two toward meaning and release
over acquisition, the repeated finding that he walks away rather than being
removed.

**All of that was reasoned from placement. None of it was tested against the
chapter that codifies exactly this.** §61 uses the word *renunciation* six
...
carries load-bearing claims here**: §49's rarity figure rests on *"both
...
|---|---|
| **Varga starting signs — D5, D6, D15, D18, D22, D36** | **Chapter 6** *(located in §37)* |
| **D8 and D11 construction** — reverse-engineered here | **Retired in §37** — chapter 6 names the sixteen and neither is among them |
| Viparita raja yoga cancelled by strength | **Chapters 39–41** |
| Kendradhipati dosha and lagna-lord exemption | **Chapter 34** — which treats each ascendant separately, Virgo included |
| A graha ruling both a trikona and a dusthana | **Chapter 34** |
| Drishti applied inside a divisional chart | **Chapters 8 and 26** |
| Kuja dosha reckoned from Shukra | Vol 1 — **already handled in §25 by refusing to choose** |
| Argala and its counter-houses | **Chapter 31** |

**So the two contents pages between them cover chapters 42 to 96, and every
disputed rule sits in 1 to 41.** *(§36 now prices all eight of them — five are
still unresolved, one of those five moves six divisional charts and a quarter
of Vimshopaka Bala, and one decides whether Guru is a functional benefic.)* What has arrived names what the reading does
...
book for this document** *(it arrived — see §37, and it confirms the sixteen
this reading built)* — six declined divisional charts and two
reverse-engineered ones depend on it.

### The standard this section holds itself to

1. **Nothing above is a citation.** It is a map from technique to chapter,
   derived from a genuine contents page. A reader with the book can now find
   the passage; this document still has not read it.
2. **No claim in the reading has been changed by it.** Chapter titles cannot
...
3. **What it does change is the reading's honesty about its own footing.**
   ...
   **Twenty-five of them now have an address, seven are marked unused, and
   ...
   reading argues hardest.** *(§32 closed all three of those; §35 closed the
   unused set apart from Kalachakra, which stays declined.)*

---

## 32. Closing the three gaps the contents pages exposed

§31 mapped this reading to Parashara's chapters and found three places where
the document argues hard and never opened the relevant chapter. **This section
closes what can honestly be closed.**
...
stated before it is used**, exactly as the rest of this document has always
done. That is no worse-founded than the techniques already in the reading, but
**it is not verse citation and is not presented as any.** Where a scheme needs
a formula I cannot state confidently, **it is declined rather than guessed** —
the same treatment §12 gave the six divisional charts.

### Lajjitadi — the six states, computed

**The rules.** A graha may hold more than one state at once. *Lajjita* —
ashamed — in the 5th with a node, Surya, Shani or Mangal. *Garvita* — proud —
in exaltation or moolatrikona. *Kshudita* — starved — in an enemy's sign, or
conjunct/aspected by an enemy, or conjunct Shani. *Trishita* — thirsty — in a
watery sign, aspected by a malefic and by no benefic. *Mudita* — delighted — in
a friend's sign, or with a friend or benefic. *Kshobhita* — agitated — conjunct
Surya and afflicted.

| Graha | Sign | States |
|---|---|---|
| **Surya** | Mesha | **Garvita, Kshudita**, Mudita |
| **Chandra** | Vrishabha | **Garvita, Kshudita** |
| Mangal | Vrishabha | Kshudita, Mudita |
| Budha | Mesha | Mudita |
| **Guru** | Mithuna | **Kshudita** — and nothing else |
| Shukra | Mesha | Kshudita, Mudita |
| Shani | Vrishabha | Kshudita, **Mudita** |

**One caution on the reading of this table.** Kshudita catches six of seven
grahas, because four of them sit with Shani and the rule is broad. **A state
that nearly everything holds discriminates weakly**, and the informative
results are the extremes rather than that column.

> **And the extreme is this: both luminaries are Garvita and Kshudita at once.**
> Each in exaltation — proud — and each starved: Surya by an enemy contact,
> Chandra by sitting with Shani.
>
> That is the Lajjitadi scheme saying, in its own vocabulary, **exactly what
> §49's rarity finding says in Baladi's**: the two lights are enthroned and
> underfed. **Two independent avastha schemes, the same verdict.**

### Whether the gap damaged the two claims that rest on avastha

**Claim A — §49's rarity headline**, *"both luminaries exalted and both weak by
avastha"*, at 1 in 3,571. Baladi says Surya *Bala* and Chandra *Mrita*, both
crippled; Lajjitadi says both *Garvita and Kshudita*.

> **Survives.** A second scheme reaches the same shape by a completely
> different rule set.

**Claim B — §21's survivability argument**, that *"Shani and Guru are the only
grahas in adult avastha"* and therefore carry the coming window.

| | Baladi | Lajjitadi |
|---|---|---|
| **Shani** | adult | **Mudita — delighted** |
| **Guru** | adult | **Kshudita — starved, and nothing else** |

> **Partly qualified.** Guru is the **only graha in the chart that is neither
> proud nor delighted.** §21's argument does not collapse — Shani still carries
> it — **but it was resting half on a graha this scheme says is underfed**, and
> Baladi could not see that, because it reports both simply as "adult".

### Deeptadi applied, Sayanadi declined

**Deeptadi**, as applied here, assigns nine states by dignity and affliction —
Deepta for exalted, Swastha for own sign, Mudita for a great friend, and so on
down to Khala for debilitation, with Vikala added for combustion.

> **It adds nothing the dignity table did not already give**, because as
> applied it is largely a relabelling of dignity. **That is reported rather
> than dressed up** — it was computed, and it changes nothing. A source text
> may assign these states by rules that are *not* dignity restated, in which
> case this pass is wrong and needs redoing.

**Sayanadi is declined.** It assigns one of twelve states by an arithmetic on
nakshatra, navamsa and birth particulars, with a further sub-state on top.
**I cannot state that arithmetic with confidence, so it is left out rather than
guessed at** — the same treatment §12 gave D5, D6, D15, D18, D22 and D36.

**Three of Parashara's five avastha schemes are now applied. Two remain open.**

### The sannyasa yogas — Chapter 79, tested at last

**The rules.** Four or more grahas in one house, the strongest determining the
order entered — the principal yoga. Chandra aspected by Shani and by no
benefic. The 10th lord in the 10th aspected by Shani.

| Test | Result |
|---|---|
| **Four or more in one house** | the 9th holds **4 bodies** — Chandra, Mangal, Shani, **Rahu** — of which **3 are real grahas** |
| **Chandra with Shani, no benefic** | Shani does not *aspect* the Moon — **it sits with it**; and **no benefic reaches the Moon's sign at all** |
| 10th lord in the 10th | Budha is in the 8th. **Does not form** |

**Both of the first two land on a boundary.** The four-graha yoga forms if the
node counts and fails by one if it does not. The Chandra yoga forms in its
conjunction variant and fails in its aspect variant. **Sources differ on both,
and this reading does not adjudicate.**

But note what the ambiguity itself says: **the chart sits exactly on the
threshold of the principal renunciation yoga, in the house of dharma, with the
node of severance supplying the fourth body.**

> **What §61 gets from this is not what I expected.** It argued the
> "sets things down" mechanism entirely from Ketu in the kama trikona and the
> purushartha weighting, and never tested the classical yogas. Tested now, they
> come back **on the line — twice, by two independent rules.**
>
> **That is stronger than a clean miss and weaker than a clean hit.** The chart
> is not a textbook renunciate. **It is a chart that keeps arriving at the
> threshold of the classical combination and not quite crossing it** — which is
> almost exactly what §61 described behaviourally: a man who sets things down
> repeatedly without ever making it a renunciation.

### The penury combinations — Chapter 42, tested

| Combination | Clause 1 | Clause 2 | |
|---|---|---|---|
| 1. 11th lord in a dusthana | no — Chandra is in the 9th | — | no |
| **2. lagna lord in a dusthana with a malefic** | **yes — Budha in the 8th** | **yes — with Surya** | **FORMS** |
| **3. 2nd lord in a dusthana, 11th lord afflicted** | **yes — Shukra in the 8th** | **yes — Chandra with Mangal, Shani, Rahu, Ketu** | **FORMS** |
| 4. benefics in dusthanas **and** malefics in kendras | yes — Shukra in the 8th | **no — no malefic in any kendra** | no |
| 5. 5th lord in a dusthana with a 6/8/12 lord | no — Shani is in the 9th | yes | no |

**A correction to the draft.** I first wrote that three combinations form on
their first clause and only one survives its second. **Both halves were wrong.**
Two form on the first clause, and **two survive completely** — I had not tested
combination 3's second clause at all and assumed it failed. **It does not.**

> **Two of the five penury combinations form**, and both are versions of one
> structural fact: **the lords of self and of wealth are both in the 8th**, and
> the lord of income sits under malefic weight.

**What does not form is as informative.** Combination 4 fails on something this
reading has already made much of: **no malefic occupies a kendra in this
chart** — §27 found only one graha in a kendra at all. **The classical picture
of poverty needs malefics on the pillars, and his pillars are empty.**

And the counterweights are already in the document: §23 found the 2nd house
empty and aspected by **four** bodies including its own lord and Guru; §24
found the 11th lord exalted.

> **Two penury yogas formed against a well-aspected 2nd and an exalted 11th
> lord is a tension, not a verdict** — and it is the same tension the whole
> reading keeps meeting.

### What this pass changed

1. **Lajjitadi computed** — and it independently confirms §49's rarity finding
   by a different rule set.
2. **It qualified §21.** Shani delighted, Guru starved — not two grahas alike.
3. **Deeptadi adds nothing** as applied, and that is reported.
4. **Sayanadi declined** — the construction rule is not securely known.
5. **The sannyasa yogas come back on the boundary**, twice, each turning on
   whether a node counts as a body. §61 is neither confirmed nor refuted; it is
   placed exactly where its own behavioural description put it.
6. **Two penury combinations form**, naming a weakness the reading already knew
   under a name it did not.

**Nothing here is sourced.** The chapters are still not in hand. **What has
changed is that three techniques the contents pages named are now computed and
visible, with their rules stated — and two of them moved a claim.**

---

## 33. Rahu through Dhanishtha, and the D10 lagna claim
...
It has three separable parts and they are **not equally sound**. The third is
methodological rather than astrological, and it decides the answer — so it is
settled before any interpretation.

### The premise holds, and it is newer than it sounds

| | |
|---|---|
| transit Rahu | **305.64 — 5°38′ Kumbha** |
| nakshatra | **Dhanishtha pada 4** |
| sign | **Kumbha — his natal 6th house** |

His own supplied transit table says the same. **But the dates matter more than
the fact:**

| | |
|---|---|
| entered Dhanishtha | **1 August 2026** — three weeks ago |
| **leaves Kumbha for Makara** | **5 December 2026** |
| leaves Dhanishtha | **10 April 2027** |

> **There are two windows, not one, and they do not end together.**

Dhanishtha straddles a sign boundary — its last two quarters in Kumbha, its
first two in Makara. **Rahu is in the Kumbha half now and drops into the Makara
half in December.**

**That distinction is the whole question**, because everything people attach to
this transit attaches to **Kumbha, not to Dhanishtha** — and the Kumbha half
has about **three months left, not eight.**

### What Kumbha is in this chart — and it is not one thing

This is why the transit is worth taking seriously at all. **Kumbha carries five
separate identifications**, arrived at in five different sections by five
different techniques:

1. the natal **6th house** — service, employment, competition
2. the **D10 ascendant** sign (§11)
3. the **Arudha of the 10th, A10** — how the career is perceived (§30)
4. the **10th from Chandra** — one of the three career references (§30)
5. the **highest Sarvashtakavarga in the chart, 41 bindus** (§8)

> **Five career-relevant identities on one sign.** No other sign in this chart
> carries more than two.

So the instinct behind the claim is sound even where its stated reason is not:
**a transit through Kumbha crosses more career signification than a transit
through any other sign he has.** And the graha crossing it is **Rahu, running
the mahadasha to December 2040.**

### But the D10 claim itself does not survive inspection

*"Rahu is transiting his D10 lagna"* can mean two different things:

- **Loose** — Rahu is in Kumbha, and Kumbha happens to be the sign the D10
  ascendant falls in.
- **Strict** — Rahu's transit position, *mapped into the D10*, lands on the D10
  ascendant.

Only the strict version would be a transit over the D10 lagna in any meaningful
sense. **So it was computed:**

| | |
|---|---|
| transit Rahu | 305.64, Kumbha |
| **mapped into the D10** | **Meena** |
| D10 ascendant | Kumbha |
| | **so it sits in D10 house 2, not the 1st** |

> **The strict claim is false.** Mapped properly into the dashamsha, transit
> Rahu is nowhere near the D10 ascendant.

The D10 divides each sign into ten, so a transiting body sweeps a whole D10
sign every three degrees — **being "on the D10 lagna" lasts about ten weeks for
Rahu and has nothing to do with Dhanishtha.**

**And the deeper objection is worse for the claim.** §26 already recorded that
applying transit and aspect logic *inside* a divisional chart is done by many
and rejected by others, on the grounds that a varga maps dignity rather than a
sky. **This reading has never run transits through a varga and does not start
now.**

> **The D10 reason people give is the weak part of the claim. The Kumbha reason
> they do not give is the strong part.**

### What the transit actually touches

Read the ordinary way — from the birth chart:

| Aspect | Falls on | Natal house | Occupants |
|---|---|---|---|
| **5th** | **Mithuna** | **10th** | **Guru** |
| 7th | Simha | 12th | empty |
| 9th | Tula | 2nd | empty |

**The first row is the finding.**

§23 and §29 established that the natal 10th is one of only two houses in this
chart receiving **no natal aspect at all** — a sealed chamber holding Guru and
reached by nothing.

> **So a transit is presently reaching a house that nothing natal reaches — and
> it is reaching natal Guru, which runs the current antardasha.**
>
...
**And it changes target in December.** When Rahu leaves Kumbha on 5 December:

| Aspect | Falls on | Natal house | Occupants |
|---|---|---|---|
| **5th** | Vrishabha | **9th** | **Chandra, Mangal, Shani, Rahu** |
| 7th | Karka | 11th | empty |
| **9th** | Kanya | **1st — the lagna** | empty |

> **The second half of the Dhanishtha passage is the heavier one, not the
> first.** It turns the aspect off the career house and onto the **self**, and
> onto **its own natal position.** If a claim about Dhanishtha is going to be
> made, it belongs to **December 2026 – April 2027**, not to now.

### The nakshatra echo, which is real and small

| | | |
|---|---|---|
| natal Rahu | Mrigashira pada 2 | **lord Mangal** |
| transit Rahu | Dhanishtha pada 4 | **lord Mangal** |

The transit repeats the natal condition **at the star level without repeating
it at the sign level.** Worth naming because **Mangal is the 8th lord** and ran
the mahadasha of ages 13.7 to 20.7 (§18–19): a Rahu transit through Mangal's
star, during a Rahu mahadasha, quietly re-involves the graha that governed the
transformation already lived.

**That is an echo, not an event**, and it is stated at that weight.

### The verdict

1. **The premise is correct.** Rahu is in Dhanishtha, since 1 August 2026.
2. **The stated reason is wrong.** Mapped into the D10, transit Rahu is in that
   chart's 2nd house, not its 1st — and this reading does not run transits
   through vargas at all.
3. **The real reason is better than the stated one.** Kumbha carries five
   independent career identifications, and Rahu is the mahadasha lord crossing
   it.
4. **The sharpest fact is one nobody mentioned:** transit Rahu's 5th aspect is
   currently on the natal 10th, a house nothing natal can reach.
5. **The dates are not what people imply.** The Kumbha half ends **5 December
   2026** — about three months away, not eight. The Makara half runs to **10
   April 2027** and is the heavier of the two.
6. **And nothing here predicts an event.** A transit marks a window in which
   part of the chart is under pressure. It does not say what happens in it.

> **One thing to set against all of it.** §28 computed the current gochara and
> found Rahu in the **6th from the lagna and the 10th from the Moon — both
...
## 34. The whole reading, swept against the titles

§31 mapped this reading to Parashara's chapters and §32 closed three gaps. This
takes the titles as a **checklist** and asks of each one: *what does this
reading do with that subject?*

The sweep turns up **one omission larger than all three gaps combined**, and it
is methodological rather than technical.
...
Chaturshitisama, Dwisaptatisama, Shashtisama, Shatabdika, Kalachakra, Chara,
Sthira, Kendra, Brahmagraha, Mandook, Yogardha, Shoola, Drig, Rasi,
Panchaswara, **Yogini**, Naisargika, Pinda, Shodhya, Ashtakavarga, Pachaka,
Tara.

**That is not wrong** — Vimshottari is the standard for a reason, and Parashara
treats it first. **But the document has never said it is a choice.** Every date
in this document rests on one selection from a list of twenty-six,
presented as though it were the calendar itself.

**So the honest test is to compute a second system and see what survives.**
Yogini is chosen because its rule is simple enough to state and check, and
because it is **completely unrelated** to Vimshottari — a 36-year cycle of
eight periods against a 120-year cycle of nine, keyed to the same Moon by
different arithmetic.

### Yogini dasha, computed

**The rule.** Eight yoginis of one to eight years, thirty-six in all. The
starting yogini is *(janma nakshatra number + 3) mod 8*, running for the
unexpired portion.

Chandra in **Krittika #3, 38.4% elapsed** → (3+3) mod 8 = **6 → Ulka, ruled by
Shani**, balance **3.70 years**.

| Yogini | Lord | From | To | Ages |
|---|---|---|---|---|
| Ulka | Shani | 15 Apr 2002 | 25 Dec 2005 | 0.0 – 3.7 |
| Siddha | Shukra | 25 Dec 2005 | 25 Dec 2012 | 3.7 – 10.7 |
| **Sankata** | **Rahu** | **25 Dec 2012** | **24 Dec 2020** | **10.7 – 18.7** |
| Mangala | Chandra | 24 Dec 2020 | 25 Dec 2021 | 18.7 – 19.7 |
| Pingala | Surya | 25 Dec 2021 | 25 Dec 2023 | 19.7 – 21.7 |
| **Dhanya** | **Guru** | **25 Dec 2023** | **25 Dec 2026** | **21.7 – 24.7** |
| Bhramari | Mangal | 25 Dec 2026 | 25 Dec 2030 | 24.7 – 28.7 |
| **Bhadrika** | **Budha** | **25 Dec 2030** | **25 Dec 2035** | **28.7 – 33.7** |
| Ulka | Shani | 25 Dec 2035 | 25 Dec 2041 | 33.7 – 39.7 |

### Three agreements, in ascending order of force

**1. The adolescent window.** Vimshottari puts the Mangal mahadasha at ages
13.7–20.7. Yogini puts **Sankata — ruled by Rahu, the eight-year yogini whose
name means *crisis* or *straits*, the harshest of the eight** — at ages
10.7–18.7, overlapping **five of the seven years** §18 and §19 identify as the
transformation already lived.

> **An independent system marks the same adolescence as hard**, and this
> reading never checked.

**2. The present period.** Vimshottari: **Rahu–Guru**, Sep 2025 – Jan 2028.
Yogini: **Dhanya, ruled by Guru**, Dec 2023 – Dec 2026. **Both systems are
running a Guru period right now**, by unrelated routes.

**3. December 2030 — and this one is worth stating twice.**

| | |
|---|---|
| **Vimshottari — Rahu–Budha opens** | **7 December 2030** |
| **Yogini — Bhadrika, ruled by Budha** | **25 December 2030** |
...
>
> And that moment is the one this reading has called **the hinge** since §17 —
> identity and career reassessment, run by the chart's weakest graha, under
> Saturn crossing the natal 10th on a single bindu (§29).

**I went looking for disagreement and found this instead.** It is **the
strongest independent confirmation of any dated claim in the document**, and it
exists only because the chapter titles prompted the check.

**And where they disagree.** Vimshottari puts the material peak at
**Rahu–Shukra, Jul 2034 – Jul 2037**. Yogini runs **Bhadrika (Budha)** to Dec
2035, then **Ulka (Shani)** to Dec 2041. **Neither is Shukra.**

> **The two systems agree on the hard dates and disagree on the good one.**
> That asymmetry is recorded rather than smoothed: the confirmations cluster on
> the difficult windows, and the divergence falls on the favourable one.

### The rest of the sweep

**Chapter 44, Maraka, lists ten sub-topics** — marakas by lordship, maraka
dasa, star groups related to death, Rahu–Ketu as marakas, the 3rd house and
death, occupants of the 8th, fate of the corpse, serpent decanates, prenatal
abode, ascent after death.

**§27 used one of the ten.** Four others are computable and untouched; the rest
belong to the longevity question §70 declines.

**Chapters 62 and 63 — Sookshma and Prana dasas.** The reading stops at
pratyantardasha; Parashara goes two levels finer. Nothing here would change,
**but the stopping point was never declared.**

**Chapters 73, 76, 77 — rays of the planets, the five elements, the three
gunas.** All three **never touched**, all three computable, and the reading
answered *"what are his natural traits"* (§52) without any of them.

**Chapter 83 — curses from a previous birth**, with combinations for lack of a
male issue. **Never touched, and the reading has a children section.** This one
is left alone deliberately: the doctrine attributes childlessness to curses
from named relatives, and **applying that to a living person from a chart alone
is not something this reading is willing to do.**
...
| | |
|---|---|
| **Applied and sound** | the dasha tree (46, 51–61), the Ashtakavarga chain (66–72), Sudarshana Chakra (74), Panchamahapurusha (75), badhaka (50), avasthas (45, three of five) |
| **Applied this session** | asceticism yogas (79), penury (42), Lajjitadi and Deeptadi (45), **Yogini dasha (46)** |
| **Declined with reason** | longevity (43, 71), Sayanadi (45), curses (83), moles (82) |
| **Stopped short** | sookshma and prana dasas (62, 63) |
| **Never touched** *(at the time of this sweep)* | rays (73), elements (76), gunas (77), nine of ten maraka sub-topics (44), **twenty-four of twenty-six dasha systems (46)** |
| **Closed since, in §35** | rays, elements, gunas, sookshma and prana, four more maraka sub-topics — **and chapters 85–94, which this ledger wrongly filed as ritual** |

> **The reading's apparatus is broad and its selection was never declared.** It
> uses one dasha system out of twenty-six, one maraka rule out of ten, and
> three avastha schemes out of five — and until this sweep it presented all of
> that as simply *"the method"*.
>
> **The one place that selection was tested, it held.** An unrelated dasha
> system independently confirms the hinge at December 2030 to within eighteen
> days.

---

## 35. Every chapter, and where it stands

The question put to the document was literal: *does it contain every chapter?*

**It did not.** §34's sweep had already listed what was never touched, and
listing a gap is not closing one. So this section takes every remaining chapter
from the two contents pages — **42 to 96, fifty-five chapters** — and puts each
into one of five states: **computed**, **tested and negative**, **declined with
a reason**, **not applicable**, or **part open**. Nothing is left in the vague middle.

**Fifteen chapters closed here, and one correction large enough to overturn
what §34 said.**

### Chapter 76 — the five elements

**The rule.** Each sign carries an element and a graha takes the element of the
sign it occupies. Fire: Mesha, Simha, Dhanu. Earth: Vrishabha, Kanya, Makara.
Air: Mithuna, Tula, Kumbha. Water: Karka, Vrischika, Meena. Ether is not a sign
element — it is assigned to Guru as a body.

| Element | Count | Bodies |
|---|---|---|
| fire | **3** | Surya, Budha, Shukra |
| **earth** | **4** | Chandra, Mangal, Shani, Rahu |
| air | 1 | Guru |
| water | 1 | Ketu |

**Earth dominates, and the lagna is earth as well.**
...
> not — that the chart would prove less earthy than Kanya rising suggests. **It
> is the reverse.**
...
|---|---|---|
| fire | 3 | **all in Mesha** |
| earth | 4 | **all in Vrishabha** |
| air | 1 | all in Mithuna |
| water | 1 | all in Vrischika |

**Every element in this chart is carried by exactly one sign.** The four earth
bodies are four bodies in Vrishabha; the three fire bodies are three bodies in
Mesha.

> **So the element census is not an independent measurement.** It is the 8th/9th
> stellium counted again in a different vocabulary. Seven of nine grahas in two
> adjacent signs *must* produce a two-element chart, whatever those elements
> happen to be — **a chart with this concentration cannot return a balanced
> element profile**, so the imbalance carries no information the stellium had
> not already given.

**The one thing it adds is genuinely small.** Ether is absent except by Guru's
bodily assignment, and Guru is the single air graha and the single tenanted
sign outside the stellium. **The one body standing apart from the concentration
is the one carrying two elements alone.** That changes no finding.

### Chapter 77 — the three gunas

**Sattva: Surya, Chandra, Guru. Rajas: Budha, Shukra. Tamas: Mangal, Shani,
Rahu, Ketu.** Three, two, four.

> **And that is true of every chart ever cast.** The guna is a property of the
> **body**, not of where the body sits, so this census returns 3 / 2 / 4 for
> every nativity in existence. I had drafted *"true of most charts"*. **It is
> true of all of them. The raw count is not nearly contentless — it is
> entirely contentless.**

**Only the distribution can say anything:**

| Guna | Houses occupied |
|---|---|
| sattva | 8th, 9th, 10th |
| rajas | **8th alone** |
| **tamas** | **3rd, 9th** |
...
9th and Ketu sits opposite in the 3rd — **all four on a single axis, three of
them in one house.** So the tamasic weight of this chart is *stacked* rather
than distributed, and the house it stacks in is the trikona of dharma.
...
scaled by the angular distance between the two points. The maxima most commonly
given are Surya 30, Chandra 16, Mangal 6, Budha 15, Guru 10, Shukra 21, Shani 4
— **102 in all.**
...
| Graha | Max | Distance from debilitation point | Rays |
|---|---|---|---|
| **Surya** | 30 | 171.47° | **28.58** |
| Chandra | 16 | 178.79° | 15.89 |
| Mangal | 6 | 80.67° | 2.69 |
| Budha | 15 | 25.46° | 2.12 |
| Guru | 10 | 159.80° | 8.88 |
| Shukra | 21 | 153.39° | 17.90 |
| Shani | 4 | 27.91° | 0.62 |
| **total** | **102** | | **76.67** |

**Assumption used, stated so it can be rejected:** distance measured from the
exact debilitation *point*, in degrees, scaled linearly to 180.

> **Surya carries the most rays — the same graha every other strength measure
> in this document already puts first among the well-made bodies. No new
> information, and an unverified rule.** It is here so the chapter is not left
> blank, and **it supports nothing.**

> **Both disclaimers above were withdrawn in §37.** When the contents page for
> chapters 1–45 arrived, chapter 28 turned out to name *exaltation rays* as the
> input to Ishta and Kashta Phala — so the scaling was checkable against the
> supplied Shadbala table all along. **It reproduces to 0.0002.** The rule is
> not unverified and the result does not support nothing; it feeds a measure
> this reading has used since §7.

### Chapters 62 and 63 — sookshma and prana

Each level subdivides the one above by the same Vimshottari proportions. **The
reading has always stopped at pratyantardasha.** Two levels remain:

| Level | Lord now | Span |
|---|---|---|
| mahadasha | Rahu | 18 years |
| antardasha | Guru | 2.4 years |
| pratyantardasha | Budha | ~124 days — *the reading has always stopped here* |
| **sookshma** | **Guru** | **16.6 days** |
| **prana** | **Shani** | **62.9 hours** |

**So the levels exist and are trivial to compute. And that is exactly why the
reading stops where it does.** Nothing in this document is dated to better than
a month, the birth time itself carries a residual of about a minute (§2), and
**a one-minute error in birth time moves a prana boundary by hours.**

> **The precision would be fake.** The stopping point is now a **declared
> choice** rather than an unstated habit, which is the only thing that needed
> fixing.

### Chapter 44 — the maraka sub-topics that are structural

§27 used one of the ten. **Four more are structural rather than predictive**,
and can be recorded without touching longevity, which §70 declines and
continues to decline.

| Sub-topic | This chart |
|---|---|
| **the 3rd house and death** | the 3rd holds **Ketu**, in the severest gandanta pada; the 3rd lord Mangal is in the 9th |
| **occupants of the 8th** | **Surya, Budha, Shukra — three bodies**, more than any house but the 9th, and one of them, **Shukra, is the 2nd lord — a maraka lord inside a dusthana** |
| **Rahu and Ketu as marakas** | Rahu in the 9th, Ketu in the 3rd — **neither in a maraka house** |
| marakas by lordship *(§27)* | 2nd lord Shukra, 7th lord Guru — **both houses empty** |

**The structural picture, with no lifespan claim attached:** the maraka houses
are empty; the maraka lords are the best and the most compromised grahas he
has; the 8th is heavily occupied and one maraka lord sits in it; the nodes stay
out of it entirely.

**Five of ten sub-topics now recorded.** The remaining five — maraka dasa, star
groups related to death, fate of the corpse, serpent decanates, prenatal abode
and ascent after death — **are declined.** Two of them I cannot state the rule
for; the rest are longevity and afterlife doctrine that this reading refused
from §70 onward and **does not reopen at the back door.**

### Chapters 85 to 94 — the inauspicious births, tested

> **I had this wrong, and §34 printed it wrong.**

The ledger dismissed chapters 84–96 as *"remedial measures — ritual
prescription"*, which is **only half of what they are**. Read properly, each one
opens by **defining a birth condition** and only then prescribes the rite:
*"Description of the evil effects of such inauspicious birth **and** the
remedial measures to be adopted…"*

**The diagnostic half is computable — and computable from the panchanga this
reading already printed in §3.** Seventeen conditions, each a yes or no about
this specific birth. **Not one of them was ever tested.**

| Ch | Condition | Rule | Result |
|---|---|---|---|
| 86 | birth on Amavasya | tithi = Krishna Amavasya | **no** — Shukla Tritiya |
| 87 | birth on Krishna Chaturdashi | tithi = Krishna 14 | **no** — Shukla Tritiya |
| 88 | birth in Bhadra | karana = Vishti | **no** — karana is Gara |
| 88 | birth in Tithi Kshaya | a tithi touching no sunrise | **no** — Tritiya spans *two* sunrises |
| 88 | birth in Vyatipata yoga | yoga #17 | **no** — Ayushman, #3 |
| 88 | birth in Parigha yoga | yoga #19 | **no** — Ayushman, #3 |
| 88 | birth in Vajra yoga | yoga #15 | **no** — Ayushman, #3 |
| 89 | inauspicious nakshatra birth | Moon in a gandmool nakshatra | **no** — Krittika is not gandmool |
| 90 | birth in Sankranti | within ~16 ghatis of a solar ingress | **no** — **91 ghatis** after |
| 91 | birth during an eclipse | eclipse in progress | **no** — nearest is **41 days** off |
| 92 | tithi gandanta | Purna/Nanda tithi junction | **no** — Tritiya is a Jaya tithi, mid-span |
| 92 | nakshatra gandanta | Revati/Ashwini, Ashlesha/Magha, Jyeshtha/Moola | **no** — Krittika borders none |
| 92 | lagna gandanta | last degree of Karka, Vrischika, Meena | **no** — lagna in Kanya |
| 93 | Abhukta Moola | Moon at the Jyeshtha/Moola junction | **no** — Moon in Krittika |
| 94 | Jyeshtha gandanta | Moon at the end of Jyeshtha | **no** — Moon in Krittika |
| 95 | daughter born after sons | sibling sex order | *not applicable* |
| 96 | unusual delivery | obstetric circumstance | *no data, and none will be asked for* |

> **Fifteen testable conditions. All fifteen come back negative.**

**That is a real result and not a trivial one.** Parashara devotes eleven
chapters to births requiring expiation, and **not one of them describes this
birth.** The panchanga is clean at every point the tradition marks as needing a
rite: an ordinary Shukla Tritiya on a Monday, a benefic yoga named — of all
things — **Ayushman**, a plain Gara karana, a nakshatra outside the gandmool
set, no eclipse within six weeks, no ingress within a day and a half, and no
gandanta of tithi, star or ascendant.

**One near miss, named because it is the only one.** He was born **thirty-six
hours after Mesha Sankranti** — the solar new year, 14 April 2002 at 05:48 IST.
That is far outside any dosha window, so **it is not a finding**; it is a
coincidence of calendar and is recorded as one.

**And one genuine irony the reading should say out loud.** §4 and §16 both make
much of **gandanta** — Ketu sits in the severest gandanta pada in the chart, and
the document has leaned on that repeatedly. **Chapter 92 is *the* gandanta
chapter, and it turns out to be about something else entirely:** gandanta *of
the birth*, in tithi, star and ascendant, none of which applies here.

> **The chart has a gandanta graha and an entirely clean gandanta birth.** Those
> are two different doctrines wearing one word, and until this computation the
> reading had silently conflated them.

**So chapters 85–94 move from *declined — ritual* to *tested — negative*, which
is the single largest correction this sweep produces.**

### What remains unclosed, and why

| Chapters | Subject | State |
|---|---|---|
| **49, 64, 65** | **Kalachakra dasa** and its antardasas | **Declined.** The construction depends on a nakshatra-pada to rasi-sequence mapping with savya and apasavya variants, and I cannot state it confidently enough to compute. **The same refusal §12 made for six divisional charts** |
| 78 | Lost horoscopy | **Not applicable** — it reconstructs a chart when birth details are unknown. His are known and verified to the arcminute (§2) |
| 80, 81 | Female horoscopy; features of a woman's body | **Not applicable** to this nativity |
| 82 | Moles and marks | **Not applicable** without physical data, which has not been supplied and will not be asked for |
| **83** | **Curses from a previous birth** | **Declined deliberately — a judgement, not a limitation.** The doctrine attributes childlessness to curses from named relatives: the father, the mother, the wife, a maternal uncle. **Computing which relative cursed a living man is not something this reading will do, and no amount of source text would change that** |
| 84–96 | Remedial rites | **Diagnostic half now computed** *(above)*; the **ritual half stands open.** §69 derives remedy from the chart's own structure rather than from prescribed rites, and does not pretend that is equivalent |
| 46 | The other twenty-five dasha systems | **Two of twenty-six now computed** — Vimshottari throughout, Yogini in §34. The remaining twenty-four are untouched, and §34 records why that matters |

### The complete ledger — all fifty-five chapters

| Ch | Subject | State |
|---|---|---|
| 42 | Combinations for penury | **computed** §32 |
| 43 | Longevity — Pindayu, Naisargayu, Amsayu | **declined** §70 |
| 44 | Maraka planets | **5 of 10 sub-topics computed** §27, §35 |
| 45 | Avasthas — five schemes | **4 of 5 computed** §4, §32 |
| 46 | Dasas of planets — twenty-six systems | **2 of 26 computed** §17, §34 |
| 47 | Effects of dasas | applied §18, §19 |
| 48 | Dasas of the lords of each house | applied §18, §19 |
| 49 | Kalachakra dasa effects | **declined** |
| 50 | Chara dasa; badhaka houses | badhaka applied §27 |
| 51 | Working out antardasas | applied §17 |
| 52–60 | Antardasa effects, each mahadasha lord | applied §22, §29 |
| 61 | Pratyantar dasas | applied §22, §28 |
| 62, 63 | Sookshma and Prana dasas | **computed, then declared out of scope** §35 |
| 64, 65 | Kalachakra antardasas | **declined** |
| 66 | Ashtakavarga construction | applied §8 |
| 67 | Trikona sodhana | applied §8 |
| 68 | Ekadhipatya sodhana | applied §8 |
| 69 | Pinda sadhana | applied §19, §22 |
| 70 | Effects of each Ashtakavarga | applied §8 |
| 71 | Longevity through Ashtakavarga | **declined** §70 |
| 72 | Sarvashtakavarga and rekha thresholds | applied §8, §22, §28 |
| **73** | **Rays of the planets** | **computed §35 — supports nothing** |
| 74 | Sudarshana Chakra | applied §30 |
| 75 | Panchamahapurusha yogas | applied §21 |
| **76** | **The five elements** | **computed §35** |
| **77** | **The three gunas** | **computed §35** |
| 78 | Lost horoscopy | **n/a** |
| 79 | Yogas leading to asceticism | **computed** §32 |
| 80, 81 | Female horoscopy | **n/a** |
| 82 | Moles and marks | **n/a** |
| 83 | Curses from a previous birth | **declined by judgement** |
| 84 | Remedial measures generally | ritual half open; §69 is the structural answer |
| **85–94** | **Inauspicious births and their remedies** | **tested §35 — all fifteen conditions negative** |
| 95, 96 | Daughter after sons; unusual delivery | **n/a** |

**Counted rather than asserted** — the script assigns a state to every chapter
from 42 to 96 and asserts that none is left unassigned:

| State | Count | Chapters |
|---|---|---|
| applied or computed | **32** | 42, 44–48, 50–63, 66–70, 72–77, 79 |
| tested and negative | **10** | 85–94 |
| declined with a reason | **6** | 43, 49, 64–65, 71, 83 |
| not applicable | **6** | 78, 80–82, 95–96 |
| part open *(ritual half)* | **1** | 84 |
| **total** | **55** | **unassigned: none** |

> **I hand-tallied this as 38 / 8 / 4 / 7 while drafting. All four numbers were
> wrong.** The counted version is the one above — which is the whole method of
> this document applied to its own bookkeeping.

**Nothing is left in the category *never touched*.** That is where §34 had to
leave chapters 73, 76 and 77, and where §31 wrongly left 85 to 94 by calling
them ritual.

### On rewriting from the start

The question came with a conditional — *if not, rewrite the .md from starting*.
**That has now been done in substance and not in form**, and the difference is
worth stating plainly rather than quietly choosing one.

**What a literal restructure would change:** the order. The document grew by
accretion, one question at a time, so Parashara's sequence and this document's
sequence have nothing to do with each other. A rewrite following the chapters
would put longevity beside maraka, elements beside gunas, and every dasha
chapter in one block.

**What it would not change:** a single finding. **Every computation in this
document has been run against the ephemeris and every one is already recorded
under the chapter that governs it** — by §31's map, §34's sweep, and this
section's ledger. Reordering paragraphs cannot alter a number.

> **And it would cost something real.** The order this document is in is the
> order the questions were asked in, and several sections exist *only* because
> an earlier one was wrong — §23 overturns §22, §32 closes what §31 exposed,
> this section corrects §34. **A rewrite into textbook order would erase the
> record of its own corrections, which is the part of this document least worth
> losing.**

**So the chapters are all accounted for, and the sequence stays as it is** —
unless the sequence itself is what was wanted, in which case it is one more
pass and nothing in it would need recomputing.

---

## 36. Chapters 1 to 41 — the half with no contents page

§35 assigned a state to all fifty-five chapters the two supplied contents pages
cover. **Chapters 1 to 41 have never been supplied in any form** — and they are
the half that matters most, because they are the foundation.

**I will not reconstruct that contents page from memory.** §31 refused to invent
citations and that refusal stands: a chapter list recalled rather than read
would be indistinguishable from a fabricated one, and it would be worse than
useless because it would *look* like provenance.

**So this section does the part that does not need the page.** §31 flagged eight
rules as school-dependent and located all eight in chapters 1–41. It never
asked the obvious follow-up:

> **How much of the reading actually moves if each one goes the other way?**

That is computable without the book. It converts *"we do not have the chapter"*
into *"here is exactly what the chapter would decide."*

### What is missing, measured

| | |
|---|---|
| chapters in the work | **96** |
| Volume 2, contents supplied | 51 — chapters 46–96 |
| Volume 1 tail, contents supplied | 4 — chapters 42–45 |
| **supplied** | **55 — 57% of the work** |
| **never supplied** | **41 — 1 to 41, 43% of the work** |

**And the 43% is the foundational half.** What lives there — stated as
techniques rather than as guessed chapter numbers, and every item is used by
this reading:

| Technique family | Used in |
|---|---|
...
| friendship — natural, temporal, compound | §4, §6 |
| **drishti — the aspect rules and their strengths** | **§10** |
| **Shadbala — all six components** | **§7** |
| Bhava Bala | §8 |
...
**Nineteen technique families, and the reading uses all nineteen.** Every one of
them is locatable *only* in 1–41, because 42–96 is now fully enumerated and
...
avasthas, the remedial chapters. **Important, but downstream.**

### The dispute nobody noticed — and it is inside the Shodashavarga

§12 declined six divisional charts because *"schools disagree on the starting
sign"* — D5, D6, D15, D18, D22, D36. **That was the right call. But it stopped
there, and it should not have.**

The starting-sign convention is not a defect peculiar to those six. It is a
property of **any** varga built as *pick a base sign, then count*. And **six
members of the Shodashavarga are built exactly that way**:

| Varga | Vimshopaka weight | Start convention |
|---|---|---|
| **D2** | 1.0 | Simha/Karka by parity — against the Kashinatha hora |
| **D16** | **2.0** | movable Mesha / fixed Simha / dual Dhanu |
| D20 | 0.5 | movable Mesha / fixed Dhanu / dual Simha |
| D24 | 0.5 | odd from Simha / even from Karka |
| D40 | 0.5 | odd from Mesha / even from Tula |
| D45 | 0.5 | movable Mesha / fixed Simha / dual Dhanu |
| **disputed weight** | **5.0 of 20 — 25%** | |

> **A quarter of Vimshopaka Bala rests on rules this reading has itself flagged
> as school-dependent** — and §12 declined six *other* vargas for that very
> reason while never noticing these six.

These are not declined. They are load-bearing: Vimshopaka is one of the four
strength measures §7 uses.

### How far can it move? A complete bound

**The bound is exact and requires guessing no rival rule.** Whatever the true
convention is, a base rule assigns *some* starting sign, and the varga sign is
*(base + part) mod 12*. Sweeping all twelve possible bases therefore covers
**every possible rule, including ones nobody has proposed.**

| Graha | As built | Min | Max | Band as built → band range |
|---|---|---|---|---|
| **Surya** | **16.85** | 13.43 | 17.68 | EXCELLENT → **good / EXCELLENT** |
| Chandra | 15.32 | 12.45 | 16.70 | EXCELLENT → **good / EXCELLENT** |
| Shukra | 12.60 | 10.70 | 14.95 | good → good |
| Guru | 12.32 | 9.10 | 13.35 | good → **moderate / good** |
| Budha | 11.45 | 8.28 | 12.53 | good → **moderate / good** |
| Shani | 11.22 | 8.70 | 12.95 | good → **moderate / good** |
| Mangal | 10.30 | 7.78 | 12.03 | good → **moderate / good** |

**Every range is identical — 4.25 — and that is not a coincidence.** The
disputed weight is 5 of 20 and the dignity scale runs 3 to 20, so the largest
possible swing is 5 × 17 / 20 = 4.25 for any graha whatever.

> **Which means the risk is not to any one figure. It is to the order.**

### The order, tested exactly

A starting-sign rule assigns a base to a **rasi**, not to a graha — so grahas
sharing a D1 sign must move together: **Surya, Budha and Shukra** are all in
Mesha; **Chandra, Mangal and Shani** are all in Vrishabha; Guru is alone in
Mithuna. The maximum of a difference of sums is the sum of the per-varga
maxima, so each pairwise question is answered exactly rather than sampled.

| Challenger | Incumbent | Gap as built | Best case | |
|---|---|---|---|---|
| Chandra | Surya | −1.53 | **+3.27** | **can overtake** |
| Shukra | Chandra | −2.72 | **+2.50** | **can overtake** |
| Guru | Shukra | −0.28 | **+2.65** | **can overtake** |
| Budha | Guru | −0.88 | **+3.42** | **can overtake** |
| Shani | Budha | −0.22 | **+4.67** | **can overtake** |
| Mangal | Shani | −0.92 | **+2.20** | **can overtake** |

> **Six of six adjacent pairs can swap. Every single adjacency in the strength
> order is reversible** by a rule this document does not have the page for.

**I drafted the next line expecting the exact test to shorten the list of
possible leaders**, reasoning that Shukra shares Mesha with Surya and cannot
move independently of it. **It does not.** Shukra clears Surya by 0.80 even
with the base forced to be shared. Both tests name the same three: **Surya,
Chandra, Shukra.**
...
> **Guru falls short of first place by 0.07 of a point.**
>
> A graha whose functional nature is *itself* disputed — see the next part —
> misses the top of this reading's strength order by seven hundredths, on a
> rule nobody has read. **That is as close to a coin toss as this document
> contains.**

**What survives regardless:** Surya and Chandra cannot be displaced to last
under any rule, and Mangal, Budha, Guru and Shani cannot reach first. **The top
is a closed set of three and the bottom a closed set of four. Everything inside
those two sets is undetermined.**

### The other seven disputes, each priced

**1. D8 and D11 construction — settled, and not by the book.** §11 rebuilt both
from scratch and reproduced the *supplied* charts **10 of 10 placements each**,
nodes included. **This is the one dispute the missing chapter cannot reopen:** a
rule that reproduces twenty independent placements exactly is confirmed by
data, and a contents page could only tell us what to call it.

**2. Viparita raja yoga cancelled by strength.** The chart has exactly one
viparita yoga: **Surya, 12th lord in the 8th — Vimala yoga — and Surya is
exalted.** One school says the yoga stands and strength helps it; the other says
viparita needs an afflicted graha and an exalted 12th lord is not afflicted.
**§25 took the second and said so.** What it did not say is the size of the bet:
the other reading hands the chart **a raja yoga it currently does not have**,
formed by the graha §7 already calls the cheapest deliverer it owns.

**3. Kendradhipati dosha — the expensive one.** Two grahas qualify and they are
the two the reading leans on hardest. **Budha** rules the 1st and 10th, both
kendras — most schools exempt the lagna lord. **Guru** rules the 4th and 7th,
both kendras, and no exemption is available. **§27 applied the dosha and calls
Guru a functional malefic.** That is a large claim to rest on an unread chapter,
because Guru is:

- the **only occupant of the 10th house**
- the lord of the **antardasha now in force**, to January 2028
- the **7th lord** the marriage window is read from
- the lord of the **best mahadasha in the chart**, 2040–2056

> **If the dosha is rejected, Guru is a benefic in the career house running the
> current period. If it is upheld, Guru is a malefic doing the same three jobs.
> The reading took one side without marking it as a choice.**

**4. A graha ruling both a trikona and a dusthana.** One graha: **Shani, lord of
the 5th (trikona) and the 6th (dusthana).** Either the trikona lordship prevails
and Shani is a benefic for Kanya, or the dusthana lordship spoils it. Shani runs
the antardasha **January 2028 – December 2030** — the window this reading calls
*the foundation*. **The ambiguity attaches to the graha running it.**

**5. Drishti applied inside a divisional chart.** §26 read aspects *inside* the
navamsa and found the D9 10th receives Guru's 5th and Mangal's 4th. §33 then
**declined** to run transits inside a varga, on the ground that a varga maps
dignity rather than a sky. **Those two positions are in tension and the document
has never reconciled them.** If a varga is not a sky, an aspect cast across it
is as questionable as a transit through it — and §26's finding was itself a
*correction* of an earlier claim that the D9 10th was unaspected.

**6. Kuja dosha reckoned from Shukra.**

| Reference | Mangal sits in the | |
|---|---|---|
| Lagna | 9th | clean |
| Chandra | 1st | **dosha** |
| Shukra | 2nd | **dosha** |

**Already computed from all three references in §25**, which is the right
treatment — it reports the split rather than picking a reference and hiding the
others. **Price: none. The reading handled this one correctly by refusing to
choose.**

**7. Argala and its counter-houses.** Argala on the 10th (Mithuna):

| Argala from | Sign | Occupants | Counter | |
|---|---|---|---|---|
| the 2nd | Karka | empty | 12th | — |
| the 4th | Kanya | empty | 10th | — |
| **the 11th** | **Mesha** | **Surya, Budha, Shukra** | **3rd — Simha** | **empty** |

**I drafted the verdict as "small, because the one argala here is on the
2nd-from and the contested variants do not touch it." The table says otherwise.**
The 2nd-from and 4th-from are both empty; the single argala is the **11th-from**
— and the contested rule is precisely **whether the 3rd counters the 11th**. I
had it exactly backwards: this is the one argala the dispute governs, not one
it misses.

> **So the dispute is live and then it dies on the facts.** The 3rd from the
> 10th is Simha, and Simha is empty. Whether or not the 3rd may counter the
> 11th, **there is nothing in it to do the countering.** Price: none — but by
> accident rather than by design. Had one graha been in Simha, this dispute
> would have decided whether the chart's only intervention on the career house
> stands or is blocked.

### The price list

| Weight | Rule | What it decides |
|---|---|---|
| **settled by data** | D8 and D11 construction | nothing — 20 of 20 placements reproduced |
| **handled already** | Kuja dosha reference | nothing — §25 refuses to choose |
| **live but moot** | argala counter-houses | governs the chart's only argala, but the counter-house is empty either way |
| **medium** | viparita cancelled by strength | one raja yoga, on the 12th lord |
| **medium** | trikona-and-dusthana lordship | Shani's nature across the 2028–2030 window |
| **medium** | drishti inside a varga | §26's D9 aspect finding, and its tension with §33 |
| **large** | **Shodashavarga starting signs** | **six divisional charts, 25% of Vimshopaka, and the whole rank order** |
| **largest** | **kendradhipati dosha** | **whether Guru — 10th-house occupant, current antardasha lord, 7th lord, and lord of the best mahadasha — is a functional benefic or malefic** |

### The honest summary, corrected twice while writing it

**I first wrote: *"nothing in chapters 1–41 can change a computed position."*
That is false**, and the bound above is its own refutation — the starting-sign
rule *is* the construction, so six of the sixteen Shodashavarga charts have
positions that move with it.

| Immune | Not immune |
|---|---|
| every longitude — fixed by the ephemeris | **D2, D16, D20, D24, D40, D45** — positions themselves move |
| every dasha date — fixed by the Moon | **Vimshopaka Bala** — 25% of its weight, and its rank order |
| every Ashtakavarga figure — built from D1 signs | **five named interpretive rules** |
| D1, D3, D4, D7, D9, D10, D12, D27, D30, D60 | |
| houses, aspects, lordships — fixed by the D1 | |

**I also first wrote *"six rules unresolved."* It is five** — of the eight,
D8/D11 is settled by data, Kuja dosha was handled correctly by refusing to
choose, and the argala dispute dies on an empty house.

> **So the answer to *what about 1 to 41* is not "they are missing."**
>
> It is this: **they are missing, they are the more important half, five
> specific rules in them are unresolved, six divisional charts and one strength
> measure move with one of those five, and exactly one — the kendradhipati rule
> — would require rewriting sections of this document rather than annotating
> them.**

**And one page would settle most of it.** The Shodashavarga chapter closes the
large item and six declined vargas at once; whichever chapter carries
kendradhipati dosha closes the largest. **The contents page for 1–41, pasted the
way the other two were, is all this needs.**

---

## 37. The contents page for chapters 1 to 45

§36 measured what was missing — an address for 57% of Parashara and none at all
for the other 43% — named the Shodashavarga chapter as the single most valuable
missing page, and asked for exactly this. **It has arrived.**

It does four things, and only the first is the one that was expected.

### Every foundational technique now has an address

| Ch | Subject | Used in |
|---|---|---|
| 3 | Planetary characters; exaltation and debilitation; natural and temporal relationships; **upagrahas, Gulika, Pranapada** | §4, §6, §16 |
| 4 | Zodiacal signs; limbs of Kalapurusha; Nisheka Lagna | §9, §67 |
| **5** | **Special ascendants — Bhava, Ghatika and Hora Lagna; Varnada Dasa** | **never used** |
| **6** | **The sixteen divisions of a sign** | §11, §12, §13 |
| 7 | Divisional consideration; **Vimsopaka strength**; indications from houses | §7, §11, §27 |
| **8** | **Aspects of the signs — *sign* aspects and planetary aspects** | §10 — planetary only |
| **9, 10** | **Evils at birth, and antidotes for them** | **never used** |
| 11 | Judgement of houses — prosperity or annihilation of a house | §9 |
| 12–23 | Effects of the 1st to the 12th house, one chapter each | §9, §65–§67 |
| 24 | **Effects of the bhava lords — 144 combinations** | §6, §9, throughout |
| **25** | **Effects of the non-luminous points *by house*** | §16 — positions only |
| 26 | Evaluation of planetary aspects; special rules for Shani, Mangal, Guru | §10 |
| **27** | Evaluation of strengths — the whole Shadbala apparatus, **planetary war**, Bhava Balas, *eligibility to issue predictions* | §7, §8 |
| **28** | **Ishta and Kashta balas — exaltation rays, Cheshta Rasmi** | §7 — *and see below* |
| 29, 30 | Bhavapadas; Upapada | §15, §30 |
| **31** | **Argala or planetary intervention** | §30, §36 |
| 32, 33 | Planetary karakatwas; effects of Karakamsa | §15 |
| **34** | **Yoga karakas — angular and trinal lordships, with a section for each ascendant including Virgo** | §27, §36 |
| **35–38** | **Nabhasa, other, lunar and solar yogas — 61 named** | §14 — 10 of 61 |
| 39–41 | Raja yogas; royal association; yogas for wealth | §14, §22 |

**All nineteen technique families §36 listed now have a chapter.** And the page
exposes six things the reading has never touched at all — most sharply:

> **Varnada Dasa is in chapter 5.** §34 counted twenty-six dasha systems from
> chapter 46's subtitle and said the reading uses one of twenty-six. **The
> count is twenty-seven.**

Also never touched: **sign aspects** (rasi drishti, chapter 8, listed right
beside the planetary aspects this reading does use); **evils at birth** and
their antidotes (9–10); the upagrahas *by house* (25) — §16 computed where they
are and never read what they do there; and **planetary war** (27).

### Chapter 6 checks the varga apparatus — and it passes

The chapter names its sixteen divisions in order. The reading built sixteen
without ever seeing that list.

| Chapter 6 names | Reading built | | Chapter 6 names | Reading built |
|---|---|---|---|---|
| Rasi | D1 | | Shodasamsa | D16 |
| Hora | D2 | | Vimsamsa | D20 |
| Decanate | D3 | | **Siddhamsa** | **D24** |
| Chaturthamsa | D4 | | **Bhamsa** | **D27** |
| Sapthamsa | D7 | | Trimsamsa | D30 |
| Navamsa | D9 | | Chatvarimsamsa | D40 |
| Dasamsa | D10 | | Akshavedamsa | D45 |
| Dvadasamsa | D12 | | Shashtiamsa | D60 |

> **Sixteen for sixteen.** The first external check the varga apparatus has ever
> had, and it passes — with *Siddhamsa* and *Bhamsa* now fixed as D24 and D27
> rather than left to inference.

**And the list settles something else, by omission: D8 and D11 are not in it.**

§31 called them *"reverse-engineered here"* and filed their construction as a
disputed rule living in Volume 1. **It does not live there.** Chapter 6
enumerates the sixteen and neither is among them, so **there is no Parashari
rule for the reading to have got wrong.** That *retires* the dispute rather than
settling it — and it explains what §11 found puzzling: the rules had to be
recovered from the supplied charts because Parashara does not give them.

### Chapter 28 overturns a §35 finding

§35 computed chapter 73, *Rays of the planets*, and published it with two
disclaimers: *"what I cannot state confidently is the scaling"* and *"no new
information, and an unverified rule… it supports nothing."*

**Both are wrong, and the contents page is what shows why.** Chapter 28 is
titled *Ishta and Kashta Balas* and its subtitle opens: **"Exaltation rays,
Cheshta Rasmi, beneficial and malefic rays."**

So the rays are not a curiosity in chapter 73. **They are the input to Ishta and
Kashta Phala** — which this reading uses in §7, §18, §19 and §22, and which is
computed from **Uchcha Bala**, a figure sitting in the *supplied* Shadbala table
that `verify_bala.py` already reproduces independently.

**Which makes the scaling testable after all.** If the exaltation ray is the
same quantity as Uchcha Bala, then rays = max × Uchcha / 60, exactly:

| Graha | Uchcha ⁄ 60 | Published rays ⁄ max | Predicted | §35 published |
|---|---|---|---|---|
| Surya | 0.9527 | 0.9527 | 28.58 | **28.58** |
| Chandra | 0.9933 | 0.9931 | 15.89 | **15.89** |
| Mangal | 0.4482 | 0.4483 | 2.69 | **2.69** |
| Budha | 0.1415 | 0.1413 | 2.12 | **2.12** |
| Guru | 0.8878 | 0.8880 | 8.88 | **8.88** |
| Shukra | 0.8522 | 0.8524 | 17.90 | **17.90** |
| Shani | 0.1550 | 0.1550 | 0.62 | **0.62** |

**Largest disagreement across seven grahas: 0.0002.**

> **The assumption §35 labelled unverifiable is the Uchcha Bala scaling, and the
> supplied table confirms it.** So §35 is corrected on two counts: the rule is
> not unverified, and the result does not support nothing — it is the input to
> a measure the reading has leaned on since §7.
>
> **I published a hedge that data already in this repository could have
> removed.** The contents page did not supply the proof. It supplied the
> pointer that made me go and look.

### The yoga chapters — the largest untested block

Chapters 35–38 name **sixty-one yogas**. §14 reports on **ten**.

**Chapter 35, Nabhasa — all thirty-one tested.** Four form: **Soola** (the seven
grahas in exactly three signs), **Sakthi** (all confined to the 7th–10th), and
then **Koota** (4th–10th) and **Chatra** (7th–1st).

> **The overlap is not an error, it is the rule's shape.** Sakthi, Koota and
> Chatra are all *confinement* yogas, and a chart packed into houses 8-9-10
> satisfies every window containing those three. **The narrowest true statement
> is Sakthi;** the other two are implied by it rather than independent findings.
> They are reported anyway, because a reader with chapter 35 open will find all
> three and should know the document saw them.

The other twenty-seven are absent, and the Sankhya series settles most of them
at once — seven grahas in three signs means Gola, Yuga, Kedara, Pasa, Dama and
Veena are all excluded by arithmetic.

**Chapters 36, 37, 38 — twelve of twenty-one testable, plus the lunar and solar
sets.** Forms: **Amala**, **Duradhura** (Sunapha and Anapha conditions are both
met, and the combined case is named Duradhura), **Veshi**. Absent: Subha,
Asubha, Gajakesari, Lakshmi, Kalanidhi, Chamara, Kahala, Adhiyoga, Vasi,
Ubhayachari, Kemadruma.

**One half-forms and is worth naming.** **Srinatha** needs the 7th lord in the
10th *and* the 10th lord exalted. **Guru is the 7th lord and it is in the
10th** — the first clause holds exactly. Budha is not exalted, so the yoga
fails on the second.

**Eight of chapter 36's twenty-one are declined by name** — Parvatha, Bheri,
Mridanga, Sarada, Matsya, Koorma, Kalpadruma, Trimurthi. Their formation rules
depend on navamsa-lord chains and multi-clause conditions whose variants differ
between schools, and I cannot state them with the confidence this document
requires. **They are listed rather than quietly omitted, which is the difference
between a gap and a silence.**

### And the sweep turns up the structural finding of this section

I first wrote: *"for Kanya, five of the seven grahas each rule two houses."*
**That is true of every lagna** — only Surya and Chandra rule one sign each — so
the universal fact says nothing. **What distinguishes Kanya is which five
pairs:**

| Graha | Rules | |
|---|---|---|
| Budha | 1st and 10th | 1 + 10 = **11** |
| Shukra | 2nd and 9th | 2 + 9 = **11** |
| Mangal | 3rd and 8th | 3 + 8 = **11** |
| Guru | 4th and 7th | 4 + 7 = **11** |
| Shani | 5th and 6th | 5 + 6 = **11** |

> **Every co-ruled pair sums to eleven. The lordship map of this chart is
> perfectly mirror-symmetric.**

**Is that common? It is testable across all twelve lagnas:**

| Lagna | Mirror pairs sharing a lord | Count |
|---|---|---|
| **Kanya** | **1/10, 2/9, 3/8, 4/7, 5/6** | **5** |
| Meena | 1/10, 2/9, 3/8, 4/7 | 4 |
| *the other ten* | — | **0** |

**Kanya is the only lagna in the zodiac with all five.** And the mechanism is
exact rather than a curiosity: sign lordship is symmetric about the Karka–Simha
boundary, and only Karka/Simha are split between the two luminaries. For houses
*a* and *11−a* to share a lord their signs must be reflections, which requires
*2L + 9 ≡ 7 (mod 12)* — **so L = 5 or 11, Kanya or Meena and nothing else.**
Kanya takes the fifth pair because its 5th and 6th fall on Makara and Kumbha,
both Shani; Meena loses it because its 5th and 6th fall on Karka and Simha, the
one split pair.

**What that costs the chart in yoga terms:**

| Yoga | Requires | Here | Foreclosed for |
|---|---|---|---|
| **Khadga** | the 2nd and 9th lords in relation | **both are Shukra** | 2 of 12 lagnas |
| **Sankha** | the 5th and 6th lords in relation | **both are Shani** | **Kanya alone** |
| **Kusuma** | a fixed ascendant | Kanya is dual | all dual and movable lagnas |

> **Khadga and Sankha are not absent from this chart. They are unavailable** —
> and Sankha is foreclosed for Kanya alone out of twelve ascendants.
>
> **That distinction matters and this reading has not been making it.** §14
> lists yogas as *forms* or *absent*, which reads as though the chart narrowly
> missed them. For these three it missed nothing: **the ascendant foreclosed
> them before any graha was placed.**

**And the symmetry reaches past the yogas.** The same mirror pairing is why Guru
rules the 4th *and* the 7th, and Budha the 1st *and* the 10th —

> **which is to say the kendradhipati dosha §36 called the most expensive unread
> rule in the document is a direct consequence of this symmetry. It is not an
> accident of this nativity. It is what Kanya lagna *is*.**

### Chapter 27 — planetary war, never tested

Graha yuddha occurs when two non-luminous grahas come within one degree. The
reading has never computed it, in a chart with **four grahas crowded into
Vrishabha** where a war would have been entirely plausible.

| Closest non-luminous pairs | |
|---|---|
| Mangal – Shani | **10.58°** |
| Budha – Shukra | 13.15° |
| Mangal – Shukra | 13.71° |
...
**No planetary war.** The closest pair is **eleven times** the one-degree
threshold. A negative result worth one line — but it was an untested assumption
until now.

### What an address does, and does not, settle

§36 priced eight disputed rules and said one page would settle most of them.
**Honestly, here is what changed:**

| | |
|---|---|
| **Retired** | **D8 and D11 construction.** Chapter 6 names the sixteen and neither is among them, so there was never a Parashari rule to disagree with. The dispute dissolves rather than resolving |
| **Resolved** | **The chapter-73 ray scaling.** Chapter 28 identified what the rays feed, which sent me to the supplied Shadbala table, which confirms the scaling to four decimals. **Settled by data the repository already held** |
| **Located, not settled** | Shodashavarga starting signs → **ch 6** · kendradhipati dosha → **ch 34** · viparita raja yoga → **ch 39–41** · trikona-and-dusthana lordship → **ch 34** · drishti inside a varga → **ch 8 and 26** · argala counter-houses → **ch 31** |
...
> undetermined in this document as they were before it arrived.

**One thing did sharpen.** Chapter 34's subtitle runs through the ascendants one
at a time — Aries, Taurus, Gemini, Cancer, Leo, **Virgo**, Libra, and on. So the
kendradhipati question for this chart is not a general doctrine to be weighed:
**it is a specific passage about Kanya lagna, and it will say plainly whether
Guru is a malefic here.** §36 called that the most expensive unread rule in the
document. **It is now the most precisely located one** — and the symmetry
finding above explains why it was always going to be load-bearing for this
ascendant.

**And the page added work rather than closing it:** one more dasha system
(Varnada, ch 5 — the count is 27, not 26), three special ascendants, sign
aspects, evils at birth, upagraha effects by house, and fifty-one named yogas
of which this section closes every one whose rule can be stated.

---

## 38. The classical sequence, run in order on the 10th house

A methodological correction was put to this reading: **don't invent percentage
weights** — *"I would not say D1 = 35%, Varga = 25%, Shadbala = 8%. That is not
a classical prescription."* Instead, judge in sequence:

> **Subject → Bhava → Bhava Lord → Kāraka → Relevant Varga → Planetary
> Strength → Bhava Strength → Yogas and Afflictions → Dasha → Transit and
> Ashtakavarga**

**Two claims, and they need separate answers.**

**The weights: nothing to retract, because there is nothing there.** This
document has never assigned a percentage weight to a technique. Checked by
search across the whole file — **zero occurrences.** The only percentages in it
are **Vimshopaka's own varga weights**, which are classical and come from the
very chapter that defines the measure (ch. 7), and **rarity frequencies from an
explicit null model** in §49. The correction is sound as general method and
simply does not describe this reading.

**The order: that one lands.** This document computed everything and
synthesised afterwards, which is not the same as judging in sequence. It
reached for Shadbala early and often. **So the test is to run the sequence in
strict order on the 10th house and record the running verdict after every step
— and see where it moves.**

### The ten steps

**1 — the subject.** The 10th: profession, authority, status, the karma one is
seen doing. Here it is **Mithuna**, lord **Budha**. Nothing judged yet.

**2 — the bhava itself.** Sign, occupants, aspects, *before* the lord.

| | |
|---|---|
| sign | Mithuna — dual, air |
| occupants | **Guru** |
| aspects onto it | **none — from any graha** |

A benefic sits in the career house, unaspected by malefics *and* unaspected by
benefics. **No affliction and no help. A sealed chamber.**

> **Running verdict:** career house occupied by a benefic, sealed from all
> outside influence.

**3 — the bhava lord.** This is the heart of it.

| | |
|---|---|
| lord | Budha — **also the lagna lord** |
| placed in | the **8th** — a dusthana, lowest SAV in the chart (21) |
| dignity | neutral |
| combustion | **9.00° from Surya — combust** |
| conjoined with | Surya, **Shukra** |
| aspected by | **none** |

The lord of the career house is buried in the house of upheaval, combust,
unaspected — and the self and the career run through **one** compromised graha.
**One counterweight, and it is real:** Budha sits with **Shukra, the 9th lord**
— the **Dharma-Karmadhipati yoga**, the strongest raja yoga in Parashari
astrology. **It forms in the 8th.**

> **Running verdict — moved:** real promise, damaged channel, delivery only
> through upheaval.

**4 — the kārakas.**

| Karaka | House | Dignity | Ishta | |
|---|---|---|---|---|
| Surya | 8th | **exalted** | 46.88 | authority — but rules the 12th |
| Budha | 8th | neutral | 18.91 | the damaged lord from step 3 |
| Guru | **10th** | **enemy** | 37.30 | present but uncomfortable |
| Shani | 9th | friend | **12.48 — lowest in the chart** | service, the long grind |

**The authority karaka is splendid and placed in loss; the counsel karaka is
present and uncomfortable; the transaction karaka is burnt; the service karaka
delivers least of anything he owns.** *Corroborates step 3. Verdict unchanged.*

**5 — the relevant varga, D10.** And here the drafted expectation was wrong.

| Graha | D10 sign | D10 house | Dignity |
|---|---|---|---|
| Budha | Karka | 6th | **enemy** |
| Guru | Tula | 9th | **enemy** |
| **Shukra** | **Vrischika** | **10th** | neutral |
| Surya | Mesha | 3rd | exalted |

> **I expected the D10 to flatter the chart** — the standard caution that a
> varga carries sign dignity but not affliction, so a combust, buried graha can
> look clean in the divisional. **It does not flatter. Budha and Guru are both
> in enemy signs there, and the varga is harsher than the D1.**

**The risk turns out to be narrower and sharper.** The D10 contains exactly one
flattering fact — **Shukra, the Atmakaraka and highest Ishta in the chart,
sitting in the D10's own 10th house.** Read early and alone, that single
placement will carry a confident career story. Read at step 5, it arrives after
the sealed bhava and the buried lord and can only qualify them. *Verdict
unchanged.*

**6 — planetary strength.**

| | Rupas | Required | Ratio | Rank |
|---|---|---|---|---|
| **Budha** | 6.46 | 7.00 | **0.92 — fails** | **7 of 7** |
| Guru | 8.21 | 6.50 | 1.26 | 4 |
| Surya | 11.39 | 5.00 | 2.28 | 1 |

**Budha is the only graha in the chart failing its Shadbala minimum, and it is
both the career lord and the lagna lord.** Note what this step did and did not
do: **it did not discover the problem** — step 3 already had the lord combust
in a dusthana. **It measured how bad the problem is**, which is exactly the role
the sequence assigns it.

> **Had strength come first**, the reading would have opened from *"Budha rank
> 7, Surya rank 1"* and been tempted to build the career story on **Surya** —
> the strongest graha in the chart, which rules the **12th** and is only a
> karaka here, not the lord. **The sequence prevents that substitution.**

*Verdict unchanged.*

**7 — bhava strength.** The 10th is **7.39 rupas, rank 9 of 12** — below the
middle, not catastrophic. **And here the two strength measures disagree, which
is the point of keeping them separate:** the *house* is mediocre while its
*lord* is the worst graha in the chart. **The house is ordinary. The man who
runs it is not well.** *Verdict unchanged.*

**8 — benefic/malefic, affliction, yogas.** No aspect at all onto the bhava.
Guru in an enemy sign carrying kendradhipati dosha. The lord combust between a
malefic and a benefic. **Both career-positive yogas present and both
compromised in the same direction** — the raja yoga fires through the 8th;
Amala runs through a graha that is uncomfortable, asleep, and possibly a
functional malefic. *Verdict unchanged.*

**9 — only now, timing.** Rahu mahadasha to 2040. **Rahu–Guru** to Jan 2028 —
the 10th-house occupant. **Rahu–Budha, Dec 2030 – Jun 2033 — the career lord
itself.**

> **The period that most directly activates the career house hands it to the
> graha step 6 found failing its minimum.** The career lord gets its own period
> and arrives at it as the weakest body in the chart.

*Verdict unchanged.*

**10 — Ashtakavarga and transit, last.** The 10th itself is well supported at
**29 bindus**; its lord sits in the **lowest-SAV sign in the chart, 21**.
Used last and used for transits — which is what §29 did in finding Shani
crossing the natal 10th on a single bindu. **It qualifies the timing. It does
not decide the promise.** *Verdict unchanged.*

### What the sequence proved

| | |
|---|---|
| after step 2 | **set** — sealed career house with a benefic in it |
| after step 3 | **moved** — real promise, damaged channel, delivery through upheaval |
| after steps 4–10 | **unchanged, seven times running** |

**The verdict was set at step 3 and moved zero times across the seven steps
after it. That result cuts both ways.**

**In this reading's favour: the conclusion is robust to method order.** Varga,
Shadbala, Bhava Bala, yogas, dasha and Ashtakavarga qualified and dated the
judgment without changing it. **The career conclusions in §22, §23, §29 and §30
survive being rebuilt in strict classical sequence.**
...
> in a dusthana carrying a raja yoga. Everything after that is refinement. **A
> reading built in classical order would have said the essential thing on its
> first page.**

**And the sequence is a guard against a mistake this document was not
protected from.** §11 read the D10 early and at length. It did not in fact
overreach — but nothing in the method was stopping it, and the D10 holds
exactly one placement (Shukra in its own 10th) capable of carrying a career
story the D1 does not support. **The order is that missing guard.**

---

## 39. Guru through Ashlesha, and the claim about dreams

The claim put to the chart: *does Jupiter transiting Ashlesha bring up deepest
fears or traumas in dreams?*

**This is a transit question, and §38 just established where transit belongs —
step 10, last, as a modifier.** A transit cannot originate a promise; it can
only act on what the natal chart already holds. So the premise is checked
first, the natal apparatus second, and the claim itself last.

### The premise is true, and it is five days old

| | |
|---|---|
| transit Guru | **108.04 — Karka 18°02′** |
| nakshatra | **Ashlesha pada 1**, lord **Budha** |
| the sign | Karka — his **11th house** |
| natal occupants of Karka | **empty** |
| anything natal in Ashlesha | **nothing** |

**The passage, computed with the retrograde loop:**

| | |
|---|---|
| **enters Ashlesha** | **20 August 2026** — five days ago |
| leaves, moving forward | 1 November 2026 |
| **re-enters, retrograde** | **26 January 2027** |
| clears it for good | 27 June 2027 |

> **Two passes, not one — and the second is entered backwards.** About ten
> months of occupancy split across two windows. Anyone quoting a single
> continuous span for this transit is quoting it wrong.

### What Ashlesha is in this chart

**The nakshatra lord is Budha** — and Budha here is lord of the 1st *and* the
10th, combust at 9° in the 8th, and **the only graha in the chart that fails
its Shadbala minimum.** A transit through Budha's asterism routes through the
weakest body he owns.

**And the fact nobody mentions:** Ashlesha ends at 120°, which is the
Karka/Simha boundary — **one of the three gandanta junctions.** Leaving
Ashlesha *is* crossing the water–fire gandanta.

**And Simha is his 12th house.**

### What the transit actually touches

| Aspect | Falls on | House | Occupants |
|---|---|---|---|
| **5th** | **Vrischika** | **3rd** | **Ketu** |
| 7th | Makara | 5th | empty |
| 9th | Meena | 7th | empty |

**The first row is the finding.** For ten months a benefic throws its most
creative aspect onto **Ketu in the severest gandanta pada in the zodiac** — the
chart's single most unstable point, a node of dissolution in the house of
initiative.
...
### Gochara says the transit is unfavourable

| | |
|---|---|
| from the natal **Chandra** | the **3rd** |
| from the natal lagna | the 11th |

**Guru is favourable in the 2nd, 5th, 7th, 9th and 11th from Chandra.** The 3rd
is not among them. **Gochara is read from the Moon**, so the standard method
calls this passage unfavourable — good from the lagna, bad from the Moon, and
the Moon governs.

Guru's own bindus in Karka: **5 of 8** — middling. Neither the single-bindu
crossing §29 flags for Shani over the 10th, nor a well-supported passage.

### The one thing that makes this transit matter at all

> **Guru is the running antardasha lord.** Rahu–Guru, September 2025 to **31
> January 2028** — and the entire Ashlesha passage sits inside it.

**That is the classical condition for a transit to have force.** A gochara by a
graha that owns no period is weather. A gochara *by the period lord* is the
period expressing itself. §38's step 9 exists to keep those apart, and here
they coincide.

### The natal apparatus — which is where the answer actually is

| | |
|---|---|
| **the 12th** — bed, sleep, dreams | **empty**; lord **Surya exalted** in the 8th; **Bhava Bala rank 1 of 12 — the strongest house in the chart** |
| **Chandra** — the mind | **exalted** in the 9th, and **Mrita — "dead" by avastha** |
| **the 8th** — fear, the hidden | three grahas, **no aspect reaches it**, rank 12 of 12, lowest SAV (21) |
| **Ketu** — dissolution | 3rd house, **severest gandanta pada**, and the target of the transit's 5th aspect |
...
### Does the classical method support the claim?

**Directly, no — and that has to be said plainly.**

Parashara's transit material gives results in terms of gain, loss, illness,
honour, travel and conflict. **Nowhere in the fifty-five chapters this reading
has enumerated is there a rule of the form "graha X in nakshatra Y produces
fears in sleep."** Dream content is not assigned to a graha crossing an
asterism.

**"Ashlesha brings up the subconscious" is a modern nakshatra-astrology
association** — built from the asterism's symbolism, the coiled serpent, the
Sarpa deity, the clinging embrace. It is coherent and widely taught. **It is
not a Parashari rule, and this reading has no text for it.**

What the method *does* own: the **12th** governs sleep and the bed; **Chandra**
governs the mind; the **8th** governs fear and what is hidden; **Ketu** governs
what surfaces without a cause. **The question is answerable. It is just not
answerable from Ashlesha.**

### The dates that actually matter — and I had these wrong first

**I drafted this saying Guru leaves Ashlesha on 27 June 2027 and that crossing
is the event.** The ingress computation says there are **three** crossings, and
the middle one goes backwards.

| Date | | Motion | |
|---|---|---|---|
| 1 Nov 2026 | Karka → Simha | +0.12 | **gandanta crossing, direct — into the 12th** |
| **26 Jan 2027** | Simha → Karka | **−0.12** | **gandanta crossing, RETROGRADE — back out of the 12th** |
| 27 Jun 2027 | Karka → Simha | +0.17 | **gandanta crossing, direct — into the 12th** |
| 27 Nov 2027 | Simha → Kanya | +0.13 | into the **natal lagna** |

> **Guru crosses the Ashlesha–Magha gandanta three times in thirteen months**,
> and one of those passages is retrograde. A retrograde crossing back through a
> gandanta is not a common event, and nothing in this reading had noticed it.

**So the transit the question asks about is the waiting room.** Ashlesha is the
last quarter of Karka; what it is the approach *to* is the twelfth house — and
Guru reaches it three separate times before settling there from June to
November 2027.

### The answer

1. **The premise is correct.** Guru is in Ashlesha, since 20 August 2026.
2. **The stated mechanism is not classical.** No Parashari rule connects a
   nakshatra transit to dream content. The association is modern and
   symbolic — real as a teaching, absent from the text.
3. **Gochara calls the transit unfavourable** — 3rd from the Moon — and it
   carries real force because **Guru is the running antardasha lord.**
4. **The sharpest fact is one the question did not reach for:** the transit's
   5th aspect sits on Ketu in the severest gandanta pada, for ten months.
5. **The natal apparatus for a loaded inner life is genuinely there** — an
   exalted Moon in a dead avastha, a sealed 8th holding three grahas, a
   gandanta Ketu — **but it is natal, not transit-caused.** It has been there
   since birth.
6. **And the destination contradicts the claim.** Guru enters the 12th as a
   benefic, into the **best-built house in the chart**, ruled by an **exalted
   Surya**. The classical reading of that is retreat, pilgrimage, foreign
   residence, expenditure on good account and **undisturbed sleep** — not
   nightmares.

> **If difficult material has in fact been surfacing in his dreams, the chart
> does not locate the cause in this transit.** The honest answer is to say so
> rather than to find a rule that fits after the fact.

---

## 40. When — the marriage question, timed in classical order

*"When will he find his soulmate or girl?"*

§38 fixed where timing belongs: **step 9**, after the bhava, its lord, the
kāraka, the varga, both strengths and the afflictions are judged. Steps 1–8 for
the 7th are already done in `bhava-krama.md`, so they are recapped, not redone.

**One thing said up front.** Jyotisha times the **activation of a promise**. It
does not name a person, guarantee an event, or distinguish *meeting* someone
from *marrying* them. Every window below is a period in which the 7th house is
under period-and-transit pressure. **What happens inside it is not in the
chart.**
...
| | |
|---|---|
| the bhava | **Meena — empty, and no aspect from any graha** |
| the lord | **Guru**, in the 10th — a kendra — in an **enemy sign**, alone |
| the kāraka | **Shukra**, in the 8th, **Ishta 47.49 — the highest in the chart** |
| the varga | **the D9 7th holds Mangal and Ketu** — two malefics |
| strength | Bhava Bala **rank 4 of 12**; SAV **33**, second-highest |
| affliction | lord is **badhakesh** for a dual lagna, and carries kendradhipati dosha |

**A strong house with a specific affliction — and the affliction is in the
navamsa, not the rashi.** That judgment is fixed before any date is named.

### The Upapada — never computed in this reading until now

The **Upapada Lagna** is the arudha of the 12th house, and the most specific
marriage indicator Jaimini gives. Count from the 12th to its lord, then the
same distance again.

| | |
|---|---|
| 12th house | Simha, lord **Surya** in Mesha — 8 signs |
| **Upapada** | **Dhanu — his 4th house** |
| **its lord** | **Guru** |
| 2nd from Upapada | Makara, lord Shani — the house of the marriage's survival |

> **The 7th lord is Guru. The Upapada lord is Guru. They are the same graha.**
>
> Two independent systems — Parashari house lordship and Jaimini arudha — hand
> the marriage to **one body**. Nothing else in this chart has that property.
> And Guru rules the 4th as well, which is the house the Upapada falls in.

### Step 9 — the dasha structure

| Antardasha | Period | Ages | |
|---|---|---|---|
| Rahu–Rahu | Dec 2022 – Sep 2025 | 20.7–23.4 | |
| **Rahu–Guru** | **6 Sep 2025 – 31 Jan 2028** | **23.4–25.8** | **7th lord *and* Upapada lord — running now** |
| Rahu–Shani | Jan 2028 – Dec 2030 | 25.8–28.6 | lord of the 2nd from Upapada |
| Rahu–Budha | Dec 2030 – Jun 2033 | 28.6–31.2 | |
| Rahu–Ketu | Jun 2033 – Jul 2034 | 31.2–32.2 | |
| **Rahu–Shukra** | **Jul 2034 – Jul 2037** | **32.2–35.2** | **kāraka of marriage, highest Ishta** |

**Inside Rahu–Guru**, the pratyantardasha of the kāraka:

> **Rahu–Guru–Shukra: 11 November 2026 – 6 April 2027.** Roughly five months.
> As of the date this was asked it **has not started** — it opens in about
> eleven weeks.

### Step 10 — the double transit, scanned
...
7th and 9th aspects reach three signs it never enters. Scanning occupancy alone
threw away most of the evidence — including the configuration running right
now.

So every month from 2026 to 2040 was scanned for the classical trigger: **do
Guru and Shani both touch the 7th house, by occupation or aspect?**

| From | To | Guru | Shani | Ages | Antardasha |
|---|---|---|---|---|---|
| **15 Jun 2026** | **12 Nov 2026** | aspect | **in** | 24.2–24.6 | **Rahu–Guru** — *running now* |
| **26 Jan 2027** | **10 Jun 2027** | aspect | **in** | 24.8–25.2 | **Rahu–Guru** |
| **7 Dec 2027** | **6 Mar 2028** | aspect | **in** | 25.6–25.9 | **Rahu–Guru** |
| 4 Apr 2034 | 18 Jul 2034 | **in** | aspect | 32.0–32.3 | Rahu–Ketu |
| 9 Mar 2039 | 8 Apr 2039 | aspect | aspect | 36.9–37.0 | Rahu–Chandra |
| 19 Nov 2039 | 17 Apr 2040 | aspect | aspect | 37.6–38.0 | Rahu–Chandra |
| 1 Jul 2040 | 13 Dec 2040 | aspect | aspect | 38.2–38.7 | Rahu–Mangal |

> **Three of the seven double-transit windows between now and 2040 fall inside
> Rahu–Guru. The Rahu–Shukra period contains none.**

**And the honest qualification most statements of this rule omit.** Shani has
been sitting **in** the 7th house since 30 March 2025 — and *that* is what
completes the double transit. **It is also the classical signature of delay in
marriage.** The same placement argues both ways, and the tradition holds both
readings:

| | |
|---|---|
| as **double transit** | the 7th is under both great grahas — **activation** |
| as **Shani in the 7th** | the 7th is under its heaviest natural obstruction — **delay** |

**What is not ambiguous** is that the 7th is under maximum attention right now,
and that this coincides with the only antardasha in the whole mahadasha owned
by the graha that rules both the 7th and the Upapada.

### The answer, ranked — and the ranking changed when the scan ran

**My first version ranked on dasha alone** and put Rahu–Shukra (2034–37) a
strong second on the kāraka's strength. **The scan overturned that.**

**1. The tightest window in his chart — 26 January to 6 April 2027**, ages
24.8–25.0, about ten weeks. **Three things coincide, and only here:**

- antardasha **Rahu–Guru** — 7th lord *and* Upapada lord
- pratyantardasha **Rahu–Guru–Shukra** — the kāraka of marriage
- **double transit** on the 7th house

**2. The whole of Rahu–Guru — now to 31 January 2028**, ages 23.4–25.8. Guru is
the only graha owning both the 7th and the Upapada, and **this is its only
antardasha in an eighteen-year mahadasha.** Two further double-transit windows
sit inside it, including the one running now.

**3. April–July 2034**, ages 32.0–32.3. **Guru *in* the 7th** with Shani
aspecting — the strongest *form* of double transit. But the antardasha is
**Rahu–Ketu**, and Ketu is the graha of severance sitting in gandanta. **A
strong transit under a poor period.**

**4. Rahu–Shukra, July 2034 – July 2037.** The kāraka's own period and the
chart's highest Ishta — **but no double transit on the 7th falls inside it.
Strong promise, no trigger.**
...
> **The sentence I would stand behind.** The chart's clearest marriage
> activation is **running now and closes 31 January 2028**, with its sharpest
> point at **26 January – 6 April 2027**. It is distinctive not for strength
> but for **convergence**: the only graha owning both the 7th and the Upapada
> is running its only period in eighteen years, and the double transit falls
> inside it three times.
>
> **If nothing comes of it, the next comparable convergence is not until 2034
> — and it arrives under Ketu.**

---

## 41. When would he find his place

*"His place"* splits four ways in a chart, and this one answers them very
differently. Rather than pick a reading, all four are computed in the classical
sequence and ranked — **the comparison is the answer.**

| | The house | What it means |
|---|---|---|
| **a home** | the **4th** | roots, land, the ground under him, inner settledness |
| **a standing** | the **10th** | his position in the world, what he is seen as |
| **belonging** | the **11th** | the circle, the network, the people he is among |
| **elsewhere** | the **12th** | foreign residence, retreat, the place away |

### The four, side by side

| | 4th — a home | 10th — a standing | 11th — belonging | 12th — elsewhere |
|---|---|---|---|---|
| sign | Dhanu | Mithuna | Karka | Simha |
| occupants | empty | **Guru** | empty | empty |
| aspects | Guru (7th), Mangal (8th) | **none** | Shani (3rd) — malefic only | Mangal (4th) — malefic only |
| lord | **Guru**, 10th, enemy, **1.26×** | **Budha**, 8th, **0.92× — FAILS** | **Chandra, exalted**, 9th, 1.07× | **Surya, exalted**, 8th, **2.28×** |
| kāraka | **Chandra exalted**; Mangal | Surya exalted; Budha | Guru, enemy sign | Shani; Ketu |
| **Bhava Bala** | **9.28 — rank 2** | 7.39 — rank 9 | 7.08 — rank 11 | **12.59 — rank 1** |
| SAV | 29 | 29 | 28 | 24 |

### The ranking is the answer, and it is uncomfortable

> **The strongest place he owns is the 12th — *elsewhere*.** Rank 1 of 12 by a
> margin of **3.31 rupas** over the next house, with an **exalted, undivided
> lord** that is also the strongest graha in the chart.

**Second is the 4th — a home.** Rank 2 of 12, lord in a kendra, kāraka Chandra
exalted at the **lowest Kashta in the chart (4.49)**, and — uniquely among
these four — **nothing structural to flag against it.**

**Then a large gap.** *A standing* is rank 9 and its lord is the only graha in
the chart that fails its own minimum. *Belonging* is rank 11, touched by a
malefic and nothing else.

**So this is not one question with one date.** The chart gives him **two strong
places and two weak ones — and the two strong ones are a roof and away.** That
is the same tension §61 names as setting down what he wanted most.

### Timed

**Elsewhere — the 12th.** Its strength is **structural, not dated**: it is true
at birth and needs no period to make it so. What *is* dated is when it becomes
visible.

> **Guru enters the 12th on 1 November 2026**, retrogrades out, and holds it
> properly from **27 June to late November 2027** — all of it inside Rahu–Guru.

**A home — the 4th.** Three windows, and they are not equal:

| | |
|---|---|
| **Rahu–Guru, now to 31 Jan 2028** | its **lord's own period** — running now |
| Feb 2031 – Mar 2032, ages 28.8–29.9 | **Guru transiting the 4th itself** — a transit, so the weakest of the three |
| **Guru mahadasha, Dec 2040 – Dec 2056** | **sixteen years under the lord of the home** — the best mahadasha in the chart |

**A standing — the 10th.** **Dec 2030 – Jun 2033**, when the failing
lagna-and-career lord runs its antardasha. Guru transits the 10th later, Sep
2036 – Apr 2037, but under Rahu–Surya rather than a career period.

> **The place he is least equipped to find is the one most people mean by the
> word.**

**Belonging — the 11th.** Rahu–Chandra, **Jun 2038 – Dec 2039**. Rank 11 of 12
and malefic-touched — **and yet its lord is exalted and undivided.** The house
and the lord flatly contradict each other, which the krama already flagged as
the sharpest internal disagreement in the chart.

### One date that belongs to all four

> **Guru crosses his own lagna on 28 November 2027**, retrogrades, and returns
> **25 July 2028.**

Guru over the ascendant is the classical marker for *the person* becoming
established rather than a department of their life. It falls at the very end of
Rahu–Guru and just after it — **ages 25.6 to 26.3.**

### The answer

**He finds his place soonest in the two houses that mean a roof and away, and
both are live right now** — the 4th's lord is running its period to **31 January
2028**, and Guru sits in the 12th for most of that span.

**The durable answer is later and larger:** the **Guru mahadasha, December 2040
to December 2056** — sixteen years run by the lord of the home, and the best
mahadasha this chart contains. If *place* means a settled ground that holds,
that is where the chart puts it.
...
## 42. The field — when he finds it, and when the deepening starts

The question sharpened from §41: not a job and not a standing, but **a field** —
a domain he settles into — and then **going deep in it.**

**Those are two different questions and the chart answers them with different
apparatus, twelve years apart.**

| | Judged by |
|---|---|
| **finding a field** | the 10th and its lord; the **Amatyakaraka**; the **10th from Karakamsa**; the D10 |
| **deepening it** | the 5th (discernment, mastery); the **D24, the varga of learning**; Guru as knowledge, Shani as depth-through-time |

### Who owns the field — four independent indicators

**Parashari.** The 10th is Mithuna, holding **Guru alone and unaspected**; its
lord **Budha** is in the 8th, combust, **ratio 0.92 — the only graha in the
chart that fails its minimum.**

**Jaimini — computed here for the first time.** The chara karakas by degree:

| | | |
|---|---|---|
| **Atmakaraka** | **Shukra** | 23.61° |
| **Amatyakaraka** | **Shani** | 17.91° |
| Bhratrikaraka | Guru | 14.80° |
| Matrikaraka | Budha | 10.46° |

> **The Amatyakaraka is Shani** — in Jaimini *the* karaka of profession, the
> minister who executes the Atmakaraka's purpose.

**Karakamsa.** Shukra's navamsa is Vrischika, so the Karakamsa is **Vrischika —
his natal 3rd**. The **10th from it is Simha**, lord **Surya exalted** — and
Simha **is his 12th house.**

**Varga.**

| | Lagna | Its 10th | Occupants |
|---|---|---|---|
| **D10** — the work | Kumbha | Vrischika | **Shukra** |
| **D24** — the learning | Vrishabha | Kumbha | **Shukra** |

> **Shukra is the only occupant of the 10th in either varga — and it occupies
> both.** The professional house of the chart that shows the work *and* of the
> chart that shows the learning. It is also the Atmakaraka and carries the
> highest Ishta phala in the chart.

**[Amended in §46. The D10 half stands — the D10 lagna is Kumbha on both lagna
values. The D24 half does not: on the computed lagna the D24 ascendant is Mesha
and Shukra falls in its 11th. The convergence is contingent on a fifty-six-second
question; Shukra in the D10 tenth is not.]**

### What the field looks like

| Indicator | Points to | Which signifies |
|---|---|---|
| 10th lord | **Budha / Mithuna** | analysis, language, transaction — the handling of information |
| 10th occupant | **Guru**, enemy sign | counsel, teaching, knowledge-work — but uncomfortable |
| **Amatyakaraka** | **Shani** | structure, endurance, systems, the long patient grind |
| 10th from Karakamsa | **Simha / Surya** | authority and the visible position — **but it is his 12th house** |

**The four do not name a profession and Jyotisha does not pretend to.** What
...
- the position is **behind the visible** — the 10th from Karakamsa lands in the 12th

> **A field where the work is with knowledge or systems, done slowly and
> thoroughly, from a position that is not the front of the house.** That is as
> specific as the method honestly gets.

### Depth — and it turns out to be one graha

The 5th house is **Makara — empty, unaspected, rank 6 of 12** — and its lord is
**Shani.**

> **The lord of the 5th and the Amatyakaraka are the same graha.** So in this
> chart the faculty of going deep and the karaka of vocation are **one body**.
> Depth is not a separate project from his career; it is the same graha wearing
> two hats.

| Shani | |
|---|---|
| placement | 9th, friendly sign, with Chandra, Mangal and Rahu |
| Shadbala | **ratio 1.28 — the best in the chart after Surya** |
| Kashta | **46.83 — the highest cost of any graha he owns** |

**Depth is available, well resourced, and the most expensive thing in the
chart.** That is coherent rather than contradictory: mastery by Shani is bought
with time and discomfort, and this chart prices it accordingly.

### The D24 — the varga of learning, never used in this reading until now

| Graha | D24 sign | House | Dignity |
|---|---|---|---|
| **Guru** | Karka | 3rd | **exalted** |
| **Shukra** | Kumbha | **10th** | friend |
| Shani | Kanya | 5th | friend |
| Surya | Kanya | 5th | neutral |
| **Budha** | Mesha | **12th** | neutral — **with both nodes** |

**Two things stand out and they point the same way.**

**Guru is exalted in the D24** — the only exaltation in the learning chart. Guru
*is* knowledge, and it is at its best in the varga that shows how deeply a
person learns.

**Budha, the career lord, is in the D24 twelfth, with Rahu and Ketu.** The graha
that runs his profession is in the house of loss in the learning chart, flanked
by both nodes. **[Amended in §46: on the computed lagna this is the D24 *first*,
not the twelfth. The finding below rests on Guru's exaltation, whose sign is
Karka either way, and survives without this.]**

> **The capacity to go deep is excellent, and it does not arrive through the
> career lord.** Credentialing through the professional channel is the weak
> route; knowledge held for its own sake is the strong one.

### The timeline, with finding separated from deepening

| Period | | Ages | What it activates |
|---|---|---|---|
| **Rahu–Guru** | Sep 2025 – **31 Jan 2028** | 23.4–25.8 | the **10th-house occupant**, exalted in the D24 |
| **Rahu–Shani** | Jan 2028 – Dec 2030 | 25.8–28.6 | the **Amatyakaraka** and the 5th lord |
| Rahu–Budha | Dec 2030 – Jun 2033 | 28.6–31.2 | the 10th lord — **the graha that fails its minimum** |
| Rahu–Shukra | Jul 2034 – Jul 2037 | 32.2–35.2 | holds the 10th of **both** vargas |
| **Guru mahadasha** | **Dec 2040 – Dec 2056** | **38.7–54.7** | **sixteen years under the 10th-house occupant** |
| **Shani mahadasha** | **Dec 2056 – Dec 2075** | **54.7–73.7** | **nineteen years under vocation-and-depth** |

**The finding era — 2028 to 2037.** Three separate professional activations in
nine years, by three different grahas — **and none of them is the graha actually
sitting in his 10th house.** That is a decade of trying things rather than a
decade of settling into one. The middle one, **Rahu–Budha**, hands the career to
the chart's weakest graha; this document has called it *the hinge* since §17,
and it is the period most likely to look like a false start.

**The deepening era — from December 2040.**

> **Thirty-five consecutive years, from 38 to 73, run by the two grahas that
> mean knowledge and depth.** Guru — sole occupant of the career house, exalted
> in the varga of learning — takes sixteen years; Shani — Amatyakaraka and lord
> of the 5th — takes the following nineteen.

### The answer

**When he finds it.** The first serious candidate is **January 2028 – December
2030**, Rahu–Shani — the first time the vocation karaka runs a period, and the
window §38 already calls *the foundation*. **But the finding stays contested for
nine years after it**, because three different grahas activate the profession
between 2028 and 2037 and none is the one standing in his 10th.

**When the deepening begins. December 2040, and it is not subtle.**

**It is a late chart for this, and that is a finding rather than a hedge.** The
career house is sealed, its lord is combust and failing, and **the two grahas
equipped to make a field deep do not get their own periods until he is nearly
forty.** What runs before then is capable and scattered.

> **One thing available now that is worth more than it looks.** Guru is the
> 10th-house occupant *and* runs the current antardasha **to 31 January 2028**.
> This is the **only period before 2040** in which the graha actually standing
> in his career house is in charge. It is short, it is running, and **it will
> not repeat for thirteen years.**

**And the caveat.** A dasha activates a capacity; it does not choose a subject.
Nothing here names an industry. The chart gives the **shape** — knowledge or
systems, handled patiently, from behind the visible position — and **when** that
shape has period support. The choosing is not in the chart.

---

## 43. Chandra grahan and the D10 lagna

The claim: *a lunar eclipse would affect his D10 lagna.*

**There is a Chandra grahan in Kumbha on 28 August 2026 — three days after this
was asked — and Kumbha is his D10 ascendant sign.** So the question has a real
occasion. The obvious answer then fails four separate ways, and the fourth is
the one nobody raises.

### The premise, computed

| | |
|---|---|
| next Chandra grahan | **28 Aug 2026, 09:42 IST** |
| type | partial |
| Moon at | **Kumbha 10.62 — Shatabhisha** |
| that sign is his | **6th house** |
| his D10 lagna sign | **Kumbha** |
| transit Rahu | Kumbha 5.27 — the node in the same sign, which is what makes an eclipse there possible |

### 1 — the strict test fails

*"An eclipse on his D10 lagna"* means one of two things, exactly as the
Dhanishtha claim in §33 did. **Loose:** the eclipse is in Kumbha, and Kumbha is
the sign the D10 ascendant falls in. **Strict:** the eclipse's longitude,
*mapped into the D10*, lands on the D10 ascendant.

| | |
|---|---|
| eclipse Moon | 310.620 = Kumbha 10.62 |
| **mapped into the D10** | **Vrishabha** |
| the D10 lagna is | Kumbha |
| | **so it sits in D10 house 4, not the 1st** |

**A D10 sign is three degrees wide.** Anything crossing the zodiac sweeps all
twelve of them inside one rashi, so *being on the D10 lagna* is a matter of
hours and has nothing to do with which sign the eclipse falls in.

### 2 — and the method does not allow the question anyway

§26 recorded that running transit logic *inside* a divisional chart is done by
many and rejected by others, because **a varga maps dignity rather than a sky.**
§33 declined to do it. §38 put transit at step 10, as a modifier on the natal
promise rather than an actor.

> **That position holds here and is not reopened for a more dramatic transit.**
> An eclipse is a spectacular event in the sky. The D10 is not a sky — it is a
> tenfold subdivision for grading professional dignity. **There is no point in
> the D10 for an eclipse to happen at.**

### 3 — the fact that actually decides it: visibility

**A grahan is held to act where it is seen.** An eclipse below the horizon at a
place is traditionally taken not to apply to people there — which is why
panchangas print eclipse timings per city and why the observances are dropped
where the eclipse is invisible.

| | |
|---|---|
| eclipse maximum | 28 Aug 2026, **09:42 IST** |
| **Moon's altitude at Guntur** | **−53.8°** |

> **The Moon is fifty-four degrees below the horizon.** It peaks mid-morning in
> India; the entire event happens on the other side of the earth. **By the
> tradition's own standard this eclipse does not apply to him at all** — a
> simpler and stronger objection than anything about the D10.

> **Amended in §44.** This computes visibility at the **birthplace**, and
> visibility belongs to the **current location**. From anywhere in the United
> States this eclipse is plainly visible, and this objection does not apply.
> The other three below are location-independent and stand.

### 4 — and it is the wrong graha for the subject

A lunar eclipse is Rahu or Ketu taking **the Moon.** What that afflicts is what
Chandra signifies — **the mind, the mother, the public, the emotional body.**
Career belongs to Surya, Budha, Guru and Shani. **A Chandra grahan is not a
career event in the first place.**

There *is* a real natal hook, and it is better than what was asked for: natal
Chandra is **exalted in the 9th and *Mrita* — "dead" by avastha**, the most
distinctive single fact in this chart about his inner life. Any Chandra grahan
speaks to that — but as a recurring seasonal touch on an existing condition,
not as a cause. **And neither eclipse falls on the natal Moon's axis.**

### Why the instinct is still sound

§33 found that **Kumbha carries five separate career identifications**, reached
by five different techniques: the natal **6th**, the **D10 ascendant**, the
**Arudha of the 10th**, the **10th from Chandra**, and the **highest
Sarvashtakavarga in the chart — 41 bindus.** No other sign carries more than
two.

**So an event in Kumbha touches more career signification than an event
anywhere else.** The house is empty, so nothing natal is being eclipsed. **The
instinct is right and the mechanism offered for it is wrong** — it matters
because Kumbha is the career sign, not because the D10 ascendant sits there.

### Which eclipse actually reaches him — and I had this wrong twice

**I drew this list up once with the eclipse-type constants swapped.** In Swiss
Ephemeris `ECL_TOTAL` is 4 and `ECL_PENUMBRAL` is 64; I had them the other way
round, which labelled half the eclipses of the next decade *total* when they are
penumbral, and the reverse. **The corrected list changes the answer.**

Two filters, both classical: **penumbral eclipses darken nothing visibly** and
are widely not observed as grahan; **an eclipse below the horizon** does not
apply where it cannot be seen.

| Date | Type | Moon | House | Alt. | |
|---|---|---|---|---|---|
| 28 Aug 2026 | partial | Kumbha 10.6 | 6 | **−53.8** | below horizon — does not apply |
| 21 Feb 2027 | penumbral | Simha 7.7 | 12 | +25.9 | penumbral — not a grahan |
| 18 Jul 2027 | penumbral | Makara 1.7 | 5 | +34.4 | penumbral |
| 12 Jan 2028 | partial | Mithuna 27.3 | 10 | −35.8 | below horizon |
| 6 Jul 2028 | partial | Dhanu 21.0 | 4 | +50.0 | counts |
| **31 Dec 2028** | **TOTAL** | **Mithuna 16.3** | **10** | **+63.3** | **in his career house, and it counts** |
| 26 Jun 2029 | TOTAL | Dhanu 10.6 | 4 | −42.9 | below horizon |
| **21 Dec 2029** | **TOTAL** | **Mithuna 5.0** | **10** | **+32.1** | **counts** |

**The one the question asks about does not count. The next is merely penumbral.
The career eclipse is twenty-eight months away.**

| **31 December 2028, 22:22 IST** | |
|---|---|
| type | **TOTAL** |
| Moon at | Mithuna 16.31 — Ardra pada 3 |
| his | **10th house — the career house itself** |
| altitude at Guntur | **+63.3° — high in the sky, fully visible** |
| natal Guru at | Mithuna 14.80 |
| **orb from natal Guru** | **1.52°** |
...
§38 established that the 10th is a **sealed** house — no natal graha aspects it
at all. **This is an eclipse landing inside that sealed chamber, on its single
occupant.** Nothing else in the next decade comes close. A second total eclipse
lands in the same house on **21 December 2029**, and **both fall inside
Rahu–Shani** — the period §17 and §42 call *the foundation*.

### The verdict

1. **The premise is correct** — there is a grahan in Kumbha on 28 August 2026,
   and Kumbha is his D10 ascendant sign.
2. **The strict claim is false** — mapped into the D10 it lands in that chart's
   4th house.
3. **The method does not allow the question** — this reading does not run
   transits through vargas.
4. **The eclipse is not visible from Guntur** — 54° below the horizon. By the
   tradition's own standard it does not apply to him.
5. **It is the wrong graha for the subject** — a Chandra grahan afflicts the
   mind, not the profession.
6. **The eclipse that matters for his career is 31 December 2028** — total,
   visible, in the 10th, 1.52° from natal Guru, inside Rahu–Shani.

> **The honest answer inverts the question.** The eclipse three days away is in
> the right *sign* and cannot touch him. The eclipses that can touch him are two
> and four years out — in the right **house**, on the right **graha**, inside
> the right **period** — and nobody is talking about those.

**And the caveat this document always attaches.** An eclipse marks a window in
which part of a chart is under pressure. It does not say what happens in it, and
**it does not create a promise the natal chart does not already hold.**

---

## 44. What if he is in the USA

**This is a fair challenge to §43 and it lands.**

§43 dismissed the 28 August 2026 Chandra grahan on four grounds and called one
of them decisive: **visibility.** The Moon is 54° below the horizon at Guntur,
and a grahan is held to act where it is seen.

> **But visibility is a property of where he is now, not where he was born.**
> I computed it for the birthplace. If he is in America, that argument
> reverses.

### First — what relocation actually changes

**The natal chart does not move.** It is fixed by the moment and place of birth
and nothing later alters it. In Chicago the lagna is still 27°37′ Kanya, Guru
is still alone in the 10th, Budha is still combust in the 8th.

**And there is no Parashari relocation chart.** Recasting a nativity for a new
city — the relocated chart, astrocartography, local space lines — is a modern
**Western** technique. It is coherent within its own system, but it is not in
Parashara; none of the fifty-five chapters this reading has enumerated contains
it, and this document does not import it.
...
| the daily **panchanga** | tithi, vara, sunrise — and therefore Gulika and the upagrahas for *current* days, never for the natal chart |
| **muhurta** | choosing a moment is always local |

**That is the whole list — and the first item is the one §43 leaned on.**

### §43's four objections, re-examined for a native in America
...
**Three of the four are properties of the chart and the method and do not care
where he stands. The fourth is entirely about where he stands.**

### The eclipse table, recomputed from American longitudes

**28 August 2026 — partial, Kumbha, his 6th and the D10-lagna sign**

| | Altitude | |
|---|---|---|
| Guntur | −53.8 | below |
| **New York** | **+39.0** | **visible**, 00:12 local |
| **Chicago** | **+34.1** | **visible**, 23:12 on the 27th |
| **Dallas** | **+37.1** | **visible** |
| **San Francisco** | **+17.4** | **visible**, 21:12 |
| **Seattle** | **+12.8** | **visible** |

> **The eclipse he asked about is visible from every American longitude
> tested.** If he is in the United States, **§43's decisive objection fails.**
> The other three still stand and are sufficient on their own — but the
> simplest and strongest of the four is gone.
...
|---|---|---|
| Guntur | −35.7 | below |
| **New York** | **+68.9** | **nearly overhead**, 00:13 local |
| Chicago | +60.6 | visible |
| San Francisco | +35.8 | visible |

> **§43 struck this one off the list — "below horizon, does not apply."** True
> at Guntur. **From New York it is sixty-nine degrees up.** A partial eclipse
> in the career house, high in an American sky, falling inside **Rahu–Shani** —
> the period §17 and §42 call *the foundation*. **I dismissed it on Indian
> visibility alone.**

**31 December 2028 — TOTAL, Mithuna 16.3, the 10th, 1.52° from natal Guru**
...
> **§43 called this the eclipse that actually matters. It is below the horizon
> across the entire United States** — it peaks at lunchtime in America. **If he
> is in the USA that December, the strongest eclipse contact in his chart does
> not reach him.**

**21 December 2029 — TOTAL, Mithuna 5.0, the 10th.** Visible from Guntur (+32),
New York (+13) and marginally Chicago (+4); **below the horizon at Dallas, San
Francisco and Seattle.** **This one depends on which American city.**

### What the natal chart already says about him being abroad

**None of this needs a relocation technique.** It is in the birth chart and has
been since 2002.

| | |
|---|---|
| **the 12th house** — foreign residence | Simha, empty, lord **Surya exalted and undivided**; **Bhava Bala 12.59 — rank 1 of 12, the strongest bhava in the chart**, and its lord is the strongest graha in the chart |
| **the D24** — the varga of learning | **Budha, Rahu and Ketu in its 12th** — which §13 already reads as *"foreign study, unambiguously"*. **§46 withdraws this row: the placement flips to the 1st on the computed lagna. The 12th-house row above is unaffected and carries the finding on its own** |
| **§41** | ranked the four senses of *place* and put **elsewhere first**, by 3.31 rupas over a home, with a standing ninth of twelve |

> **The chart does not need to be asked whether he should be abroad. It already
> says that being somewhere other than where he started is the thing it is best
> built for.**
>
> If he is in the USA, **he is living in the strongest house he owns** — and
> that is a natal statement, not a relocation one. It was true before he went.
...
**§43 has to be amended on exactly one point.** I applied the visibility filter
at the *birthplace*; visibility belongs to the *current* location. For a native
in America the 28 August 2026 grahan is plainly visible, and that objection —
the one I called decisive — does not apply to him. **The other three survive
intact and are sufficient.**

**The practical difference, if he is in the United States:**

| | |
|---|---|
| **gained** | **12 January 2028** — a partial eclipse in his **10th house**, nearly overhead from the east coast, inside the foundation period. I had struck it off for being invisible in India |
| **lost** | **31 December 2028** — the total eclipse 1.5° from natal Guru in the sealed 10th. Below the horizon everywhere in America |
| **split** | **21 December 2029** — visible from the east, not the west |

**And the larger point, which does not depend on any of this:** his 12th house
is the best-built bhava in the chart with an exalted lord, his learning varga
puts three grahas in *its* 12th, and §41 already ranked *elsewhere* first among
the four senses of place.

> **The chart was always pointing at somewhere else.** Whether that somewhere is
> the USA is not something Jyotisha can name, and this document will not pretend
> otherwise.

---

## 45. Does the eclipse trigger anything

§44 established that the 28 August 2026 grahan is visible from the United
States, so if he is there it reaches him. **The question is what that does.**

**This document's standing position, stated before the computation so it cannot
be accused of being fitted afterwards:** a transit marks a window in which part
of the chart is under pressure. **It does not say what happens in it, and it
does not create a promise the natal chart does not already hold** (§33, §39,
§43).

### What classical method actually licenses here

**The classical eclipse material is overwhelmingly mundane.** Where the texts
treat grahan at length they are discussing kings, kingdoms, armies, crops,
rainfall and the fortunes of countries — **not what happens to a private
individual in the months after.**

**Individual eclipse-effect prediction is a later and largely popular
elaboration.** It is widely taught and this is not a sneer at it, but it is not
what Parashara is doing, and **the fifty-five chapters enumerated in §35 and §37
contain no rule of the form "an eclipse in house N produces event X for the
native."**
...
**Those three are computed. Nothing else is invented to fill the gap.**

### Both applicable measures come back favourable

**Gochara.** The eclipse Moon is in Kumbha; natal Chandra is in Vrishabha — so
the eclipse is the **10th from the Moon.** Chandra's gochara is favourable in
the 1st, 3rd, 6th, 7th, **10th** and 11th from the janma rashi.

> **The 10th is among them. Favourable.**

**Tara bala.** Janma nakshatra **Krittika** (#3); eclipse nakshatra
**Shatabhisha** (#24). Count = 22 → **tara 4 = Kshema.**

> **Kshema is a favourable tara** — well-being, safety, prosperity.

**So by the two measures the classical method actually gives for an individual,
this eclipse is favourably placed.** That is the opposite of what the question
expects, and it is worth sitting with rather than explaining away. **The dread
attached to grahan is real in practice and in ritual, and it is not what the
transit tables say here.**

### What it actually touches

| | |
|---|---|
| falls in | **Kumbha — his 6th house** |
| what that house is | service, employment, competition, debt, illness, the daily grind |
| occupants | **empty — nothing natal is being eclipsed** |
| its lord | **Shani — the Amatyakaraka**, the Jaimini karaka of profession (§42) |
| Bhava Bala | **rank 10 of 12** |
| Sarvashtakavarga | **41 — the highest of any sign in this chart** |
| Moon's 7th aspect | Simha = the 12th, **empty** |

**One coincidence that looks like something and is not.** The eclipse falls at
10.62° of its sign; natal Budha is at 10.46° of *its* sign — 0.16° apart. **They
are in different signs and different navamsas** (Makara against Karka). Same
degree-in-sign is not a contact in any classical scheme. **It is a numerical
accident, reported here so nobody else mistakes it for a finding.**

### What is already scheduled in this window

| | |
|---|---|
| mahadasha | **Rahu** |
| antardasha | **Guru** — 6 Sep 2025 to **31 Jan 2028** |
| pratyantardasha | **Budha** — 20 May to 21 Sep 2026 |

**And that is the real answer.** Guru in this chart is:

- the **sole occupant of the 10th house** (§42)
- the **7th lord and the Upapada lord** (§40)
- the **4th lord** — home and roots (§41)
- **exalted in the D24**, the varga of learning (§42)

> **It is the only antardasha in an eighteen-year mahadasha owned by the graha
> standing in his career house, and it closes 31 January 2028.**
>
...
### How long an eclipse is held to act

| | |
|---|---|
| preceding solar eclipse | 12 Aug 2026 |
| **this lunar eclipse** | **28 Aug 2026** |
| next lunar eclipse | 21 Feb 2027 |
...
runs until the next one: **August 2026 to February 2027.**

**That rule is folklore rather than text, and is flagged as such rather than
dressed up.** What *is* textual is that the Moon leaves Kumbha in about two days
and does not return for a month.

### The answer

**Not by itself, and the chart gives no reason to expect it to.**

1. **By the two classical measures that apply to an individual it is favourably
   placed** — the 10th from his Moon, and Kshema tara. If you were predicting
   from the transit tables alone, **you would not predict trouble.**
2. **Nothing natal is being eclipsed.** Kumbha is empty; the eclipse conjoins no
   graha of his, and its 7th aspect falls on an empty 12th.
3. **What is under attention is the 6th house** — work, competition, debt,
   health, obligation. A real and specific domain, and **the house whose lord is
   the Amatyakaraka**, so it connects directly to the career questions he has
   been asking. It is rank 10 of 12 with the **highest bindu count in the
   chart** — which §41 read as: *he wins contests he should not comfortably win,
   and the winning costs him.*
4. **And the period underneath is doing the actual work.**

> **The eclipse marks the 6th house for a few weeks, in a favourable transit
> position, touching nothing natal.** If something moves for him between now and
> early 2027, the chart attributes it to **Rahu–Guru** and not to the grahan —
> and it would have been due with or without an eclipse.
...
## 46. The D81, computed — and the promise §2 made that three sections broke

§12 listed the D81 as *"never attempted — needs a birth time finer than was
known"*, printed its positions anyway, and declined to lean on it. Calculating
it properly does two things: it produces a chart worth about one paragraph, and
it walks straight into a disclosure this document undertook to make in §2 and
then did not make three times.

### What the D81 is

**D81, the nava-navamsa** — the navamsa of the navamsa. Each sign divided into
eighty-one parts of **22.22 arcminutes** each.

**It is not in Parashara's sixteen.** §37 enumerated chapter 6's list and D81 is
not among them; it belongs to the Nadi and Jaimini streams, where the
nava-navamsa refines the navamsa result. **So it is computed here as an
extension, not as Parashari doctrine.** Its *construction* is not in dispute,
though — unlike the six vargas §12 declined, D81 is a **pure linear map** with no
starting-sign convention to argue about. Whatever uncertainty it carries is
arithmetic precision, not rule choice.

### The chart

**D81 lagna: Meena** on the supplied longitude (natal lagna Kanya). §3 below
shows why that qualifier is load-bearing.

| Body | D1 longitude | Div / 81 | D81 sign | House | Dignity |
|---|---|---|---|---|---|
| Lagna | 177.6269 | 75 | **Meena** | 1 | — |
| Surya | 1.4675 | 4 | Karka | 5 | friend |
| **Chandra** | 31.7875 | 5 | **Vrishabha** | 3 | **exalted** |
| Mangal | 37.3256 | 20 | Simha | 6 | friend |
| Budha | 10.4639 | 29 | Simha | 6 | friend |
| **Guru** | 74.7978 | 40 | **Makara** | 11 | **debilitated** |
| Shukra | 23.6136 | 64 | Karka | 5 | enemy |
| **Shani** | 47.9069 | 49 | **Makara** | 11 | **own** |
| Rahu | 56.9311 | 73 | Makara | 11 | — |
| Ketu | 236.9311 | 73 | Karka | 5 | — |

| House | Sign | Occupants |
|---|---|---|
| 3 | Vrishabha | Chandra |
| 5 | Karka | Surya, Shukra, Ketu |
| 6 | Simha | Mangal, Budha |
| **11** | **Makara** | **Guru, Shani, Rahu** |

**What it shows, at the weight it deserves.** **Shani in its own sign** — the
only own-sign placement in the D81. **Guru debilitated in the same sign, sitting
with it.** **Chandra exalted in Vrishabha**, repeating its D1 exaltation.

> **Shani own and Guru debilitated in one sign is the sharpest thing here** —
> the graha of depth at home, the graha of knowledge at its worst, together.
> **And that is exactly the pair §42 handed the deepening era to.**

### Precision — and the D81 lagna does not survive it

| | |
|---|---|
| lagna speed at birth | 0.2390°/min = **14.34 arcmin per minute** |
| one D81 division | 22.22 arcmin = **93 seconds of clock time** |

**§2 records a residual of about a minute in the birth moment. The uncertainty
is two-thirds of a division.** And the two lagna values the reading already
holds **straddle a D81 boundary with no perturbation needed at all**:

| | Kanya | Division | Position in it | D81 lagna |
|---|---|---|---|---|
| **supplied** | 27.6269 | 75 | 13.17′ in | **Meena** |
| **computed** | 27.4035 | 74 | 21.99′ in | **Kumbha** |

A ±60-second scan around the stated moment confirms the shape of it:

| Body | −60s | stated | +60s | |
|---|---|---|---|---|
| **Lagna** | Kumbha | Kumbha | Meena | **moves** |
| all nine grahas | — | — | — | **stable** |

> **The nine grahas are all stable. The lagna is not.** The D81 *sign*
> placements are as solid as any varga in the document. The D81 *houses* are
> not, because they are counted from a lagna that changes division every
> ninety-three seconds — and that has already happened between the two values
> the reading holds.
>
> **So the Shani–Guru conjunction in Makara is real. Its house number is not**,
> and nothing above is built on the house column.

### A draft claim, checked and retracted

The first draft of this section said §2 *"never asked which vargas the residual
moves"*, and that the Shodashavarga had never been tested for it. **Both are
false, and the retraction is printed here rather than quietly deleted.**

The two lagna values:

| | |
|---|---|
| **supplied** (source data) | 177.6269 = Kanya **27.6269** |
| **computed** (from the birth moment) | 177.4035 = Kanya **27.4035** |
| difference | **13.41 arcmin = 56 seconds of clock time** |

The clock time that reproduces the supplied lagna is **18:03:41 IST**, against a
stated 18:02:45 — within three seconds of the 18:03:44 §12 uses, and the two
give identical varga lagnas at every division.

Within the sixteen:

| Varga | On supplied | On computed | |
|---|---|---|---|
| D1, D2, D3, D4, D7, D9, D10 | — | — | agree |
| **D12** | Simha | **Karka** | **differs** |
| D16, D20 | — | — | agree |
| **D24** | Vrishabha | **Mesha** | **differs** |
| D27, D30, D40, D45 | — | — | agree |
| **D60** | Mesha | **Meena** | **differs** |

**Three of the sixteen Shodashavarga lagnas differ.** And then the check against
what §2 actually printed:

| | |
|---|---|
| movers computed here, all 27 schemes | D12, D24, D36, D60, D81, D108, D144, D150 |
| movers printed in §2 | D12, D24, D36, D60, D81, D108, D144, D150 |
| stable | **19 of 27 — §2's exact figure** |

> **§2 had it right, to the scheme.** §12's *"5 of 12 move"* was never the whole
> census — its scope is the twelve *further* vargas, and inside that scope it is
> correct too. **The apparatus has had this right from the beginning.**

### What is actually wrong — an unkept promise, not a missing test

§2, having named the movers, wrote:

> *"any claim resting specifically on the D12, D24, D36 or D60 ascendant now
> sits inside a one-minute ambiguity, **and this document flags it wherever it
> makes one**."*

**It then flagged exactly one** — the D60 destination finding in §11. **§13, §42
and §44 each rest a published claim on the D24 ascendant, and none of them
flagged it.**

| D24 lagna | | |
|---|---|---|
| **Vrishabha** *(supplied)* | Shukra **H10**, Budha **H12**, Rahu H12, Ketu H12, Guru H3 |
| **Mesha** *(computed)* | Shukra **H11**, Budha **H1**, Rahu H1, Ketu H1, Guru H4 |

- §42: *"Shukra is the only occupant of the 10th in either varga, and it occupies
  both"* — **H10 on supplied, H11 on computed.** The D10 half stands; the
  convergence does not.
- §42: *"Budha, the career lord, is in the D24 twelfth, with both nodes"* —
  **H12 on supplied, H1 on computed.**
- §13: *"Budha, Rahu and Ketu in the 12th — foreign study, unambiguously"*, which
  §44 then leaned on. **This is the worst of the three: the one place the reading
  claimed certainty about precisely the quantity §2 had already marked
  ambiguous.**

**All three are annotated in place.**

**What survives regardless, because it never uses the D24 lagna:**

- **Guru is exalted in the D24.** Its sign is Karka either way. That was §42's
  strongest D24 finding and it is untouched.
...
- **§44's foreign-residence case**, which rests on the 12th house of the *birth
  chart* — Bhava Bala rank 1 of 12, lord exalted — and needed the D24 row only
  as corroboration.

> **§42's conclusion — that the capacity for depth is excellent and does not
> arrive through the career lord — rests on the part that survives. The
> convergence it decorated the finding with does not.**

**The reading uses the supplied longitudes throughout, which is internally
consistent, and §2 knew what that cost.** What was missing was the flag at the
three places where a claim was actually built on it. **And the D81 falls under
the same rule: its lagna is on §2's mover list, so this section prints the graha
signs and builds nothing on the houses.**

---

## 47. Shani through the 8th, over the exalted Surya

The question names one contact. **The chart makes it three**, because the 8th
house is not empty — and the contact it names turns out to be the mildest of
them by one measure and the least supported by another, which is the honest
result and not the tidy one.

### The 8th house is not empty

| Graha | Position | Dignity | Nakshatra | Rules |
|---|---|---|---|---|
| **Surya** | 01°28′ Mesha | **exalted** | Ashwini 1 | the **12th** |
| **Budha** | 10°27′ Mesha | neutral | Ashwini 4 | the **1st and 10th** |
| **Shukra** | 23°36′ Mesha | neutral | Bharani 4 | the **2nd and 9th** |

**Shani cannot reach Surya without entering Mesha, and it cannot leave Mesha
without also crossing Budha — the lagna lord and the 10th lord — and Shukra,
the Atmakaraka.** The transit the question asks about is the first of three.

### The dates

**It is not one pass. It is three.**

| | |
|---|---|
| **3 June 2027** | Meena → **Mesha — enters the 8th** |
| 20 October 2027 | back to Meena |
| **23 February 2028** | re-enters Mesha |
| 8 August 2029 | to Vrishabha |
| **5 October 2029** | back into Mesha |
| **17 April 2030** | Vrishabha — **finally clear** |

**Every exact crossing:**

| Natal graha | Passes | Dates |
|---|---|---|
| **Surya** (01°28′) | **3** | 19 Jun 2027 · **1 Oct 2027 retrograde** · 8 Mar 2028 |
| **Budha** (10°27′) | **3** | 21 May 2028 · **18 Dec 2028 retrograde** · 24 Jan 2029 |
| **Shukra** (23°36′) | **1** | 31 May 2029 |

Within **one degree** of natal Surya: 8 Jun–4 Jul 2027, 17 Sep–15 Oct 2027,
29 Feb–18 Mar 2028. **72 days in total across three windows** — not a
two-and-a-half-year siege on the Sun, three separate months.

### What Shani is while it does this — and the order is counter-intuitive

**Shani is debilitated in Mesha the entire time.** Debilitation deepens toward
**20° Mesha**:

| | Degree | Distance from deepest debilitation |
|---|---|---|
| **Surya** | 1.47° | **18.5° away — the shallow end** |
| Budha | 10.46° | 9.5° away |
| **Shukra** | 23.61° | **3.6° away — almost exactly the bottom** |

> **The contact the question asks about is the mildest of the three by
> debilitation depth. The one nobody asks about — Shukra, the Atmakaraka —
> is the worst.**

And the relationships run the other way: **Surya and Shani are mutual enemies;
Shukra and Shani are mutual friends.** So the harshest contact by dignity falls
on the friendliest relationship and the mildest falls on the bitterest. **These
pull opposite ways and neither cancels the other.**

### The Ashtakavarga, rebuilt from first principles

This section needed kakshya, which the supplied sheet cannot give — it has
totals, not contributors. **So the whole Ashtakavarga was rebuilt from the
Parashari benefic-place tables**, for the first time in this repository.

| | |
|---|---|
| signs matching the supplied sheet | **11 of 12** |
| total bindus | **336** against the canonical 337 |
| per-graha totals | Surya 48, Chandra 49, Mangal 39, Budha 54, Guru 56, **Shukra 51**, Shani 39 |

**Six of the seven reproduce their canonical totals exactly. Shukra comes to 51
where the canon says 52, and the whole discrepancy lands in one cell — Karka.**
A search over every missing benefic place finds four single additions that would
reconcile it. **It is recorded rather than patched**, because patching the table
to match the sheet would make the check circular: the point of rebuilding was to
test the sheet, not to agree with it. **Nothing here depends on it** — the Mesha
column is identical in both.

**And with that, the transit reading becomes exact:**

| | |
|---|---|
| **SAV of Mesha** | **21 — the lowest of the twelve signs** (next is Vrishabha 22; highest Kumbha 41) |
| **Shani's own bindus in Mesha** | **3 of 8** — below the classical threshold of 4 |

> **Shani spends nearly three years in the weakest sign of the chart carrying
> three of its own eight bindus. That is the hardest number in this section,
> and it has nothing to do with Surya. It is about the sign.**

### Kakshya — and a draft assumption that inverted

A sign divides into eight belts of 3.75°, owned in order by Shani, Guru,
Mangal, Surya, Shukra, Budha, Chandra, Lagna. A transiting graha is held to
deliver according to whether **the kakshya lord gave it a bindu in that sign.**

**Shani's three contributors in Mesha are Surya, Mangal and Guru.**

| Crossing | Kakshya | Lord | Bindu? |
|---|---|---|---|
| **Surya** | 1 | **Shani** | **no — empty** |
| **Budha** | 3 | Mangal | **yes** |
| **Shukra** | 7 | Chandra | no — empty |

**A first draft of this section reasoned that Surya sits in Shani's own kakshya,
so Shani would be at home there. It is the opposite.** Shani did not give itself
a bindu in Mesha, so its own belt is one of the five empty ones — and that is
exactly where natal Surya sits.
...
> least supported. **Both are computed and neither is suppressed. There is no
> classical ranking between them and this document does not invent one.**

### Gochara — and two things that get confused

**Mesha is the 12th from natal Chandra.** Shani is favourable from the Moon only
in the 3rd, 6th and 11th. **This is Sade Sati, first phase.**

> **Sade Sati is not Ashtama Shani, and the two are constantly conflated.**
> Ashtama Shani is Shani in the 8th *from the Moon* — that is Dhanu for him, and
> **Shani does not reach it until 8 December 2046.** What runs from 2027 is
> Shani in the 8th *from the lagna* and the 12th from the Moon. **The harsher
> doctrine is not the one that is coming.**

**Vedha, tested rather than mentioned.** Shani in the 12th from the Moon is
obstructed by a graha in the 3rd from the Moon — Karka:

| Window on natal Surya | In Karka | Excluding Surya/Chandra |
|---|---|---|
| 8 Jun – 4 Jul 2027 | Chandra, **Guru** | **Guru — obstructed** |
| 17 Sep – 15 Oct 2027 | Chandra | **nothing** |
| 29 Feb – 18 Mar 2028 | Chandra | **nothing** |

**That column pair is the whole argument for the restriction.** Chandra passes
through every sign every month, so a vedha rule admitting Chandra obstructs
essentially every slow transit ever computed — which would make the doctrine
vacuous. **On the restricted reading only the first crossing is obstructed; on
the unrestricted reading all three are. The two schools differ about two of the
three, and neither makes the transit worse than stated.**

### What nobody would look for: the 3rd aspect

| Aspect | Falls on | House | SAV | Occupants |
|---|---|---|---|---|
| **3rd** | **Mithuna** | **10th** | 29 | **Guru** |
| 7th | Tula | 2nd | 24 | empty |
| 10th | Makara | 5th | 29 | empty |

> **For the whole transit, Shani has an aspect on Guru in the 10th** — the sole
> occupant of the career house, the 7th lord, the 4th lord and the Upapada lord.
> **The transit does not only sit on the 8th. It looks at the career house the
> entire time it is there.**

### And what is running underneath

| Mahadasha | Antardasha | | |
|---|---|---|---|
| Rahu | Guru | 6 Sep 2025 | 31 Jan 2028 |
| **Rahu** | **Shani** | **31 Jan 2028** | **7 Dec 2030** |

> **A Shani antardasha runs inside the Shani transit, overlapping by 2.21
> years.** A dasha lord and a transit naming the same graha at once is the
> combination classical timing treats as decisive — **far more so than any
> single conjunction, including the one the question asks about.** And Shani is
> the **Amatyakaraka**, the Jaimini karaka of profession (§42), and the 5th and
> 6th lord.

**And Guru aspects Mesha through most of the same period** — Simha from Jun 2027
and Mar–Jul 2028, Tula from Dec 2028 and Aug 2029. **Guru and Shani both
touching the 8th is a double transit**, which is the classical condition for a
bhava actually *delivering* rather than merely being pressed.

### The answer

**What is computed, and will happen in the sky:**

1. Shani first enters the 8th **3 June 2027** and is finally clear **17 April
   2030** — three passes, not one. It crosses Surya 3 times, Budha 3 times,
   Shukra once.
2. **Debilitated the whole way**, and shallowest exactly where Surya is.
3. **Mesha has the lowest SAV in his chart (21)**, and Shani carries **3 of its
   own 8 bindus** there.
4. **This is Sade Sati, phase one** — not Ashtama Shani, which is twenty years
   further off.
5. The **3rd aspect sits on Guru in the 10th** for the entire transit.
6. A **Shani antardasha** runs inside it, overlapping 2.21 years.
7. **Guru aspects the 8th through most of it — a double transit.**

**What that licenses saying, and what it does not.** A transit marks a window in
which part of the chart is under load. **It does not name an event, and there is
no rule in the fifty-five chapters of the form "Shani over an exalted Surya
produces X."**

**What the classical material does say:** Shani over Surya is a contact between
mutual enemies, and the standard significations are **delay, weight, and the
slow removal of props — applied to whatever Surya rules.** Here Surya rules the
**12th** and sits in the **8th**. **It is the 12th lord that gets pressed — not
the 1st, not the 10th.**

**And the exaltation is not decoration.** §7 measured this graha: **the highest
Ishta phala in the chart and the lowest Kashta** — the one graha that gives most
and charges least. A debilitated Shani meeting an exalted Surya is the weaker
graha arriving on the stronger one's ground. **The dread attached to "Saturn
over the Sun" assumes a Sun that can be diminished. This chart does not have
one.**

**So, in order of what the computation actually supports:**

> **The sign is the problem, not the contact.** Nearly three years in the
> weakest sign of the chart, at 3 bindus, opening Sade Sati. That is real, it is
> long, and it is the part that does not soften.
>
> **The 8th house gets a double transit, and that is the one thing here that is
> not pressure.** Guru aspects Mesha through most of the same window. The
> classical reading is that the bhava *delivers* — meaning the transformation
> this document has been describing since §19 actually lands, rather than being
> deferred again.
>
> **The Surya crossing is where the two measures disagree, and both are
> reported.** Mildest by depth, least supported by kakshya. 72 days across three
> windows, on the chart's strongest and cheapest graha, pressing the house Surya
> *rules* rather than anything he is holding onto.
>
> **The part worth watching is not in the question.** The 3rd aspect on Guru in
> the 10th, running the whole time. The **Shukra crossing on 31 May 2029**, at
> the bottom of Shani's debilitation, on the Atmakaraka. And the Budha crossings
> over the lagna lord and 10th lord — the only ones the kakshya rule supports.

**One last thing, because it is the only genuinely good news here and it is
structural rather than consoling.** §60 measured **ρ = +0.82** between what the
grahas deliver and what they cost, and named **Surya the single exemption** —
most given, least charged. **And it rules the 12th. The house under pressure in
this transit is the one house in his chart that pays out freely.**

---

## 48. The 8th–9th exchange, named from outside

**A description of this exact configuration arrived from outside the reading:**
*"9th lord in 8th / 8th lord in 9th — this can produce a completely unexpected
change in fortune through something initially perceived as a crisis:
inheritance, marriage, research, occult knowledge, tax/insurance matters,
institutional connections."*

**It is describing the structure §50 calls the one thing the whole reading
restates.** The description is accurate; **the valence claim is the part that
needs testing**, because §14 classified this exchange **Dainya — the type the
tradition calls wretched** — and the description reads it as fortune. Both
cannot be taken on trust.

### The exchange, exactly — and one thing sixteen prior mentions missed

| | Rules | Sits in | Dignity |
|---|---|---|---|
| **Shukra** | the **2nd and 9th** | the **8th** (Mesha) | neutral |
| **Mangal** | the **3rd and 8th** | the **9th** (Vrishabha) | neutral |

**A complete mutual exchange, exactly as described.** And then something this
document has named sixteen times without ever checking:

| | |
|---|---|
| longitude gap | **13.71°** |
| relationship | **2/12 — adjacent signs** |
| does Mangal aspect Shukra? | **no** — its 4th, 7th and 8th all miss |
| does Shukra aspect Mangal? | **no** |

> **The two lords do not see each other.** A 2/12 relationship carries no
> drishti in any scheme, and Mangal's special aspects miss as well. **They hold
> each other's houses and never look at each other.**
>
> **A parivartana is a bond of ownership, not of sight. This one is
> administrative, not collaborative.**

### The two classical readings

**Reading one — the parivartana typology (§14).** The pair's lordships are
**2, 3, 8, 9**. A dusthana is present (the 8th) → **Dainya**; the 3rd is present
→ **Khala** as well. *Dainya* means poverty, wretchedness, dependency. **On this
typology the exchange is the bad kind, and it is not close.**

**Reading two — the trikona/dusthana reading, which is what was sent.** Shukra
also rules the **9th, the strongest trikona**. So this is not a plain dusthana
exchange: it is a **dusthana lord and a trikona lord swapping seats, with the
trikona lord going into the dusthana.** **The typology does not capture that** —
the Dainya rule fires on the mere presence of a dusthana lordship and never asks
what else the pair owns. Here the pair owns the worst dusthana and the best
trikona at once.
...
> That is too strong.** §37's contents page lists **BPHS chapter 24 — "Effects
> of the bhava lords, 144 combinations"** — a chapter of results for every lord
> in every house. **So "9th lord in the 8th" and "8th lord in the 9th" are both
> classical entries with stated results. The placements are textual.**
>
...
> *exchange*, and no chapter among the fifty-five in §35 and §37 says "the 8th–9th
> parivartana produces an unexpected change of fortune." **That synthesis — two
> placements read as one mechanism with one outcome — is the later part.**
>
> **And chapter 24 is on this document's own unfinished list**, marked *"§6, §9,
> throughout"* — used in passing, never worked systematically. So the honest
> position is: **the tradition has a specific answer for each half of this
> exchange, this reading has never looked it up**, and what follows tests the
> claim against the chart instead.

### The two houses, before testing anything

| | Bhava Bala | Rank | SAV | Occupants |
|---|---|---|---|---|
| **8th — Mesha** | **7.00** | **12 of 12 — the weakest bhava** | **21 — lowest of twelve signs** | Surya, Budha, Shukra |
| **9th — Vrishabha** | 7.61 | 7 of 12 | 22 | Chandra, Mangal, Shani, Rahu |

> **The house the fortune is supposed to arrive through is the weakest bhava in
> the chart and the weakest sign by Ashtakavarga.** That is not a refutation — a
> weak bhava can still deliver in the right dasha — but it is the first thing an
> honest test returns, and it is not in the description.

### The six named significations, one by one

**Inheritance.** 8th lord Mangal in the 9th is the classical signature and it is
present. But Mangal's **Kashta phala is 38.87, the second highest in the
chart**, and the 2nd house of family wealth is ruled by Shukra — which is in the
8th. **The significature is there and it is expensive.** Nothing dates it and no
computation here can name an amount.

**Marriage. Strongest of the six.** The karaka of marriage *is* one of the two
exchanging grahas, and **Shukra carries the highest Ishta phala in the chart
(47.49) at a cost of 11.87** — the best-conditioned graha there is. The 7th lord
Guru is the sole occupant of the 10th; the Upapada is Dhanu, lord Guru. **§40
already timed this.**

**Research and occult knowledge. Second strongest.** **The 8th lord in the 9th
is the textbook research placement** — hidden things governed from the house of
doctrine. Shani is the Amatyakaraka *and* the 5th lord of mantra and purva
punya. **This one is structural, not incidental: it is the exchange read
forwards.**

**Tax, insurance, other people's money. This one inverts.** The 8th is the
weakest bhava (rank 12) at the lowest SAV (21). **The 6th — debt and obligation —
carries 41 bindus, the highest in the chart**, and its lord is the Amatyakaraka.

> **The debt side of this signification is far better supported than the receipt
> side. He is built to carry obligation, not to be handed windfalls. That is the
> opposite weighting to the claim.**

**Institutional connections. Strong, but not where expected.** 6th SAV 41, 10th
29, 11th 28 — and the **12th at Bhava Bala 12.59, rank 1 of 12, the strongest
bhava in the chart**, its lord Surya exalted and sitting in the 8th. **It
arrives through the 12th, not the 11th** — large institutions and elsewhere,
not networks and contacts. §41 and §45 reached the same place by other routes.

**A change in fortune itself.** The 9th is rank 7 of 12 — middling. Its lord
Shukra passes Shadbala (6.68 against 5.5), is the **Atmakaraka**, and carries the
chart's highest Ishta. But the 9th's own occupants are Chandra, Mangal, Shani
and Rahu.

> **The fortune is real and it is routed.** The 9th lord does not sit in the
> 9th; bhagya is administered from the house of upheaval, and **there is no
> other channel for it.** That is exactly what the description says, and **it is
> the one part that survives intact.**

### When it fires — and the dasha arithmetic is blunt

**A parivartana fires in the dashas of its two lords.** So "when" reduces to:
when do Mangal and Shukra run?

| Mahadasha | From | To | Age at start |
|---|---|---|---|
| Chandra | 25 Dec 2005 | 25 Dec 2015 | 4 |
| **Mangal** | 25 Dec 2015 | **25 Dec 2022** | 14 — **spent** |
| Rahu | 25 Dec 2022 | 25 Dec 2040 | 21 |
| Guru | 25 Dec 2040 | 24 Dec 2056 | 39 |
| Shani | 24 Dec 2056 | 25 Dec 2075 | 55 |
| Budha | 25 Dec 2075 | 24 Dec 2092 | 74 |
| Ketu | 24 Dec 2092 | 25 Dec 2099 | 91 |
| **Shukra** | **25 Dec 2099** | 26 Dec 2119 | **98 — unreachable** |

> **Read those two rows together, because nobody in this document had.**
> **Mangal's mahadasha ended at age 21. Shukra's begins at age 98.** Krittika's
> Vimshottari order puts Shukra last of the nine.
>
> **The exchange will never hold a mahadasha again in his life.** It fires only
> at antardasha level and below, for the rest of it. **That is the single most
> important fact about this configuration and it is pure arithmetic.**

Every remaining antardasha of either lord, to age 80:

| Mahadasha | Antardasha | From | To | Age | Years |
|---|---|---|---|---|---|
| **Rahu** | **Shukra** | **14 Jul 2034** | 13 Jul 2037 | 32 | **3.00** |
| Rahu | Mangal | 7 Dec 2039 | 25 Dec 2040 | 38 | 1.05 |
| Guru | Shukra | 6 Nov 2048 | 8 Jul 2051 | 47 | 2.67 |
| Guru | Mangal | 25 Aug 2053 | 1 Aug 2054 | 51 | 0.93 |
| Shani | Shukra | 16 Oct 2063 | 16 Dec 2066 | 62 | 3.17 |
| Shani | Mangal | 28 Jun 2069 | 7 Aug 2070 | 67 | 1.11 |
| Budha | Shukra | 20 May 2079 | 20 Mar 2082 | 77 | 2.83 |

**14.8 years in total — 27% of the next fifty-six**, arriving in pieces of one
to three years. **The next one is Rahu–Shukra, July 2034 to July 2037, at age
32**, and it is the longest of the Shukra windows before sixty.

### The substitution, applied and measured

One classical treatment of a complete exchange reads each lord **as if it were
in its own sign.** That is a school position, not a universal rule, and this
document had never applied it.

| Graha | Actual | Dignity | As-if | Dignity |
|---|---|---|---|---|
| Mangal | Vrishabha | neutral | Mesha | **own** |
| Shukra | Mesha | neutral | Vrishabha | **own** |

**Both go from neutral to own sign — and that is the entire effect.** Neither
becomes exalted; neither was debilitated to start with; **no house placement
changes** (Mangal stays in the 9th, Shukra in the 8th); and **the measured
Shadbala is untouched**, because Shadbala never used the substitution. **A
genuine upgrade, and a small one. It does not turn a Dainya exchange into a Maha
one, and no school claims it does.**
...
- **The configuration is exactly as described**, and §50 already calls it the
  one structure the whole reading restates.
- **"Fortune routed through crisis" is literally what the chart does.** The 9th
  lord does not sit in the 9th. There is no other channel for bhagya.
- **Three of the six significations are strongly supported** — marriage (the
  karaka *is* one of the exchanging grahas, and the best-conditioned graha in
  the chart), research and occult knowledge (the exchange read forwards), and
  institutional connections (**through the 12th**, the strongest bhava, not the
  11th).

**Not supported:**

- **"Completely unexpected change in fortune" as a promise of scale.** The 8th
  is the weakest bhava in the chart and Mesha the lowest SAV of twelve signs.
  **The channel is real; the channel is also the thinnest thing in the chart.**
- **The tax/insurance/other-people's-money signification inverts.** The debt
  side is the best-supported house in the chart; the receipt side the worst.
- **The typology disagrees with the claim outright.** §14 classes this Dainya
  and Khala. Both halves are covered individually by chapter 24; what the texts
  do not carry is a joint result. **This document reports both readings and
  picks neither** — the texts do not settle it, and pretending otherwise would
  be inventing authority.

**And the fact nobody mentions when they describe this yoga:**

> **Mangal's mahadasha ended at 21. Shukra's begins at 98. The exchange will
> never hold a mahadasha again.** Whatever it delivers, it delivers in
> antardashas — about fifteen years spread across the next fifty, in pieces of a
> year or two. **The description imagines a hinge. The arithmetic gives
> instalments.**

**One last thing, and it is the part that is actually good.** The two lords are
fourteen degrees apart and **do not aspect each other**. That is not a defect —
**it is why the arrangement is stable rather than volatile.** The crisis house
and the fortune house are permanently bonded by ownership and permanently out of
each other's sight.

> **§50 put it in one sentence and the computation has not moved it:** every
> crisis is routed through meaning, and every belief is tested by crisis. He
> does not get to hold a philosophy that has not been through something.
> **That is the yoga. Not a windfall — a wiring.**

---

## 49. Rarity — measuring instead of asserting
...
Everything in the previous forty-eight sections — §2 through §49 — collapses into a single
...
## 51. Part two — the questions asked
...
|---|---|---|
| **52** | *"What are his natural traits"* | `verify_traits.py` |
| **53** | *"Why do people feel jealous or insecure about him"* | `verify_perception.py` |
| **54** | *"How 8th house transform him"* · *"When can he expect major transformation"* · *"Why do people go through such deep transformations does he has any purpose to it"* | `verify_eighth.py` · `verify_timeline.py` · `verify_purpose.py` |
| **55** | *"His wife traits"* | `verify_spouse.py` |
| **56** | *"Will his in laws be wealthy"* | `verify_inlaws.py` |
| **57** | *"So who are the people loving him and when can he experience it. And will he be satisfied with his wife love in marriage and vice versa"* | `verify_love.py` |
| **58** | *"Career growth"* | `verify_career.py` |
| **59** | *"How would the solar eclipse affect him"* | `verify_eclipse.py` |
| **60** | *"Which means he gets all but with pain"* · *"Which means his life is good but with friction"* · *"So it overall upward trajectory in life right"* · *"Any unique point that is so uncommon"* | `verify_cost.py` · `verify_audit.py` · `verify_rarity.py` |
| **61** | *"Why will he walk away from the things he wanted most"* | `verify_relinquish.py` |
...
or gaps that are still need to found about him"* became §72, most of which has
...
**And four questions answered since then live in Part one rather than here**,
because each of them extends that backward turn rather than opening a new
subject: *"what kind of transformation did he go through in the Mars
mahadasha"* and *"the difference between past and future"* are both in **§19**;
...
and *"are there any cancel out rules"* became **§25**;
and *"say more deeper about d9 chart"* became **§26**;
and *"house nature like trikon, upachaya, kender"* became **§27**;
and a supplied live transit table became **§28**;
and *"say about job and career loss"* became **§29**;
and *"analyse both d1, d9 charts... for career"* became **§30**;
and *"rewrite the whole analysis using reference books"* became **§31**
and, once two contents pages arrived, **§32**;
and *"people say as Rahu moves through Dhanishtha..."* became **§33**;
and *"reanalyse the whole file with the titles given"* became **§34**;
and *"does the .md file contain every chapter given above"* became **§35**;
and *"what about 1 to 41 chapters"* became **§36**;
and the contents page for chapters 1 to 45, supplied in answer to it, became
**§37**; and a methodological correction — *"rather than inventing percentage
weights, the house judgment can be organized like this"* — became **§38**;
and *"does the transit of Jupiter over Ashlesha bring deepest fears or traumas
in dreams"* became **§39**; and *"when will he find his soulmate or girl"*
became **§40**; and *"when would he find his place"* became **§41**; and *"like career or field, when is he going to find his place
and start deepening it"* became **§42**; and *"how would Chandra grahan affect his D10 lagna"* became
**§43**; and *"what if he is in USA"* became **§44**; and *"does it trigger any events or situations for him"*
became **§45**; and *"calculate the D81 chart from the information you have"*
became **§46**; and *"what would happen when Saturn travels in the 8th house
over the exalted Sun next year"* became **§47**; and a pasted description of the 9th-lord/8th-lord exchange —
*"this can produce a completely unexpected change in fortune through something
initially perceived as a crisis"* — became **§48**.

**Two of those are the only sections in Part one that do not derive everything
from the chart alone.** §22 is conditioned on a fact the chart did not supply —
that he is in a job now — and §33 begins from a claim made outside the reading
entirely. Every other section in Part one starts from the longitudes.

---

## 52. "What are his natural traits"
...
## 53. "Why do people feel jealous or insecure about him"
...
## 54. The three questions about transformation
...
| Contact | Vargas |
|---|---|
| **Occupies the 7th** | **D9, D27** *(an earlier draft added D11 — withdrawn in §60; Ketu is in D11's 10th)* |
...
## 56. "Will his in laws be wealthy"
...
## 57. "Who are the people loving him, and when can he experience it — and will he be satisfied with his wife's love, and she with his"
...
## 59. "How would the solar eclipse affect him"
...
## 60. The four claims he put to the chart
...
Measured, not asserted — §49 has the full method and the deflations. The single
answer:
...
## 61. Why he sets down the things he wanted most
...
## 63. The timeline all the answers share
...
## 64. Part three — the questions not asked
...
asked about** (§65–§67, twenty areas across two passes), **things about him
nobody thought to ask**
(§68–§70), **the corrections the exact birth data forced** (§71), and **what
remains unknown** (§72).

---

## 65. The people never asked about
...
## 66. The areas never asked about
...
## 67. The second pass — eight more never asked
...
> says — and it is exactly what the satisfaction analysis in §57 found from the
...
That is the same conclusion the purpose analysis in §54 reached from the
...
## 69. Remedy — never asked, and derivable
...
## 70. The question deliberately declined
...
## 71. Every correction the birth data forced
...
| **"Budha, Rahu and Ketu in the D24 12th — foreign study, unambiguously"** (§13, leaned on by §42 and §44) | **The word "unambiguously" is withdrawn.** The D24 ascendant is one of the eight §2 flagged as sitting inside the one-minute residual: Vrishabha on the supplied lagna, Mesha on the computed one, which puts those three grahas in the 1st instead. **§46 annotated all three places.** Guru's exaltation in the D24 is unaffected, and §44's foreign-residence case rests on the birth chart's 12th, which is untouched |
...
| Was | Now |
|---|---|
| **1. Birth time to the minute** — *"the only input that would change conclusions rather than add to them"* | **CLOSED.** Known to the second. It changed four dates and one frame-dependent count (§71) |
...
- **The parents' charts.** Both threads are read by bhavat bhavam from his
  chart alone, which is why §65 describes roles rather than people.
...
(§2). They are computed and printed — **the D81 in full in §46** — and **no
conclusion in this document rests on any of them.** §46 also states the sharper
version: **three of the sixteen Shodashavarga lagnas move as well** (D12, D24,
D60), which §2 had already found and §46 re-derived independently.

### Scope notes, stated honestly

- **Ayurdaya is still not performed** — §70 gives the reasons, and the birth
...
## 73. The whole thing on one page
